...
#if android
 typedef PlatformGL = haxor.platform.android.graphics.AndroidGL;
#end

#if windows
typedef PlatformGL  =  haxor.platform.graphics.OpenGL;
#end


/**
 * Class that describes the low-level commands of the Graphhaxor.graphics.GLplatform.
