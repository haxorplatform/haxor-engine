...
import haxor.texture.Texture.TextureFilter;
...
class ParticleKernel extends KernelFloat
{
	...
	{
		super(DATA_SIZE, DATA_SIZE,false,TextureFormat.Float4);
		
		name = "ParticleKernel"+p_renderer.id;
		
		m_back  	= new RenderTexture(DATA_SIZE, DATA_SIZE, TextureFormat.Float4);
