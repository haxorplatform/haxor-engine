...
public  class InputHandler extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_input_InputHandler(haxor.input.InputHandler __temp_me265)
	{
		{
		}
	...
	{
		double __temp_p_angle264 = ( (( p_angle == null )) ? (((double) (0.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_angle)) )) );
		double __temp_p_pressure263 = ( (( p_pressure == null )) ? (((double) (0.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_pressure)) )) );
		double __temp_p_ry262 = ( (( p_ry == null )) ? (((double) (0.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_ry)) )) );
		double __temp_p_rx261 = ( (( p_rx == null )) ? (((double) (0.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_rx)) )) );
		...
		t.delta.x = 0.0;
		t.delta.y = 0.0;
		t.pressure = __temp_p_pressure263;
		t.radius.x = __temp_p_rx261;
		t.radius.y = __temp_p_ry262;
		t.angle = __temp_p_angle264;
		t.m_down = true;
	...
	public   void OnJoystickDataUpdate(int p_code, double p_value, boolean p_is_analog)
	{
		...
		if ( ! (p_is_analog) ) 
		{
			...
			{
				haxe.root.Array<java.lang.Object> __temp_array395 = this.m_joystick.hold;
				__temp_array395.__set(p_code, ( ((double) (haxe.lang.Runtime.toDouble(__temp_array395.__get(p_code))) ) + haxor.core.Time.m_delta ));
			}
	...
	public   void OnJoystickAnalogUpdate()
	{
		...
		{
			double p_v = 0.0;
			double __temp_stmt1064 = 0.0;
			{
				double p_a = v.x;
				__temp_stmt1064 = ( (( p_a < 0 )) ? ( - (p_a) ) : (p_a) );
			}
			
			p_v = ( (( __temp_stmt1064 - b0 )) / (( b1 - b0 )) );
			if (( p_v <= 0.0 )) 
			{
				v.x = 0.0;
			}
		...
		{
			double p_v1 = 0.0;
			double __temp_stmt1065 = 0.0;
			{
				double p_a1 = v.y;
				__temp_stmt1065 = ( (( p_a1 < 0 )) ? ( - (p_a1) ) : (p_a1) );
			}
			
			p_v1 = ( (( __temp_stmt1065 - b0 )) / (( b1 - b0 )) );
			if (( p_v1 <= 0.0 )) 
			{
				v.y = 0.0;
			}
		...
		{
			double p_v2 = 0.0;
			double __temp_stmt1066 = 0.0;
			{
				double p_a2 = v.x;
				__temp_stmt1066 = ( (( p_a2 < 0 )) ? ( - (p_a2) ) : (p_a2) );
			}
			
			p_v2 = ( (( __temp_stmt1066 - b0 )) / (( b1 - b0 )) );
			if (( p_v2 <= 0.0 )) 
			{
				v.x = 0.0;
			}
		...
		{
			double p_v3 = 0.0;
			double __temp_stmt1067 = 0.0;
			{
				double p_a3 = v.y;
				__temp_stmt1067 = ( (( p_a3 < 0 )) ? ( - (p_a3) ) : (p_a3) );
			}
			
			p_v3 = ( (( __temp_stmt1067 - b0 )) / (( b1 - b0 )) );
			if (( p_v3 <= 0.0 )) 
			{
				v.y = 0.0;
			}
	...
	public   void EmulateTouch(int p_code, int p_id)
	{
		...
		if (( p_id == 0 )) 
		{
			...
			{
				double __temp_stmt1068 = 0.0;
				{
					haxor.math.Vector2 _this1 = haxor.input.Input.deltaMouse;
					__temp_stmt1068 = java.lang.Math.sqrt(( ( _this1.x * _this1.x ) + ( _this1.y * _this1.y ) ));
				}
				
				if (( __temp_stmt1068 > 0 )) 
				{
	...
	{
		{
			boolean __temp_executeDef1069 = true;
	...
	{
		{
			boolean __temp_executeDef1070 = true;
			switch (field.hashCode())
			{
				case -1333561812:
				{
	...
	{
		{
			boolean __temp_executeDef1071 = true;
			switch (field.hashCode())
			{
				case -1333561812:
				{
