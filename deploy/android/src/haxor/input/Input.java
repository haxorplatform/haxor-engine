...
public  class Input extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_input_Input(haxor.input.Input __temp_me260)
	{
		{
		}
	...
	{
		boolean __temp_p_update_state259 = ( (( p_update_state == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_update_state)) );
