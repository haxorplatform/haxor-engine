...
public  class Console extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_core_Console(haxor.core.Console __temp_me27889)
	{
		{
		}
	...
	{
		int __temp_p_level27888 = ( (( p_level == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_level)) )) );
		if (( haxor.core.Console.verbose >= __temp_p_level27888 )) 
		{
