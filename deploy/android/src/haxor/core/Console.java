...
public  class Console extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_core_Console(haxor.core.Console __temp_me54479)
	{
		{
		}
	...
	{
		int __temp_p_level54478 = ( (( p_level == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_level)) )) );
		if (( haxor.core.Console.verbose >= __temp_p_level54478 )) 
		{
