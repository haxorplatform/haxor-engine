...
public  class BaseApplication extends haxor.component.Behaviour
{
	...
	public static   void __hx_ctor_haxor_core_BaseApplication(haxor.core.BaseApplication __temp_me42335)
	{
		haxor.component.Behaviour.__hx_ctor_haxor_component_Behaviour(__temp_me42335);
		haxor.core.BaseApplication.m_instance = __temp_me42335;
		__temp_me42335.m_scenes = new haxe.root.Array<haxor.core.Scene>(new haxor.core.Scene[]{});
		__temp_me42335.set_fps(60);
		__temp_me42335.m_frame_ms = 0.0;
		__temp_me42335.m_init_allowed = false;
		__temp_me42335.m_platform = haxor.core.Platform.Unknown;
		haxor.core.Time.Initialize();
		haxor.graphics.Screen.Initialize(__temp_me42335);
	}
	...
	{
		{
			boolean __temp_executeDef42464 = true;
	...
	{
		{
			boolean __temp_executeDef42465 = true;
			switch (field.hashCode())
			{
				case -2020655093:
				{
	...
	{
		{
			boolean __temp_executeDef42466 = true;
			switch (field.hashCode())
			{
				case 1461662450:
				{
	...
	{
		{
			boolean __temp_executeDef42467 = true;
			switch (field.hashCode())
			{
				case -1499590326:
				{
	...
	{
		{
			boolean __temp_executeDef42468 = true;
			switch (field.hashCode())
			{
				case 1461662450:
				{
