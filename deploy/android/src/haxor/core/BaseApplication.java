...
public  class BaseApplication extends haxor.component.Behaviour
{
	...
	public static   void __hx_ctor_haxor_core_BaseApplication(haxor.core.BaseApplication __temp_me55659)
	{
		haxor.component.Behaviour.__hx_ctor_haxor_component_Behaviour(__temp_me55659);
		haxor.core.BaseApplication.m_instance = __temp_me55659;
		__temp_me55659.m_scenes = new haxe.root.Array<haxor.core.Scene>(new haxor.core.Scene[]{});
		__temp_me55659.set_fps(60);
		__temp_me55659.m_frame_ms = 0.0;
		__temp_me55659.m_init_allowed = false;
		__temp_me55659.m_platform = haxor.core.Platform.Unknown;
		haxor.core.Time.Initialize();
		haxor.graphics.Screen.Initialize(__temp_me55659);
	}
	...
	{
		{
			boolean __temp_executeDef55800 = true;
	...
	{
		{
			boolean __temp_executeDef55801 = true;
			switch (field.hashCode())
			{
				case -2020655093:
				{
	...
	{
		{
			boolean __temp_executeDef55802 = true;
			switch (field.hashCode())
			{
				case 1461662450:
				{
	...
	{
		{
			boolean __temp_executeDef55803 = true;
			switch (field.hashCode())
			{
				case -1499590326:
				{
	...
	{
		{
			boolean __temp_executeDef55804 = true;
			switch (field.hashCode())
			{
				case 1461662450:
				{
