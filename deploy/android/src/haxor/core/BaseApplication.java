...
public  class BaseApplication extends haxor.component.Behaviour
{
	...
	public static   void __hx_ctor_haxor_core_BaseApplication(haxor.core.BaseApplication __temp_me27866)
	{
		haxor.component.Behaviour.__hx_ctor_haxor_component_Behaviour(__temp_me27866);
		haxor.core.BaseApplication.m_instance = __temp_me27866;
		__temp_me27866.m_scenes = new haxe.root.Array<haxor.core.Scene>(new haxor.core.Scene[]{});
		__temp_me27866.set_fps(60);
		__temp_me27866.m_frame_ms = 0.0;
		__temp_me27866.m_frame_count = 0;
		__temp_me27866.m_init_allowed = false;
		__temp_me27866.m_frame_allowed = false;
		__temp_me27866.m_platform = haxor.core.Platform.Unknown;
		haxor.core.Time.Initialize();
		haxor.graphics.Screen.m_application = __temp_me27866;
	...
	public  boolean m_frame_allowed;
	
	public  int m_frame_count;
	...
	{
		haxor.core.Console.Log(( ( ( ( "Application> Resize [" + haxe.lang.Runtime.toString(haxor.graphics.Screen.m_width) ) + "," ) + haxe.lang.Runtime.toString(haxor.graphics.Screen.m_height) ) + "]" ), 5);
	...
	{
		{
			boolean __temp_executeDef27965 = true;
			switch (field.hashCode())
			{
				case 1945172715:
				{
					if (field.equals("m_frame_count")) 
					{
						__temp_executeDef27965 = false;
						this.m_frame_count = ((int) (value) );
						return value;
					}
	...
	{
		{
			boolean __temp_executeDef27966 = true;
			switch (field.hashCode())
			{
				case 1945172715:
				{
					if (field.equals("m_frame_count")) 
					{
						__temp_executeDef27966 = false;
						this.m_frame_count = ((int) (haxe.lang.Runtime.toInt(value)) );
						return value;
					}
				...
				case -868965244:
				{
					if (field.equals("m_frame_allowed")) 
					{
						__temp_executeDef27966 = false;
						this.m_frame_allowed = haxe.lang.Runtime.toBool(value);
						return value;
					}
	...
	{
		{
			boolean __temp_executeDef27967 = true;
			switch (field.hashCode())
			{
				case 1461662450:
				{
	...
	{
		{
			boolean __temp_executeDef27968 = true;
			switch (field.hashCode())
			{
				case 1945172715:
				{
					if (field.equals("m_frame_count")) 
					{
						__temp_executeDef27968 = false;
						return ((double) (this.m_frame_count) );
					}
	...
	{
		{
			boolean __temp_executeDef27969 = true;
			switch (field.hashCode())
			{
				case 1461662450:
				{
	...
	{
		baseArr.push("m_frame_count");
		baseArr.push("m_frame_allowed");
