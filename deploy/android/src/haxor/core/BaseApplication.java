...
public  class BaseApplication extends haxor.component.Behaviour
{
	...
	public static   void __hx_ctor_haxor_core_BaseApplication(haxor.core.BaseApplication __temp_me54455)
	{
		haxor.component.Behaviour.__hx_ctor_haxor_component_Behaviour(__temp_me54455);
		haxor.core.BaseApplication.m_instance = __temp_me54455;
		__temp_me54455.m_scenes = new haxe.root.Array<haxor.core.Scene>(new haxor.core.Scene[]{});
		__temp_me54455.set_fps(60);
		__temp_me54455.m_frame_ms = 0.0;
		__temp_me54455.m_init_allowed = false;
		__temp_me54455.m_platform = haxor.core.Platform.Unknown;
		haxor.core.Time.Initialize();
		haxor.graphics.Screen.Initialize(__temp_me54455);
	}
	...
	{
		{
			boolean __temp_executeDef54596 = true;
	...
	{
		{
			boolean __temp_executeDef54597 = true;
			switch (field.hashCode())
			{
				case -2020655093:
				{
	...
	{
		{
			boolean __temp_executeDef54598 = true;
			switch (field.hashCode())
			{
				case 1461662450:
				{
	...
	{
		{
			boolean __temp_executeDef54599 = true;
			switch (field.hashCode())
			{
				case -1499590326:
				{
	...
	{
		{
			boolean __temp_executeDef54600 = true;
			switch (field.hashCode())
			{
				case 1461662450:
				{
