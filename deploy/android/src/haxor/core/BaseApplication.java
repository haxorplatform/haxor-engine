...
public  class BaseApplication extends haxor.component.Behaviour
{
	...
	public static   void __hx_ctor_haxor_core_BaseApplication(haxor.core.BaseApplication __temp_me255319, java.lang.String p_name)
	{
		haxor.component.Behaviour.__hx_ctor_haxor_component_Behaviour(__temp_me255319, p_name);
	}
	...
	{
		{
			boolean __temp_executeDef255697 = true;
	...
	{
		{
			boolean __temp_executeDef255698 = true;
			switch (field.hashCode())
			{
				case -2020655093:
				{
	...
	{
		{
			boolean __temp_executeDef255699 = true;
			switch (field.hashCode())
			{
				case 1461662450:
				{
	...
	{
		{
			boolean __temp_executeDef255700 = true;
			switch (field.hashCode())
			{
				case -1499590326:
				{
	...
	{
		{
			boolean __temp_executeDef255701 = true;
			switch (field.hashCode())
			{
				case 312095663:
				{
