...
public  class Entity extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_core_Entity(haxor.core.Entity __temp_me42361, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me42361, p_name);
		__temp_me42361.m_enabled = true;
		__temp_me42361.m_components = new haxe.root.Array<haxor.component.Component>(new haxor.component.Component[]{});
	}
	...
	{
		{
			boolean __temp_executeDef42583 = true;
	...
	{
		{
			boolean __temp_executeDef42584 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef42585 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
