...
public  class Entity extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_core_Entity(haxor.core.Entity __temp_me160462, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me160462, ( (( p_name == null )) ? (haxe.lang.Runtime.toString("")) : (p_name) ));
		if (( p_name == null )) 
		{
			p_name = "";
		}
		
		__temp_me160462.m_enabled = true;
		__temp_me160462.m_components = new haxe.root.Array<haxor.component.Component>(new haxor.component.Component[]{});
		__temp_me160462.m_layer = 1;
		__temp_me160462.m_transform = ((haxor.component.Transform) (__temp_me160462.AddComponent(((java.lang.Class<haxor.component.Component>) (((java.lang.Class) (haxor.component.Transform.class) )) ))) );
	}
	...
	{
		{
			boolean __temp_executeDef161193 = true;
	...
	{
		{
			boolean __temp_executeDef161194 = true;
			switch (field.hashCode())
			{
				case 1825980968:
				{
	...
	{
		{
			boolean __temp_executeDef161195 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef161196 = true;
			switch (field.hashCode())
			{
				case 776172287:
				{
	...
	{
		{
			boolean __temp_executeDef161197 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
