...
public  class Entity extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_core_Entity(haxor.core.Entity __temp_me27891, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me27891, p_name);
		__temp_me27891.m_enabled = true;
		__temp_me27891.m_components = new haxe.root.Array<haxor.component.Component>(new haxor.component.Component[]{});
	}
	...
	{
		{
			boolean __temp_executeDef28072 = true;
	...
	{
		{
			boolean __temp_executeDef28073 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef28074 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
