...
public  class Entity extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_core_Entity(haxor.core.Entity __temp_me33813, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me33813, p_name);
		__temp_me33813.m_enabled = true;
		__temp_me33813.m_components = new haxe.root.Array<haxor.component.Component>(new haxor.component.Component[]{});
	}
	...
	{
		{
			boolean __temp_executeDef34010 = true;
	...
	{
		{
			boolean __temp_executeDef34011 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef34012 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
