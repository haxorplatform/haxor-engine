...
public  class Resource extends haxe.lang.HxObject implements haxor.core.IDisposable
{
	...
	public static   void __hx_ctor_haxor_core_Resource(haxor.core.Resource __temp_me151267, java.lang.String p_name)
	{
		if (( p_name == null )) 
		{
			p_name = "";
		...
		__temp_me151267.m_uid = haxor.context.EngineContext.uid++;
		__temp_me151267.m_destroyed = false;
		__temp_me151267.__cid = 0;
		__temp_me151267.__db = "";
		__temp_me151267.m_pid = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{-1, -1, -1, -1, -1, -1, -1, -1, -1});
		__temp_me151267.m_name = p_name;
		__temp_me151267.m_is_behaviour = ( __temp_me151267 instanceof haxor.component.Behaviour );
		__temp_me151267.m_type_class = ((java.lang.Class) (haxe.root.Type.getClass(__temp_me151267)) );
		__temp_me151267.m_type_full_name = haxe.root.Type.getClassName(__temp_me151267.m_type_class);
		haxe.root.Array<java.lang.String> nt = haxe.lang.StringExt.split(__temp_me151267.m_type_full_name, ".");
		nt.reverse();
		__temp_me151267.m_type_name = nt.__get(0);
		if (haxe.lang.Runtime.valEq(p_name, "")) 
		{
			__temp_me151267.m_name = ( __temp_me151267.m_type_name + __temp_me151267.m_uid );
		}
		 else 
		{
			__temp_me151267.m_name = p_name;
		...
		__temp_me151267.m_guid = "";
		__temp_me151267.m_guid += haxe.root.StringTools.hex(((int) (java.lang.Math.floor(( 268435455 * java.lang.Math.random() ))) ), null);
		__temp_me151267.m_guid += haxe.root.StringTools.hex(((int) (java.lang.Math.floor(( 268435455 * java.lang.Math.random() ))) ), null);
		__temp_me151267.m_guid += haxe.root.StringTools.hex(((int) (java.lang.Math.floor(( 268435455 * java.lang.Math.random() ))) ), null);
		__temp_me151267.m_guid += haxe.root.StringTools.hex(((int) (java.lang.Math.floor(( 268435455 * java.lang.Math.random() ))) ), null);
		haxor.context.EngineContext.resources.Add(__temp_me151267);
	}
	...
	{
		{
			boolean __temp_executeDef151647 = true;
	...
	{
		{
			boolean __temp_executeDef151648 = true;
			switch (field.hashCode())
			{
				case 1202714234:
				{
	...
	{
		{
			boolean __temp_executeDef151649 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef151650 = true;
			switch (field.hashCode())
			{
				case 90663134:
				{
	...
	{
		{
			boolean __temp_executeDef151651 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
