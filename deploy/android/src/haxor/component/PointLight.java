...
public  class PointLight extends haxor.component.Light
{
	...
	public static   void __hx_ctor_haxor_component_PointLight(haxor.component.PointLight __temp_me80590)
	{
		haxor.component.Light.__hx_ctor_haxor_component_Light(__temp_me80590);
		__temp_me80590.atten = 1.0;
		__temp_me80590.radius = 1.0;
	}
	...
	{
		{
			boolean __temp_executeDef81221 = true;
	...
	{
		{
			boolean __temp_executeDef81222 = true;
			switch (field.hashCode())
			{
				case -938578798:
				{
	...
	{
		{
			boolean __temp_executeDef81223 = true;
			switch (field.hashCode())
			{
				case -938578798:
				{
	...
	{
		{
			boolean __temp_executeDef81224 = true;
			switch (field.hashCode())
			{
				case -938578798:
				{
