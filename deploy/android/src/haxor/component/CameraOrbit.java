...
public  class CameraOrbit extends haxor.component.Behaviour implements haxor.core.IUpdateable
{
	...
	public static   void __hx_ctor_haxor_component_CameraOrbit(haxor.component.CameraOrbit __temp_me35, java.lang.String p_name)
	{
		haxor.component.Behaviour.__hx_ctor_haxor_component_Behaviour(__temp_me35, p_name);
	}
	...
	{
		double __temp_p_angle_y34 = ( (( p_angle_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_angle_y)) )) );
		double __temp_p_angle_x33 = ( (( p_angle_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_angle_x)) )) );
		double __temp_p_distance32 = ( (( p_distance == null )) ? (((double) (1) )) : (((double) (haxe.lang.Runtime.toDouble(p_distance)) )) );
		...
		orbit.distance = __temp_p_distance32;
		orbit.smooth = ((double) (0) );
		orbit.angle = new haxor.math.Vector2(((java.lang.Object) (__temp_p_angle_x33) ), ((java.lang.Object) (__temp_p_angle_y34) ));
		return orbit;
	}
	...
	public   void OnUpdate()
	{
		...
		haxor.math.Vector3 __temp_stmt617 = new haxor.math.Vector3(((java.lang.Object) (1) ), ((java.lang.Object) (0) ), ((java.lang.Object) (0) ));
		haxor.math.Quaternion __temp_stmt618 = null;
		{
			haxor.context.DataContext _this1 = haxor.context.EngineContext.data;
			__temp_stmt618 = _this1.m_q.__get(_this1.m_nq = ( (( _this1.m_nq + 1 )) % _this1.m_q.length ));
		}
		
		q.Multiply(__temp_stmt618.SetAxisAngle(__temp_stmt617,  - (this.m_angle.y) ), null);
	...
	{
		{
			int __temp_hash624 = field.hashCode();
			boolean __temp_executeDef623 = true;
			switch (__temp_hash624)
			{
				case 327758243:case 312095663:
				{
					if (( (( ( __temp_hash624 == 327758243 ) && field.equals("OnStart") )) || field.equals("OnBuild") )) 
					{
