...
public  class Component extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_component_Component(haxor.component.Component __temp_me4429)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me4429, "");
		__temp_me4429.OnBuild();
	}
	...
	{
		{
			boolean __temp_executeDef4509 = true;
	...
	{
		{
			boolean __temp_executeDef4510 = true;
			switch (field.hashCode())
			{
				case 312095663:
				{
	...
	{
		{
			int __temp_hash4512 = field.hashCode();
			boolean __temp_executeDef4511 = true;
			switch (__temp_hash4512)
			{
				case 1415373896:case 1976486356:
				{
					if (( (( ( __temp_hash4512 == 1415373896 ) && field.equals("set_name") )) || field.equals("get_name") )) 
					{
						__temp_executeDef4511 = false;
