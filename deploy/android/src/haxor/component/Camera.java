...
public  class Camera extends haxor.component.Behaviour
{
	...
	public static   void __hx_ctor_haxor_component_Camera(haxor.component.Camera __temp_me151309, java.lang.String p_name)
	{
		haxor.component.Behaviour.__hx_ctor_haxor_component_Behaviour(__temp_me151309, p_name);
	}
	...
	@Override public   void OnBuild()
	{
		...
		this.set_mask(1);
		{
			...
			this.m_viewport.SetAABB2(v);
			haxor.context.EngineContext.camera.UpdateViewport(this);
			haxor.math.AABB2 __temp_expr151920 = v;
		}
	...
	public   haxor.math.Vector4 WorldToProjection(haxor.math.Vector3 p_world_point)
	{
		...
		p.z = p_world_point.z;
		{
			...
			p.z = vz;
			p.w = vw;
			haxor.math.Vector4 __temp_expr151921 = p;
		}
		
		{
			...
			p.z = vz1;
			p.w = vw1;
			haxor.math.Vector4 __temp_expr151922 = p;
		}
	...
	{
		double __temp_p_smooth151308 = ( (( p_smooth == null )) ? (((double) (0.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_smooth)) )) );
		...
		haxor.math.Quaternion q = null;
		{
			...
			haxor.math.Matrix4 __temp_stmt151924 = null;
			{
				haxor.context.DataContext _this2 = haxor.context.EngineContext.data;
				__temp_stmt151924 = _this2.m_m4.__get(_this2.m_nq = ( (( _this2.m_nm4 + 1 )) % _this2.m_m4.length ));
			}
			
			haxor.math.Matrix4 __temp_stmt151923 = haxor.math.Matrix4.LookAt(p, p_at, p_up, __temp_stmt151924);
			q = haxor.math.Quaternion.FromMatrix(__temp_stmt151923, p_result);
		}
		
		if (( __temp_p_smooth151308 > 0 )) 
		{
			haxor.math.Quaternion __temp_stmt151925 = null;
			{
				haxor.context.DataContext _this3 = haxor.context.EngineContext.data;
				__temp_stmt151925 = _this3.m_q.__get(_this3.m_nq = ( (( _this3.m_nq + 1 )) % _this3.m_q.length ));
			}
			
			r = haxor.math.Quaternion.Lerp(r, q, ( __temp_p_smooth151308 * haxor.core.Time.m_delta ), __temp_stmt151925);
		}
		 else 
		{
			r = q;
	...
	{
		{
			boolean __temp_executeDef151926 = true;
	...
	{
		{
			boolean __temp_executeDef151927 = true;
			switch (field.hashCode())
			{
				case 588326199:
				{
	...
	{
		{
			boolean __temp_executeDef151928 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef151929 = true;
			switch (field.hashCode())
			{
				case -729568467:
				{
	...
	{
		{
			int __temp_hash151931 = field.hashCode();
			boolean __temp_executeDef151930 = true;
			switch (__temp_hash151931)
			{
				case 602652923:case 1899224918:case 312095663:
				{
					if (( (( ( __temp_hash151931 == 602652923 ) && field.equals("OnDestroy") )) || ( (( ( __temp_hash151931 == 1899224918 ) && field.equals("OnTransformUpdate") )) || field.equals("OnBuild") ) )) 
					{
						__temp_executeDef151930 = false;
