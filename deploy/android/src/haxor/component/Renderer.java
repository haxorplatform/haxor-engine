...
public  class Renderer extends haxor.component.Behaviour
{
	...
	public static   void __hx_ctor_haxor_component_Renderer(haxor.component.Renderer __temp_me80588, java.lang.String p_name)
	{
		haxor.component.Behaviour.__hx_ctor_haxor_component_Behaviour(__temp_me80588, p_name);
	}
	...
	{
		{
			boolean __temp_executeDef81211 = true;
	...
	{
		{
			boolean __temp_executeDef81212 = true;
			switch (field.hashCode())
			{
				case 259065146:
				{
	...
	{
		{
			boolean __temp_executeDef81213 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef81214 = true;
			switch (field.hashCode())
			{
				case 259065146:
				{
	...
	{
		{
			int __temp_hash81216 = field.hashCode();
			boolean __temp_executeDef81215 = true;
			switch (__temp_hash81216)
			{
				case 602652923:case 312095663:
				{
					if (( (( ( __temp_hash81216 == 602652923 ) && field.equals("OnDestroy") )) || field.equals("OnBuild") )) 
					{
						__temp_executeDef81215 = false;
