...
public  class Behaviour extends haxor.component.Component
{
	...
	public static   void __hx_ctor_haxor_component_Behaviour(haxor.component.Behaviour __temp_me1808)
	{
		haxor.component.Component.__hx_ctor_haxor_component_Component(__temp_me1808);
		__temp_me1808.m_enabled = true;
		__temp_me1808.m_is_behaviour = true;
		__temp_me1808.m_is_updateable = ( __temp_me1808 instanceof haxor.core.IUpdateable );
		__temp_me1808.m_is_renderable = ( __temp_me1808 instanceof haxor.core.IRenderable );
		__temp_me1808.m_is_resizeable = ( __temp_me1808 instanceof haxor.core.IResizeable );
		__temp_me1808.UpdateContextFlag(true);
	}
	...
	public   void UpdateContextFlag(boolean p_flag)
	{
		if (this.m_is_updateable) 
		{
			if (p_flag) 
			{
				haxor.context.HaxorContext.update.Add(this);
			}
			 else 
			{
				haxor.context.HaxorContext.update.Remove(this);
			}
		...
		if (this.m_is_renderable) 
		{
			if (p_flag) 
			{
				haxor.context.HaxorContext.render.Add(this);
			}
			 else 
			{
				haxor.context.HaxorContext.render.Remove(this);
			}
		...
		if (this.m_is_resizeable) 
		{
			if (p_flag) 
			{
				haxor.context.HaxorContext.resize.Add(this);
			}
			 else 
			{
				haxor.context.HaxorContext.resize.Remove(this);
			}
	...
	{
		{
			boolean __temp_executeDef1869 = true;
	...
	{
		{
			boolean __temp_executeDef1870 = true;
			switch (field.hashCode())
			{
				case -1599225582:
				{
	...
	{
		{
			boolean __temp_executeDef1871 = true;
			switch (field.hashCode())
			{
				case -1599225582:
				{
