...
public  class Behaviour extends haxor.component.Component
{
	...
	public static   void __hx_ctor_haxor_component_Behaviour(haxor.component.Behaviour __temp_me54454)
	{
		haxor.component.Component.__hx_ctor_haxor_component_Component(__temp_me54454);
		__temp_me54454.m_enabled = true;
		__temp_me54454.m_is_behaviour = true;
		__temp_me54454.m_is_updateable = ( __temp_me54454 instanceof haxor.core.IUpdateable );
		__temp_me54454.m_is_renderable = ( __temp_me54454 instanceof haxor.core.IRenderable );
		__temp_me54454.m_is_resizeable = ( __temp_me54454 instanceof haxor.core.IResizeable );
		__temp_me54454.UpdateContextFlag(true);
	}
	...
	{
		{
			boolean __temp_executeDef54593 = true;
	...
	{
		{
			boolean __temp_executeDef54594 = true;
			switch (field.hashCode())
			{
				case -1599225582:
				{
	...
	{
		{
			boolean __temp_executeDef54595 = true;
			switch (field.hashCode())
			{
				case -1599225582:
				{
