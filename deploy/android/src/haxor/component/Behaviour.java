...
public  class Behaviour extends haxor.component.Component
{
	...
	public static   void __hx_ctor_haxor_component_Behaviour(haxor.component.Behaviour __temp_me151269, java.lang.String p_name)
	{
		haxor.component.Component.__hx_ctor_haxor_component_Component(__temp_me151269, p_name);
	}
	...
	{
		{
			boolean __temp_executeDef151656 = true;
	...
	{
		{
			boolean __temp_executeDef151657 = true;
			switch (field.hashCode())
			{
				case 327758243:
				{
	...
	{
		{
			boolean __temp_executeDef151658 = true;
			switch (field.hashCode())
			{
				case 312095663:
				{
