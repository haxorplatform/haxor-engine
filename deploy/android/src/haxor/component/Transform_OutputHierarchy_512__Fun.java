...
public  class Transform_OutputHierarchy_512__Fun extends haxe.lang.Function
{
	public    Transform_OutputHierarchy_512__Fun(haxe.root.Array<java.lang.Object> d0, haxe.root.Array<java.lang.String> hs)
	{
		super(2, 0);
		this.d0 = d0;
		this.hs = hs;
	...
	@Override public   java.lang.Object __hx_invoke2_o(double __fn_float1, java.lang.Object __fn_dyn1, double __fn_float2, java.lang.Object __fn_dyn2)
	{
		...
		{
			int __temp_index164468 = 0;
			this.hs.__set(__temp_index164468, ( this.hs.__get(__temp_index164468) + ( ( ( ( ( ( tab + t.get_name() ) + " " ) + t.get_position().ToString(null) ) + t.get_rotation().ToString(null) ) + t.get_scale().ToString(null) ) + "\n" ) ));
		}
