...
public  class MeshRenderer extends haxor.component.Renderer
{
	...
	public static   void __hx_ctor_haxor_component_MeshRenderer(haxor.component.MeshRenderer __temp_me80589, java.lang.String p_name)
	{
		haxor.component.Renderer.__hx_ctor_haxor_component_Renderer(__temp_me80589, p_name);
	}
	...
	{
		{
			boolean __temp_executeDef81217 = true;
	...
	{
		{
			boolean __temp_executeDef81218 = true;
			switch (field.hashCode())
			{
				case 1528462453:
				{
	...
	{
		{
			int __temp_hash81220 = field.hashCode();
			boolean __temp_executeDef81219 = true;
			switch (__temp_hash81220)
			{
				case 1528462453:case 312095663:
				{
					if (( (( ( __temp_hash81220 == 1528462453 ) && field.equals("OnRender") )) || field.equals("OnBuild") )) 
					{
						__temp_executeDef81219 = false;
