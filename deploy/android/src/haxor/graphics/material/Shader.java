...
public  class Shader extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_material_Shader(haxor.graphics.material.Shader __temp_me21756, java.lang.String p_source)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me21756, null);
		__temp_me21756._cid_ = haxor.context.EngineContext.material.sid++;
		...
		x = x.firstElement();
		__temp_me21756.set_name(x.get("id"));
		if (( ( __temp_me21756.get_name() == null ) || haxe.lang.Runtime.valEq(__temp_me21756.get_name(), "") )) 
		{
			__temp_me21756.set_name(( "Shader" + __temp_me21756._cid_ ));
		}
		...
		__temp_me21756.m_vss = __temp_me21756.GetShaderSource(vs);
		__temp_me21756.m_fss = __temp_me21756.GetShaderSource(fs);
		__temp_me21756.m_hasError = false;
		haxor.context.EngineContext.material.InitializeShader(__temp_me21756);
	}
	...
	public   java.lang.String GetShaderSource(haxe.root.Xml n)
	{
		...
		{
			java.lang.String __temp_svar21916 = (prec);
			switch (__temp_svar21916.hashCode())
			{
				case 107348:
				{
					if (__temp_svar21916.equals("low")) 
					{
				...
				case 3202466:
				{
					if (__temp_svar21916.equals("high")) 
					{
				...
				case -1078030475:
				{
					if (__temp_svar21916.equals("medium")) 
					{
	...
	{
		{
			boolean __temp_executeDef21918 = true;
	...
	{
		{
			boolean __temp_executeDef21919 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef21920 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
