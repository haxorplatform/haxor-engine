...
public  class UberShader extends haxor.graphics.material.Shader
{
	...
	public static   void __hx_ctor_haxor_graphics_material_UberShader(haxor.graphics.material.UberShader __temp_me223, java.lang.String p_source)
	{
		haxor.graphics.material.Shader.__hx_ctor_haxor_graphics_material_Shader(__temp_me223, p_source);
	}
