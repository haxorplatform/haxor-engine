...
public  class Material extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_material_Material(haxor.graphics.material.Material __temp_me255442, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me255442, ( (( p_name == null )) ? (haxe.lang.Runtime.toString("")) : (p_name) ));
		__temp_me255442.grab = false;
		if (( p_name == null )) 
		{
			p_name = "";
		}
		
		{
			...
			{
				__temp_me255442.__cid = _this.m_id++;
			}
			 else 
			{
				__temp_me255442.__cid = ((int) (haxe.lang.Runtime.toInt(_this.m_cache.shift())) );
			}
			
		}
		
		__temp_me255442.m_uniforms = new haxe.root.Array<haxor.graphics.material.MaterialUniform>(new haxor.graphics.material.MaterialUniform[]{});
		__temp_me255442.queue = 1000;
		__temp_me255442.zfunc = 515;
		__temp_me255442.ztest = true;
		__temp_me255442.zwrite = true;
		__temp_me255442.blend = false;
		__temp_me255442.blendSrc = 1;
		__temp_me255442.blendDst = 0;
		__temp_me255442.invert = false;
		__temp_me255442.cull = 2;
		__temp_me255442.lighting = false;
		__temp_me255442.grab = false;
		haxor.context.EngineContext.material.InitializeMaterial(__temp_me255442);
	}
	
	
	public static   haxor.graphics.material.Material Opaque(haxor.graphics.texture.Texture p_texture, java.lang.Object p_ztest, java.lang.Object p_zwrite)
	{
		boolean __temp_p_zwrite255432 = ( (( p_zwrite == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_zwrite)) );
		boolean __temp_p_ztest255431 = ( (( p_ztest == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_ztest)) );
		...
		m.queue = 1000;
		m.ztest = __temp_p_ztest255431;
		m.zwrite = __temp_p_zwrite255432;
		if (( p_texture != null )) 
		{
	...
	{
		boolean __temp_p_double_sided255435 = ( (( p_double_sided == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_double_sided)) );
		boolean __temp_p_zwrite255434 = ( (( p_zwrite == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_zwrite)) );
		boolean __temp_p_ztest255433 = ( (( p_ztest == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_ztest)) );
		haxor.graphics.material.Material m = new haxor.graphics.material.Material(haxe.lang.Runtime.toString("Transparent"));
		if (__temp_p_double_sided255435) 
		{
			m.cull = 0;
		}
		...
		m.set_shader(( (( p_texture == null )) ? (( (( haxor.graphics.material.Shader.m_flat_shader == null )) ? (haxor.graphics.material.Shader.m_flat_shader = new haxor.graphics.material.Shader(haxe.lang.Runtime.toString(haxor.context.ShaderContext.flat_source))) : (haxor.graphics.material.Shader.m_flat_shader) )) : (( (( haxor.graphics.material.Shader.m_flat_texture_shader == null )) ? (haxor.graphics.material.Shader.m_flat_texture_shader = new haxor.graphics.material.Shader(haxe.lang.Runtime.toString(haxor.context.ShaderContext.flat_texture_source))) : (haxor.graphics.material.Shader.m_flat_texture_shader) )) ));
		m.queue = 2000;
		m.ztest = __temp_p_ztest255433;
		m.zwrite = __temp_p_zwrite255434;
		m.blend = true;
		if (( p_texture != null )) 
		{
			m.SetTexture("DiffuseTexture", p_texture);
	...
	{
		boolean __temp_p_double_sided255438 = ( (( p_double_sided == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_double_sided)) );
		boolean __temp_p_zwrite255437 = ( (( p_zwrite == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_zwrite)) );
		boolean __temp_p_ztest255436 = ( (( p_ztest == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_ztest)) );
		haxor.graphics.material.Material m = null;
		{
			...
			if (__temp_p_double_sided255438) 
			{
				m1.cull = 0;
			}
			...
			m1.queue = 2000;
			m1.ztest = __temp_p_ztest255436;
			m1.zwrite = __temp_p_zwrite255437;
			m1.blend = true;
			m = m1;
		}
	...
	{
		boolean __temp_p_double_sided255441 = ( (( p_double_sided == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_double_sided)) );
		boolean __temp_p_zwrite255440 = ( (( p_zwrite == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_zwrite)) );
		boolean __temp_p_ztest255439 = ( (( p_ztest == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_ztest)) );
		haxor.graphics.material.Material m = null;
		{
			haxor.graphics.material.Material m1 = new haxor.graphics.material.Material(haxe.lang.Runtime.toString("Transparent"));
			if (__temp_p_double_sided255441) 
			{
				m1.cull = 0;
			}
			...
			m1.set_shader(( (( haxor.graphics.material.Shader.m_flat_shader == null )) ? (haxor.graphics.material.Shader.m_flat_shader = new haxor.graphics.material.Shader(haxe.lang.Runtime.toString(haxor.context.ShaderContext.flat_source))) : (haxor.graphics.material.Shader.m_flat_shader) ));
			m1.queue = 2000;
			m1.ztest = __temp_p_ztest255439;
			m1.zwrite = __temp_p_zwrite255440;
			m1.blend = true;
			m = m1;
		}
	...
	public   void SetMatrix4(java.lang.String p_name, haxor.math.Matrix4 p_matrix4, java.lang.Object p_transpose)
	{
		boolean __temp_p_transpose255429 = ( (( p_transpose == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_transpose)) );
		if (( p_matrix4 == null )) 
		{
			this.RemoveUniform(p_name);
			return ;
		...
		if (u.exists) 
		{
			u.SetMatrix4(p_matrix4, __temp_p_transpose255429);
		}
	...
	{
		boolean __temp_p_check_shader255430 = ( (( p_check_shader == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_check_shader)) );
		{
			int _g1 = 0;
			int _g = this.m_uniforms.length;
			while (( _g1 < _g ))
			{
				...
				if (haxe.lang.Runtime.valEq(this.m_uniforms.__get(i).name, p_name)) 
				{
					if (__temp_p_check_shader255430) 
					{
	...
	{
		{
			boolean __temp_executeDef256136 = true;
	...
	{
		{
			boolean __temp_executeDef256137 = true;
			switch (field.hashCode())
			{
				case -159401775:
				{
	...
	{
		{
			boolean __temp_executeDef256138 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef256139 = true;
			switch (field.hashCode())
			{
				case 3065202:
				{
	...
	{
		{
			boolean __temp_executeDef256140 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
				...
				case 1513473521:
				{
					...
					{
						__temp_executeDef256140 = false;
						this.SetMatrix4(haxe.lang.Runtime.toString(dynargs.__get(0)), ((haxor.math.Matrix4) (dynargs.__get(1)) ), dynargs.__get(2));
					}
