...
public  class Material extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_material_Material(haxor.graphics.material.Material __temp_me54092, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me54092, p_name);
		__temp_me54092.grab = false;
		__temp_me54092._cid_ = haxor.context.EngineContext.material.mid++;
		__temp_me54092.m_uniforms = new haxe.root.Array<haxor.graphics.material.MaterialUniform>(new haxor.graphics.material.MaterialUniform[]{});
		__temp_me54092.queue = 1000;
		__temp_me54092.zfunc = 515;
		__temp_me54092.ztest = true;
		__temp_me54092.zwrite = true;
		__temp_me54092.blend = false;
		__temp_me54092.blendSrc = 1;
		__temp_me54092.blendDst = 0;
		__temp_me54092.invert = false;
		__temp_me54092.cull = 2;
		__temp_me54092.lighting = false;
		__temp_me54092.grab = false;
		haxor.context.EngineContext.material.InitializeMaterial(__temp_me54092);
	}
	...
	{
		{
			boolean __temp_executeDef54316 = true;
	...
	{
		{
			boolean __temp_executeDef54317 = true;
			switch (field.hashCode())
			{
				case -159401775:
				{
	...
	{
		{
			boolean __temp_executeDef54318 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef54319 = true;
			switch (field.hashCode())
			{
				case 3065202:
				{
	...
	{
		{
			boolean __temp_executeDef54320 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
