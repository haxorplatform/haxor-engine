...
public  class Material extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_material_Material(haxor.graphics.material.Material __temp_me55699, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me55699, p_name);
		__temp_me55699.grab = false;
		__temp_me55699.__cid = haxor.context.EngineContext.material.mid++;
		__temp_me55699.m_uniforms = new haxe.root.Array<haxor.graphics.material.MaterialUniform>(new haxor.graphics.material.MaterialUniform[]{});
		__temp_me55699.queue = 1000;
		__temp_me55699.zfunc = 515;
		__temp_me55699.ztest = true;
		__temp_me55699.zwrite = true;
		__temp_me55699.blend = false;
		__temp_me55699.blendSrc = 1;
		__temp_me55699.blendDst = 0;
		__temp_me55699.invert = false;
		__temp_me55699.cull = 2;
		__temp_me55699.lighting = false;
		__temp_me55699.grab = false;
		haxor.context.EngineContext.material.InitializeMaterial(__temp_me55699);
	}
	...
	{
		{
			boolean __temp_executeDef55925 = true;
	...
	{
		{
			boolean __temp_executeDef55926 = true;
			switch (field.hashCode())
			{
				case -159401775:
				{
	...
	{
		{
			boolean __temp_executeDef55927 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef55928 = true;
			switch (field.hashCode())
			{
				case 3065202:
				{
	...
	{
		{
			boolean __temp_executeDef55929 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
