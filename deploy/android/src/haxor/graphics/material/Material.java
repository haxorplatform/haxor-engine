...
public  class Material extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_material_Material(haxor.graphics.material.Material __temp_me54496, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me54496, p_name);
		__temp_me54496.grab = false;
		__temp_me54496._cid_ = haxor.context.EngineContext.material.mid++;
		__temp_me54496.m_uniforms = new haxe.root.Array<haxor.graphics.material.MaterialUniform>(new haxor.graphics.material.MaterialUniform[]{});
		__temp_me54496.queue = 1000;
		__temp_me54496.zfunc = 515;
		__temp_me54496.ztest = true;
		__temp_me54496.zwrite = true;
		__temp_me54496.blend = false;
		__temp_me54496.blendSrc = 1;
		__temp_me54496.blendDst = 0;
		__temp_me54496.invert = false;
		__temp_me54496.cull = 2;
		__temp_me54496.lighting = false;
		__temp_me54496.grab = false;
		haxor.context.EngineContext.material.InitializeMaterial(__temp_me54496);
	}
	...
	@Override public   void OnDestroy()
	{
		...
		{
			haxor.graphics.GL.m_gl.DetachShader(p, ((int) (haxe.lang.Runtime.toInt(_this.vertex_shaders.__get(this.m_shader._cid_))) ));
			haxor.graphics.GL.m_gl.DetachShader(p, ((int) (haxe.lang.Runtime.toInt(_this.fragment_shaders.__get(this.m_shader._cid_))) ));
		}
	...
	{
		{
			boolean __temp_executeDef54721 = true;
	...
	{
		{
			boolean __temp_executeDef54722 = true;
			switch (field.hashCode())
			{
				case -159401775:
				{
	...
	{
		{
			boolean __temp_executeDef54723 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef54724 = true;
			switch (field.hashCode())
			{
				case 3065202:
				{
	...
	{
		{
			boolean __temp_executeDef54725 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
