...
public  class Material extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_material_Material(haxor.graphics.material.Material __temp_me219, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me219, ( (( p_name == null )) ? (haxe.lang.Runtime.toString("")) : (p_name) ));
		__temp_me219.grab = false;
		if (( p_name == null )) 
		{
			p_name = "";
		}
		
		{
			...
			{
				__temp_me219.__cid = _this.m_id++;
			}
			 else 
			{
				__temp_me219.__cid = ((int) (haxe.lang.Runtime.toInt(_this.m_cache.shift())) );
			}
			
		}
		
		__temp_me219.m_uniforms = new haxe.root.Array<haxor.graphics.material.MaterialUniform>(new haxor.graphics.material.MaterialUniform[]{});
		__temp_me219.queue = 1000;
		__temp_me219.zfunc = 515;
		__temp_me219.ztest = true;
		__temp_me219.zwrite = true;
		__temp_me219.blend = false;
		__temp_me219.blendSrc = 1;
		__temp_me219.blendDst = 0;
		__temp_me219.invert = false;
		__temp_me219.cull = 2;
		__temp_me219.lighting = false;
		__temp_me219.grab = false;
		haxor.context.EngineContext.material.InitializeMaterial(__temp_me219);
	}
	...
	{
		boolean __temp_p_zwrite209 = ( (( p_zwrite == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_zwrite)) );
		boolean __temp_p_ztest208 = ( (( p_ztest == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_ztest)) );
		...
		m.queue = 1000;
		m.ztest = __temp_p_ztest208;
		m.zwrite = __temp_p_zwrite209;
		if (( p_texture != null )) 
		{
	...
	{
		boolean __temp_p_double_sided212 = ( (( p_double_sided == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_double_sided)) );
		boolean __temp_p_zwrite211 = ( (( p_zwrite == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_zwrite)) );
		boolean __temp_p_ztest210 = ( (( p_ztest == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_ztest)) );
		haxor.graphics.material.Material m = new haxor.graphics.material.Material(haxe.lang.Runtime.toString("Transparent"));
		if (__temp_p_double_sided212) 
		{
			m.cull = 0;
		}
		...
		m.set_shader(( (( p_texture == null )) ? (( (( haxor.graphics.material.Shader.m_flat_shader == null )) ? (haxor.graphics.material.Shader.m_flat_shader = new haxor.graphics.material.Shader(haxe.lang.Runtime.toString(haxor.context.ShaderContext.flat_source))) : (haxor.graphics.material.Shader.m_flat_shader) )) : (( (( haxor.graphics.material.Shader.m_flat_texture_shader == null )) ? (haxor.graphics.material.Shader.m_flat_texture_shader = new haxor.graphics.material.Shader(haxe.lang.Runtime.toString(haxor.context.ShaderContext.flat_texture_source))) : (haxor.graphics.material.Shader.m_flat_texture_shader) )) ));
		m.queue = 2000;
		m.ztest = __temp_p_ztest210;
		m.zwrite = __temp_p_zwrite211;
		m.blend = true;
		if (( p_texture != null )) 
		{
			m.SetTexture("DiffuseTexture", p_texture);
	...
	{
		boolean __temp_p_double_sided215 = ( (( p_double_sided == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_double_sided)) );
		boolean __temp_p_zwrite214 = ( (( p_zwrite == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_zwrite)) );
		boolean __temp_p_ztest213 = ( (( p_ztest == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_ztest)) );
		haxor.graphics.material.Material m = null;
		{
			...
			m1.queue = 2000;
			m1.ztest = __temp_p_ztest213;
			m1.zwrite = __temp_p_zwrite214;
			m1.blend = true;
			m = m1;
		}
	...
	{
		boolean __temp_p_double_sided218 = ( (( p_double_sided == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_double_sided)) );
		boolean __temp_p_zwrite217 = ( (( p_zwrite == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_zwrite)) );
		boolean __temp_p_ztest216 = ( (( p_ztest == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_ztest)) );
		haxor.graphics.material.Material m = null;
		{
			haxor.graphics.material.Material m1 = new haxor.graphics.material.Material(haxe.lang.Runtime.toString("Transparent"));
			if (__temp_p_double_sided218) 
			{
				m1.cull = 0;
			}
			...
			m1.set_shader(( (( haxor.graphics.material.Shader.m_flat_shader == null )) ? (haxor.graphics.material.Shader.m_flat_shader = new haxor.graphics.material.Shader(haxe.lang.Runtime.toString(haxor.context.ShaderContext.flat_source))) : (haxor.graphics.material.Shader.m_flat_shader) ));
			m1.queue = 2000;
			m1.ztest = __temp_p_ztest216;
			m1.zwrite = __temp_p_zwrite217;
			m1.blend = true;
			m = m1;
		}
	...
	{
		boolean __temp_p_transpose206 = ( (( p_transpose == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_transpose)) );
		if (( p_matrix4 == null )) 
		{
			this.RemoveUniform(p_name);
			return ;
		...
		if (u.exists) 
		{
			u.SetMatrix4(p_matrix4, __temp_p_transpose206);
		}
	...
	{
		boolean __temp_p_check_shader207 = ( (( p_check_shader == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_check_shader)) );
		{
			int _g1 = 0;
			int _g = this.m_uniforms.length;
			while (( _g1 < _g ))
	...
	{
		{
			boolean __temp_executeDef1002 = true;
	...
	{
		{
			boolean __temp_executeDef1003 = true;
			switch (field.hashCode())
			{
				case -159401775:
				{
	...
	{
		{
			boolean __temp_executeDef1004 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef1005 = true;
			switch (field.hashCode())
			{
				case 3065202:
				{
	...
	{
		{
			boolean __temp_executeDef1006 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
