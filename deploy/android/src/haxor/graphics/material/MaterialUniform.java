...
public  class MaterialUniform extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_graphics_material_MaterialUniform(haxor.graphics.material.MaterialUniform __temp_me56105, java.lang.String p_name, boolean p_is_float, int p_length, int p_offset)
	{
		__temp_me56105.__cid = haxor.context.EngineContext.material.uid++;
		__temp_me56105.__d = true;
		__temp_me56105.name = p_name;
		__temp_me56105.isFloat = p_is_float;
		__temp_me56105.offset = p_offset;
		if (p_is_float) 
		{
			__temp_me56105.data = new haxor.io.FloatArray(((int) (p_length) ));
		}
		 else 
		{
			__temp_me56105.data = new haxor.io.Int32Array(((int) (p_length) ));
		}
	...
	{
		{
			boolean __temp_executeDef56412 = true;
	...
	{
		{
			boolean __temp_executeDef56413 = true;
			switch (field.hashCode())
			{
				case 2058932050:
				{
	...
	{
		{
			boolean __temp_executeDef56414 = true;
			switch (field.hashCode())
			{
				case 2058932050:
				{
	...
	{
		{
			boolean __temp_executeDef56415 = true;
			switch (field.hashCode())
			{
				case -1019779949:
				{
