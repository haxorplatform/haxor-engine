...
public  class MaterialUniform extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_graphics_material_MaterialUniform(haxor.graphics.material.MaterialUniform __temp_me160497, java.lang.String p_name, boolean p_is_float, int p_length, int p_offset)
	{
		{
			haxor.context.UID _this = haxor.context.EngineContext.material.uid;
			if (( _this.m_cache.length <= 0 )) 
			{
				__temp_me160497.__cid = _this.m_id++;
			}
			 else 
			{
				__temp_me160497.__cid = ((int) (haxe.lang.Runtime.toInt(_this.m_cache.shift())) );
			}
			
		}
		
		__temp_me160497.__d = true;
		__temp_me160497.name = p_name;
		__temp_me160497.isFloat = p_is_float;
		__temp_me160497.offset = p_offset;
		__temp_me160497.exists = false;
		if (p_is_float) 
		{
			__temp_me160497.data = new haxor.io.FloatArray(((int) (p_length) ));
		}
		 else 
		{
			__temp_me160497.data = new haxor.io.Int32Array(((int) (p_length) ));
		}
	...
	{
		{
			boolean __temp_executeDef161241 = true;
	...
	{
		{
			boolean __temp_executeDef161242 = true;
			switch (field.hashCode())
			{
				case -1289358244:
				{
	...
	{
		{
			boolean __temp_executeDef161243 = true;
			switch (field.hashCode())
			{
				case 1454199873:
				{
	...
	{
		{
			boolean __temp_executeDef161244 = true;
			switch (field.hashCode())
			{
				case -1019779949:
				{
	...
	{
		{
			boolean __temp_executeDef161245 = true;
			switch (field.hashCode())
			{
				case 1454199873:
				{
