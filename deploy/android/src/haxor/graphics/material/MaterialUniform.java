...
public  class MaterialUniform extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_graphics_material_MaterialUniform(haxor.graphics.material.MaterialUniform __temp_me164246, java.lang.String p_name, boolean p_is_float, int p_length, int p_offset)
	{
		{
			haxor.context.UID _this = haxor.context.EngineContext.material.uid;
			if (( _this.m_cache.length <= 0 )) 
			{
				__temp_me164246.__cid = _this.m_id++;
			}
			 else 
			{
				__temp_me164246.__cid = ((int) (haxe.lang.Runtime.toInt(_this.m_cache.shift())) );
			}
			
		}
		
		__temp_me164246.__d = true;
		__temp_me164246.name = p_name;
		__temp_me164246.isFloat = p_is_float;
		__temp_me164246.offset = p_offset;
		__temp_me164246.exists = false;
		if (p_is_float) 
		{
			__temp_me164246.data = new haxor.io.FloatArray(((int) (p_length) ));
		}
		 else 
		{
			__temp_me164246.data = new haxor.io.Int32Array(((int) (p_length) ));
		}
	...
	public   void SetMatrix4(haxor.math.Matrix4 m)
	{
		if ( ! (this.exists) ) 
		{
			return ;
	...
	{
		{
			boolean __temp_executeDef164945 = true;
	...
	{
		{
			boolean __temp_executeDef164946 = true;
			switch (field.hashCode())
			{
				case -1289358244:
				{
	...
	{
		{
			boolean __temp_executeDef164947 = true;
			switch (field.hashCode())
			{
				case 1454199873:
				{
	...
	{
		{
			boolean __temp_executeDef164948 = true;
			switch (field.hashCode())
			{
				case -1019779949:
				{
	...
	{
		{
			boolean __temp_executeDef164949 = true;
			switch (field.hashCode())
			{
				case 1454199873:
				{
