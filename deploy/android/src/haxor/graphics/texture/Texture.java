...
public  class Texture extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_texture_Texture(haxor.graphics.texture.Texture __temp_me255466)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me255466, null);
		__temp_me255466.m_mipmaps = false;
		__temp_me255466.m_format = haxor.core.PixelFormat.RGBA8;
		__temp_me255466.m_minFilter = haxor.core.TextureFilter.Linear;
		__temp_me255466.m_magFilter = haxor.core.TextureFilter.Linear;
		__temp_me255466.m_wrap = ( ( haxor.core.TextureWrap.ClampX | haxor.core.TextureWrap.ClampY ) | haxor.core.TextureWrap.ClampZ );
		__temp_me255466.m_width = 0;
		__temp_me255466.m_height = 0;
		__temp_me255466.m_aniso = 0;
		{
			haxor.context.UID _this = haxor.context.EngineContext.texture.tid;
			if (( _this.m_cache.length <= 0 )) 
			{
				__temp_me255466.__cid = _this.m_id++;
			}
			 else 
			{
				__temp_me255466.__cid = ((int) (haxe.lang.Runtime.toInt(_this.m_cache.shift())) );
			}
	...
	{
		{
			boolean __temp_executeDef256180 = true;
	...
	{
		{
			boolean __temp_executeDef256181 = true;
			switch (field.hashCode())
			{
				case -1483930146:
				{
	...
	{
		{
			boolean __temp_executeDef256182 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef256183 = true;
			switch (field.hashCode())
			{
				case -1483930146:
				{
	...
	{
		{
			boolean __temp_executeDef256184 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
