...
public  class Texture extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_texture_Texture(haxor.graphics.texture.Texture __temp_me33834)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me33834, null);
		__temp_me33834.m_mipmaps = false;
		__temp_me33834.m_format = haxor.graphics.PixelFormat.RGBA8;
		__temp_me33834.m_minFilter = haxor.graphics.TextureFilter.Linear;
		__temp_me33834.m_magFilter = haxor.graphics.TextureFilter.Linear;
		__temp_me33834.m_wrap = ( ( haxor.graphics.TextureWrap.ClampX | haxor.graphics.TextureWrap.ClampY ) | haxor.graphics.TextureWrap.ClampZ );
		__temp_me33834.m_width = 0;
		__temp_me33834.m_height = 0;
		__temp_me33834.m_aniso = 0;
		__temp_me33834._cid_ = haxor.context.EngineContext.texture.tid++;
		haxor.context.EngineContext.texture.Create(__temp_me33834);
	}
	...
	public final   haxor.graphics.TextureType get_type()
	{
	...
	{
		{
			boolean __temp_executeDef34038 = true;
	...
	{
		{
			boolean __temp_executeDef34039 = true;
			switch (field.hashCode())
			{
				case 3575610:
				{
	...
	{
		{
			boolean __temp_executeDef34040 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef34041 = true;
			switch (field.hashCode())
			{
				case 766385894:
				{
	...
	{
		{
			boolean __temp_executeDef34042 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
