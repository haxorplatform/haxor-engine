...
public  class RenderTexture extends haxor.graphics.texture.Texture
{
	...
	public static   void __hx_ctor_haxor_graphics_texture_RenderTexture(haxor.graphics.texture.RenderTexture __temp_me257, int p_width, int p_height, haxor.core.PixelFormat p_format, java.lang.Object p_store_depth)
	{
		haxor.graphics.texture.Texture.__hx_ctor_haxor_graphics_texture_Texture(__temp_me257);
		boolean __temp_p_store_depth256 = ( (( p_store_depth == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_store_depth)) );
		__temp_me257.m_format = p_format;
		__temp_me257.m_width = ((int) (p_width) );
		__temp_me257.m_height = ((int) (p_height) );
		boolean store_depth = ( __temp_p_store_depth256 && haxor.graphics.GL.TEXTURE_DEPTH_ENABLED );
		if (store_depth) 
		{
			__temp_me257.m_depth = new haxor.graphics.texture.Texture2D(((int) (__temp_me257.m_width) ), ((int) (__temp_me257.m_height) ), ((haxor.core.PixelFormat) (haxor.core.PixelFormat.Depth) ));
		}
		
		haxor.context.EngineContext.texture.Create(__temp_me257);
	}
	...
	{
		{
			boolean __temp_executeDef1058 = true;
	...
	{
		{
			boolean __temp_executeDef1059 = true;
			switch (field.hashCode())
			{
				case 1976688259:
				{
	...
	{
		{
			boolean __temp_executeDef1060 = true;
			switch (field.hashCode())
			{
				case 1976688259:
				{
