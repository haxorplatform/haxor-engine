...
public  class TextureCube extends haxor.graphics.texture.Texture
{
	...
	public static   void __hx_ctor_haxor_graphics_texture_TextureCube(haxor.graphics.texture.TextureCube __temp_me255481)
	{
		__temp_me255481.m_faces = new haxe.root.Array<haxor.graphics.texture.Texture>(new haxor.graphics.texture.Texture[]{null, null, null, null, null, null});
		__temp_me255481.m_is_cross = false;
		haxor.graphics.texture.Texture.__hx_ctor_haxor_graphics_texture_Texture(__temp_me255481);
		haxor.context.EngineContext.texture.Create(__temp_me255481);
	}
	...
	{
		{
			boolean __temp_executeDef256195 = true;
	...
	{
		{
			boolean __temp_executeDef256196 = true;
			switch (field.hashCode())
			{
				case 2043460517:
				{
	...
	{
		{
			boolean __temp_executeDef256197 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
