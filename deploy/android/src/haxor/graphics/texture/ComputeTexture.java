...
public  class ComputeTexture extends haxor.graphics.texture.Texture2D
{
	...
	public static   void __hx_ctor_haxor_graphics_texture_ComputeTexture(haxor.graphics.texture.ComputeTexture __temp_me164280, int p_width, int p_height, haxor.core.PixelFormat p_format)
	{
		haxor.graphics.texture.Texture2D.__hx_ctor_haxor_graphics_texture_Texture2D(__temp_me164280, p_width, p_height, p_format);
		__temp_me164280.set_minFilter(haxor.core.TextureFilter.Nearest);
		__temp_me164280.set_magFilter(haxor.core.TextureFilter.Nearest);
		__temp_me164280.m_lock = false;
		__temp_me164280.m_dirty = false;
	}
	...
	{
		java.lang.Object __temp_p_v3164275 = ( (( p_v3 == null )) ? (((java.lang.Object) (0) )) : (((java.lang.Object) (p_v3) )) );
		java.lang.Object __temp_p_v2164274 = ( (( p_v2 == null )) ? (((java.lang.Object) (0) )) : (((java.lang.Object) (p_v2) )) );
		java.lang.Object __temp_p_v1164273 = ( (( p_v1 == null )) ? (((java.lang.Object) (0) )) : (((java.lang.Object) (p_v1) )) );
		java.lang.Object __temp_p_v0164272 = ( (( p_v0 == null )) ? (((java.lang.Object) (0) )) : (((java.lang.Object) (p_v0) )) );
		haxor.math.Color __temp_stmt164996 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt164996 = _this.m_c.__get(_this.m_nc = ( (( _this.m_nc + 1 )) % _this.m_c.length ));
		}
		
		this.m_data.SetPixel(p_x, p_y, __temp_stmt164996.Set(__temp_p_v0164272, __temp_p_v1164273, __temp_p_v2164274, __temp_p_v3164275));
		this.m_dirty = true;
		this.Refresh();
	}
	...
	{
		int __temp_p_height164279 = ( (( p_height == null )) ? (((int) (-1) )) : (((int) (haxe.lang.Runtime.toInt(p_height)) )) );
		int __temp_p_width164278 = ( (( p_width == null )) ? (((int) (-1) )) : (((int) (haxe.lang.Runtime.toInt(p_width)) )) );
		int __temp_p_y164277 = ( (( p_y == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_y)) )) );
		int __temp_p_x164276 = ( (( p_x == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_x)) )) );
		int w = 0;
		if (( __temp_p_width164278 < 0 )) 
		{
			w = this.m_width;
		}
		 else 
		{
			w = __temp_p_width164278;
		}
		
		int h = 0;
		if (( __temp_p_height164279 < 0 )) 
		{
			h = this.m_height;
		}
		 else 
		{
			h = __temp_p_height164279;
		}
		
		this.m_data.SetRange(__temp_p_x164276, __temp_p_y164277, w, h, p_values, null);
		this.Refresh();
		this.m_dirty = true;
	}
	...
	{
		{
			boolean __temp_executeDef164997 = true;
	...
	{
		{
			boolean __temp_executeDef164998 = true;
			switch (field.hashCode())
			{
				case -1190396359:
				{
	...
	{
		{
			boolean __temp_executeDef164999 = true;
			switch (field.hashCode())
			{
				case -1190396359:
				{
