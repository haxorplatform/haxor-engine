...
public  class Bitmap extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_texture_Bitmap(haxor.graphics.texture.Bitmap __temp_me55707, int p_width, int p_height, haxor.graphics.PixelFormat p_format)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me55707, null);
		__temp_me55707.m_width = p_width;
		__temp_me55707.m_height = p_height;
		__temp_me55707.m_format = p_format;
		__temp_me55707.m_float = false;
		__temp_me55707.m_channels = 1;
		...
		int len = ( ( __temp_me55707.m_width * __temp_me55707.m_height ) * __temp_me55707.m_channels );
		if (__temp_me55707.m_float) 
		{
			__temp_me55707.m_buffer = new haxor.io.FloatArray(((int) (len) ));
		}
		 else 
		{
			__temp_me55707.m_buffer = new haxor.io.Buffer(((int) (len) ));
		}
	...
	{
		{
			boolean __temp_executeDef55949 = true;
	...
	{
		{
			boolean __temp_executeDef55950 = true;
			switch (field.hashCode())
			{
				case -1867509751:
				{
	...
	{
		{
			boolean __temp_executeDef55951 = true;
			switch (field.hashCode())
			{
				case 2189731:
				{
	...
	{
		{
			boolean __temp_executeDef55952 = true;
			switch (field.hashCode())
			{
				case 1578008418:
				{
	...
	{
		{
			boolean __temp_executeDef55953 = true;
			switch (field.hashCode())
			{
				case 2189731:
				{
