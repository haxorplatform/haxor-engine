...
public  class Bitmap extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_texture_Bitmap(haxor.graphics.texture.Bitmap __temp_me242, int p_width, int p_height, haxor.core.PixelFormat p_format)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me242, null);
		__temp_me242.m_width = p_width;
		__temp_me242.m_height = p_height;
		__temp_me242.m_format = p_format;
		__temp_me242.m_float = false;
		__temp_me242.m_channels = 1;
		...
		int len = ( ( __temp_me242.m_width * __temp_me242.m_height ) * __temp_me242.m_channels );
		if (__temp_me242.m_float) 
		{
			__temp_me242.m_buffer = new haxor.io.FloatArray(((int) (len) ));
		}
		 else 
		{
			__temp_me242.m_buffer = new haxor.io.Buffer(((int) (len) ));
		}
	...
	{
		double __temp_p_v3240 = ( (( p_v3 == null )) ? (((double) (0.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_v3)) )) );
		double __temp_p_v2239 = ( (( p_v2 == null )) ? (((double) (0.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_v2)) )) );
		double __temp_p_v1238 = ( (( p_v1 == null )) ? (((double) (0.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_v1)) )) );
		double __temp_p_v0237 = ( (( p_v0 == null )) ? (((double) (0.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_v0)) )) );
		int cc = this.m_channels;
		p_y = ( ( this.m_height - 1 ) - p_y );
		int pos = ( (( p_x + ( p_y * this.m_width ) )) * cc );
		if (this.m_float) 
		{
			haxor.io.FloatArray b = ((haxor.io.FloatArray) (this.m_buffer) );
			b.Set(pos, __temp_p_v0237);
			if (( cc >= 2 )) 
			{
				b.Set(( pos + 1 ), __temp_p_v1238);
			}
			
			if (( cc >= 3 )) 
			{
				b.Set(( pos + 2 ), __temp_p_v2239);
			}
			
			if (( cc >= 4 )) 
			{
				b.Set(( pos + 3 ), __temp_p_v3240);
			}
		...
		haxor.io.Buffer b1 = ((haxor.io.Buffer) (this.m_buffer) );
		b1.SetByte(pos, ((int) (( __temp_p_v0237 * 255.0 )) ));
		if (( cc >= 2 )) 
		{
			b1.SetByte(( pos + 1 ), ((int) (( __temp_p_v1238 * 255.0 )) ));
		}
		
		if (( cc >= 3 )) 
		{
			b1.SetByte(( pos + 2 ), ((int) (( __temp_p_v2239 * 255.0 )) ));
		}
		
		if (( cc >= 4 )) 
		{
			b1.SetByte(( pos + 3 ), ((int) (( __temp_p_v3240 * 255.0 )) ));
		}
	...
	{
		int __temp_p_length241 = ( (( p_length == null )) ? (((int) (-1) )) : (((int) (haxe.lang.Runtime.toInt(p_length)) )) );
		p_y = ( ( this.m_height - 1 ) - p_y );
		int cc = this.m_channels;
		int len = 0;
		if (( __temp_p_length241 < 0 )) 
		{
			len = p_values.length;
		}
		 else 
		{
			len = __temp_p_length241;
		}
	...
	{
		{
			boolean __temp_executeDef1041 = true;
	...
	{
		{
			boolean __temp_executeDef1042 = true;
			switch (field.hashCode())
			{
				case -1867509751:
				{
	...
	{
		{
			boolean __temp_executeDef1043 = true;
			switch (field.hashCode())
			{
				case 1467637275:
				{
	...
	{
		{
			boolean __temp_executeDef1044 = true;
			switch (field.hashCode())
			{
				case 1578008418:
				{
	...
	{
		{
			boolean __temp_executeDef1045 = true;
			switch (field.hashCode())
			{
				case 1467637275:
				{
