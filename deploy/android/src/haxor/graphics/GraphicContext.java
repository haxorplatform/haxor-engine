...
public  class GraphicContext extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_graphics_GraphicContext(haxor.graphics.GraphicContext __temp_me255418, haxor.core.BaseApplication p_application)
	{
		__temp_me255418.m_api = haxor.graphics.GraphicAPI.None;
		__temp_me255418.m_application = p_application;
	}
	...
	{
		{
			boolean __temp_executeDef256098 = true;
	...
	{
		{
			boolean __temp_executeDef256099 = true;
			switch (field.hashCode())
			{
				case 2054294852:
				{
	...
	{
		{
			boolean __temp_executeDef256100 = true;
			switch (field.hashCode())
			{
				case 2054294852:
				{
