...
public  class GraphicContext extends haxe.lang.HxObject
{
	...
	{
		haxor.graphics.GraphicContext.__hx_ctor_haxor_graphics_GraphicContext(this, p_application);
	}
	
	
	public static   void __hx_ctor_haxor_graphics_GraphicContext(haxor.graphics.GraphicContext __temp_me164224, haxor.core.BaseApplication p_application)
	{
		__temp_me164224.m_api = haxor.graphics.GraphicAPI.None;
		__temp_me164224.m_application = p_application;
	}
	
	
	public static   java.lang.Object __hx_createEmpty()
	{
		return new haxor.graphics.GraphicContext(((haxe.lang.EmptyObject) (haxe.lang.EmptyObject.EMPTY) ));
	}
	
	
	public static   java.lang.Object __hx_create(haxe.root.Array arr)
	{
		return new haxor.graphics.GraphicContext(((haxor.core.BaseApplication) (arr.__get(0)) ));
	}
	
	
	
	
	public   haxor.graphics.GraphicAPI get_api()
	{
		return this.m_api;
	}
	
	
	public  haxor.graphics.GraphicAPI m_api;
	...
	{
		{
			boolean __temp_executeDef164902 = true;
			switch (field.hashCode())
			{
				...
				case 103590728:
				{
					...
					{
						__temp_executeDef164902 = false;
						this.m_api = ((haxor.graphics.GraphicAPI) (value) );
						return value;
					}
	...
	{
		{
			boolean __temp_executeDef164903 = true;
			switch (field.hashCode())
			{
				case 2054294852:
				{
	...
	{
		{
			boolean __temp_executeDef164904 = true;
			switch (field.hashCode())
			{
				case 2054294852:
				{
