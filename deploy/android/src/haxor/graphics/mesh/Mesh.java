...
public  class Mesh extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_mesh_Mesh(haxor.graphics.mesh.Mesh __temp_me56110)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me56110, null);
		__temp_me56110.__cid = haxor.context.EngineContext.mesh.mid++;
		__temp_me56110.m_attribs = new haxe.root.Array<haxor.graphics.mesh.MeshAttrib>(new haxor.graphics.mesh.MeshAttrib[]{});
		__temp_me56110.m_indexed = false;
		__temp_me56110.m_vcount = 0;
		__temp_me56110.m_mode = 35048;
		__temp_me56110.primitive = 4;
		__temp_me56110.m_topology_attrib = new haxor.graphics.mesh.MeshAttrib();
		__temp_me56110.m_topology_attrib.m_name = "$topology";
		__temp_me56110.m_topology_attrib.offset = 1;
	}
	...
	{
		boolean __temp_p_from_gpu56108 = ( (( p_from_gpu == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_from_gpu)) );
		{
			int _g1 = 0;
			int _g = this.m_attribs.length;
			while (( _g1 < _g ))
	...
	{
		int __temp_p_offset56109 = ( (( p_offset == null )) ? (((int) (3) )) : (((int) (haxe.lang.Runtime.toInt(p_offset)) )) );
		if (( p_data == null )) 
		{
	...
	{
		{
			boolean __temp_executeDef56421 = true;
	...
	{
		{
			boolean __temp_executeDef56422 = true;
			switch (field.hashCode())
			{
				case -1420606869:
				{
	...
	{
		{
			boolean __temp_executeDef56423 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef56424 = true;
			switch (field.hashCode())
			{
				case -1420606869:
				{
	...
	{
		{
			boolean __temp_executeDef56425 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
