...
public  class Mesh extends haxor.core.Resource
{
	...
	public static   void __hx_ctor_haxor_graphics_mesh_Mesh(haxor.graphics.mesh.Mesh __temp_me164251, java.lang.String p_name)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me164251, ( (( p_name == null )) ? (haxe.lang.Runtime.toString("")) : (p_name) ));
		if (( p_name == null )) 
		{
			p_name = "";
		}
		
		{
			...
			{
				__temp_me164251.__cid = _this.m_id++;
			}
			 else 
			{
				__temp_me164251.__cid = ((int) (haxe.lang.Runtime.toInt(_this.m_cache.shift())) );
			}
			
		}
		
		__temp_me164251.m_attribs = new haxe.root.Array<haxor.graphics.mesh.MeshAttrib>(new haxor.graphics.mesh.MeshAttrib[]{});
		__temp_me164251.m_indexed = false;
		__temp_me164251.m_vcount = 0;
		__temp_me164251.m_bounds = haxor.math.AABB3.get_empty();
		__temp_me164251.m_mode = 35044;
		__temp_me164251.primitive = 4;
		__temp_me164251.m_topology_attrib = new haxor.graphics.mesh.MeshAttrib();
		__temp_me164251.m_topology_attrib.m_name = "$topology";
		__temp_me164251.m_topology_attrib.offset = 1;
	}
	...
	{
		boolean __temp_p_from_gpu164249 = ( (( p_from_gpu == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_from_gpu)) );
		{
			int _g1 = 0;
			int _g = this.m_attribs.length;
			while (( _g1 < _g ))
	...
	{
		int __temp_p_offset164250 = ( (( p_offset == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_offset)) )) );
		if (( p_data == null )) 
		{
		...
		if (( __temp_p_offset164250 > 0 )) 
		{
			a.offset = __temp_p_offset164250;
		}
	...
	{
		{
			boolean __temp_executeDef164956 = true;
	...
	{
		{
			boolean __temp_executeDef164957 = true;
			switch (field.hashCode())
			{
				case -1981935929:
				{
	...
	{
		{
			boolean __temp_executeDef164958 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
	...
	{
		{
			boolean __temp_executeDef164959 = true;
			switch (field.hashCode())
			{
				case -1420606869:
				{
	...
	{
		{
			boolean __temp_executeDef164960 = true;
			switch (field.hashCode())
			{
				case 602652923:
				{
