...
public  class Mesh2D extends haxor.graphics.mesh.MeshLayout<haxor.math.Vector2, haxor.math.Vector3, haxor.math.Vector2, haxor.math.Vector2, haxor.math.Vector3, haxor.math.Vector3>
{
	...
	public static   void __hx_ctor_haxor_graphics_mesh_Mesh2D(haxor.graphics.mesh.Mesh2D __temp_me80660, java.lang.String p_name)
	{
		haxor.graphics.mesh.MeshLayout.__hx_ctor_haxor_graphics_mesh_MeshLayout(__temp_me80660, p_name);
	}
