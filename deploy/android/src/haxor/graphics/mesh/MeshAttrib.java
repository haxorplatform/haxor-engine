...
public  class MeshAttrib extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_graphics_mesh_MeshAttrib(haxor.graphics.mesh.MeshAttrib __temp_me33832)
	{
		__temp_me33832._cid_ = haxor.context.EngineContext.mesh.aid++;
		__temp_me33832._loc_ = -1;
		__temp_me33832.m_name = "";
		__temp_me33832.data = null;
		__temp_me33832.offset = 0;
	}
	...
	{
		{
			boolean __temp_executeDef34028 = true;
	...
	{
		{
			boolean __temp_executeDef34029 = true;
			switch (field.hashCode())
			{
				case -1019779949:
				{
	...
	{
		{
			boolean __temp_executeDef34030 = true;
			switch (field.hashCode())
			{
				case 1131801318:
				{
	...
	{
		{
			boolean __temp_executeDef34031 = true;
			switch (field.hashCode())
			{
				case 94851343:
				{
	...
	{
		{
			boolean __temp_executeDef34032 = true;
			switch (field.hashCode())
			{
				case 1131801318:
				{
