...
public  class MeshAttrib extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_graphics_mesh_MeshAttrib(haxor.graphics.mesh.MeshAttrib __temp_me27909)
	{
		__temp_me27909._cid_ = haxor.context.EngineContext.mesh.aid++;
		__temp_me27909._loc_ = -1;
		__temp_me27909.m_name = "";
		__temp_me27909.data = null;
		__temp_me27909.offset = 0;
	}
	...
	{
		{
			boolean __temp_executeDef28090 = true;
	...
	{
		{
			boolean __temp_executeDef28091 = true;
			switch (field.hashCode())
			{
				case -1019779949:
				{
	...
	{
		{
			boolean __temp_executeDef28092 = true;
			switch (field.hashCode())
			{
				case 1131801318:
				{
	...
	{
		{
			boolean __temp_executeDef28093 = true;
			switch (field.hashCode())
			{
				case 94851343:
				{
	...
	{
		{
			boolean __temp_executeDef28094 = true;
			switch (field.hashCode())
			{
				case 1131801318:
				{
