...
public  class Mesh2 extends haxor.graphics.mesh.MeshLayout<haxor.math.Vector3, haxor.math.Vector3, haxor.math.Vector2, haxor.math.Vector2, haxor.math.Vector3, haxor.math.Vector3>
{
	...
	public static   void __hx_ctor_haxor_graphics_mesh_Mesh2(haxor.graphics.mesh.Mesh2 __temp_me234, java.lang.String p_name)
	{
		haxor.graphics.mesh.MeshLayout.__hx_ctor_haxor_graphics_mesh_MeshLayout(__temp_me234, p_name);
	}
