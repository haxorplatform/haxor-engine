...
public  class Model extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_graphics_mesh_Model(haxor.graphics.mesh.Model __temp_me160512)
	{
		{
		}
	...
	public static   haxor.graphics.mesh.Mesh get_screen()
	{
		...
		m.Set("vertex", v, 3);
		m.Set("uv0", uv, 3);
		haxor.math.AABB3 __temp_stmt161268 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt161268 = _this.m_aabb3.__get(_this.m_naabb3 = ( (( _this.m_naabb3 + 1 )) % _this.m_aabb3.length ));
		}
		
		m.set_bounds(m.GenerateAttribBounds("vertex", __temp_stmt161268));
	...
	public static   haxor.graphics.mesh.Mesh get_planeXY()
	{
		...
		m.Set("vertex", v, 3);
		m.Set("uv0", uv, 3);
		haxor.math.AABB3 __temp_stmt161269 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt161269 = _this.m_aabb3.__get(_this.m_naabb3 = ( (( _this.m_naabb3 + 1 )) % _this.m_aabb3.length ));
		}
		
		m.set_bounds(m.GenerateAttribBounds("vertex", __temp_stmt161269));
		m.set_topology(haxor.io.UInt16Array.Alloc(new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{0, 1, 2, 0, 2, 3})));
	...
	public static   haxor.graphics.mesh.Mesh get_planeXZ()
	{
		...
		m.Set("vertex", v, 3);
		m.Set("uv0", uv, 3);
		haxor.math.AABB3 __temp_stmt161270 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt161270 = _this.m_aabb3.__get(_this.m_naabb3 = ( (( _this.m_naabb3 + 1 )) % _this.m_aabb3.length ));
		}
		
		m.set_bounds(m.GenerateAttribBounds("vertex", __temp_stmt161270));
		m.set_topology(haxor.io.UInt16Array.Alloc(new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{0, 1, 2, 0, 2, 3})));
	...
	public static   haxor.graphics.mesh.Mesh get_planeYZ()
	{
		...
		m.Set("vertex", v, 3);
		m.Set("uv0", uv, 3);
		haxor.math.AABB3 __temp_stmt161271 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt161271 = _this.m_aabb3.__get(_this.m_naabb3 = ( (( _this.m_naabb3 + 1 )) % _this.m_aabb3.length ));
		}
		
		m.set_bounds(m.GenerateAttribBounds("vertex", __temp_stmt161271));
		m.set_topology(haxor.io.UInt16Array.Alloc(new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{0, 1, 2, 0, 2, 3})));
	...
	public static   haxor.graphics.mesh.Mesh get_cube()
	{
		...
		m.Set("uv0", uv, 3);
		m.Set("normal", n, 3);
		haxor.math.AABB3 __temp_stmt161272 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt161272 = _this.m_aabb3.__get(_this.m_naabb3 = ( (( _this.m_naabb3 + 1 )) % _this.m_aabb3.length ));
		}
		
		m.set_bounds(m.GenerateAttribBounds("vertex", __temp_stmt161272));
	...
	public static   haxor.graphics.mesh.Mesh get_tetrahedron()
	{
		...
		m.Set("uv0", uv, 3);
		m.Set("normal", n, 3);
		haxor.math.AABB3 __temp_stmt161273 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt161273 = _this.m_aabb3.__get(_this.m_naabb3 = ( (( _this.m_naabb3 + 1 )) % _this.m_aabb3.length ));
		}
		
		m.set_bounds(m.GenerateAttribBounds("vertex", __temp_stmt161273));
	...
	public static   haxor.graphics.mesh.Mesh get_sphere()
	{
		...
		m.Set("uv0", uv, 3);
		m.Set("normal", n, 3);
		haxor.math.AABB3 __temp_stmt161274 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt161274 = _this.m_aabb3.__get(_this.m_naabb3 = ( (( _this.m_naabb3 + 1 )) % _this.m_aabb3.length ));
		}
		
		m.set_bounds(m.GenerateAttribBounds("vertex", __temp_stmt161274));
