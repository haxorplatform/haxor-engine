...
public  class SkinnedMesh3 extends haxor.graphics.mesh.Mesh3
{
	...
	public static   void __hx_ctor_haxor_graphics_mesh_SkinnedMesh3(haxor.graphics.mesh.SkinnedMesh3 __temp_me80659, java.lang.String p_name)
	{
		haxor.graphics.mesh.Mesh3.__hx_ctor_haxor_graphics_mesh_Mesh3(__temp_me80659, p_name);
	}
	...
	{
		{
			boolean __temp_executeDef81407 = true;
	...
	{
		{
			boolean __temp_executeDef81408 = true;
			switch (field.hashCode())
			{
				case -1390323062:
				{
	...
	{
		{
			boolean __temp_executeDef81409 = true;
			switch (field.hashCode())
			{
				case -1069076235:
				{
