...
public  class Activity_Iterate_42__Fun extends haxe.lang.Function
{
	public    Activity_Iterate_42__Fun(haxe.root.Array<haxe.lang.Function> p_callback1, haxe.root.Array<java.lang.Object> p_length1, haxe.root.Array<java.lang.Object> p_step1, haxe.root.Array<java.lang.Object> it)
	{
		super(1, 0);
	...
	@Override public   java.lang.Object __hx_invoke1_o(double __fn_float1, java.lang.Object __fn_dyn1)
	{
		...
		boolean finished = false;
		{
			...
			while (( _g < ((int) (haxe.lang.Runtime.toInt(this.p_step1.__get(0))) ) ))
			{
				...
				{
					int __temp_arrIndex164478 = 0;
					int __temp_arrVal164476 = ((int) (haxe.lang.Runtime.toInt(this.it.__get(__temp_arrIndex164478))) );
					int __temp_arrRet164477 = __temp_arrVal164476++;
					this.it.__set(__temp_arrIndex164478, __temp_arrVal164476);
					int __temp_expr165296 = __temp_arrRet164477;
				}
