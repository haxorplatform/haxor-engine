...
{
	public    Activity_Iterate_43__Fun(haxe.root.Array<java.lang.Object> it, haxe.root.Array<java.lang.Object> p_step1, haxe.root.Array<java.lang.Object> p_length1, haxe.root.Array<haxe.lang.Function> p_callback1)
	{
		super(1, 0);
		this.it = it;
	...
	@Override public   java.lang.Object __hx_invoke1_o(double __fn_float1, java.lang.Object __fn_dyn1)
	{
		...
		boolean finished = false;
		{
			...
			while (( _g < ((int) (haxe.lang.Runtime.toInt(this.p_step1.__get(0))) ) ))
			{
				...
				{
					int __temp_arrIndex398 = 0;
					int __temp_arrVal396 = ((int) (haxe.lang.Runtime.toInt(this.it.__get(__temp_arrIndex398))) );
					int __temp_arrRet397 = __temp_arrVal396++;
					this.it.__set(__temp_arrIndex398, __temp_arrVal396);
					int __temp_expr1297 = __temp_arrRet397;
				}
