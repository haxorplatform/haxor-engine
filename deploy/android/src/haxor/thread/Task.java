...
public  class Task extends haxor.thread.Activity
{
	...
	public static   void __hx_ctor_haxor_thread_Task(haxor.thread.Task __temp_me363, java.lang.Object p_threaded, haxe.lang.Function p_callback)
	{
		boolean __temp_p_threaded362 = ( (( p_threaded == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_threaded)) );
		haxe.lang.Function cb = p_callback;
		if (( cb == null )) 
		{
			cb = ((haxe.lang.Function) (new haxe.lang.Closure(((java.lang.Object) (__temp_me363) ), haxe.lang.Runtime.toString("OnExecute"))) );
		}
		
		haxor.thread.Activity.__hx_ctor_haxor_thread_Activity(__temp_me363, cb, __temp_p_threaded362, null);
		__temp_me363.m_active = false;
		__temp_me363.m_progress = 0.0;
		__temp_me363.m_has_progress = false;
	}
	...
	{
		{
			boolean __temp_executeDef1298 = true;
	...
	{
		{
			boolean __temp_executeDef1299 = true;
			switch (field.hashCode())
			{
				case -2021681384:
				{
	...
	{
		{
			boolean __temp_executeDef1300 = true;
			switch (field.hashCode())
			{
				case 2020677750:
				{
	...
	{
		{
			boolean __temp_executeDef1301 = true;
			switch (field.hashCode())
			{
				case -855695937:
				{
	...
	{
		{
			boolean __temp_executeDef1302 = true;
			switch (field.hashCode())
			{
				case 2020677750:
				{
