...
public  class Task extends haxor.thread.Activity
{
	...
	public static   void __hx_ctor_haxor_thread_Task(haxor.thread.Task __temp_me151581, java.lang.Object p_threaded, haxe.lang.Function p_callback)
	{
		boolean __temp_p_threaded151580 = ( (( p_threaded == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_threaded)) );
		haxe.lang.Function cb = p_callback;
		if (( cb == null )) 
		{
			cb = ((haxe.lang.Function) (new haxe.lang.Closure(((java.lang.Object) (__temp_me151581) ), haxe.lang.Runtime.toString("OnExecute"))) );
		}
		
		haxor.thread.Activity.__hx_ctor_haxor_thread_Activity(__temp_me151581, cb, __temp_p_threaded151580, null);
		__temp_me151581.m_active = false;
		__temp_me151581.m_progress = 0.0;
		__temp_me151581.m_has_progress = false;
	}
	...
	{
		{
			boolean __temp_executeDef152461 = true;
	...
	{
		{
			boolean __temp_executeDef152462 = true;
			switch (field.hashCode())
			{
				case -2021681384:
				{
	...
	{
		{
			boolean __temp_executeDef152463 = true;
			switch (field.hashCode())
			{
				case 2020677750:
				{
	...
	{
		{
			boolean __temp_executeDef152464 = true;
			switch (field.hashCode())
			{
				case -855695937:
				{
	...
	{
		{
			boolean __temp_executeDef152465 = true;
			switch (field.hashCode())
			{
				case 2020677750:
				{
