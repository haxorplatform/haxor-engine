...
public  class Task extends haxor.thread.Activity
{
	...
	public static   void __hx_ctor_haxor_thread_Task(haxor.thread.Task __temp_me160693, java.lang.Object p_threaded, haxe.lang.Function p_callback)
	{
		boolean __temp_p_threaded160692 = ( (( p_threaded == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_threaded)) );
		haxe.lang.Function cb = p_callback;
		if (( cb == null )) 
		{
			cb = ((haxe.lang.Function) (new haxe.lang.Closure(((java.lang.Object) (__temp_me160693) ), haxe.lang.Runtime.toString("OnExecute"))) );
		}
		
		haxor.thread.Activity.__hx_ctor_haxor_thread_Activity(__temp_me160693, cb, __temp_p_threaded160692, null);
		__temp_me160693.m_active = false;
		__temp_me160693.m_progress = 0.0;
		__temp_me160693.m_has_progress = false;
	}
	...
	{
		{
			boolean __temp_executeDef161593 = true;
	...
	{
		{
			boolean __temp_executeDef161594 = true;
			switch (field.hashCode())
			{
				case -2021681384:
				{
	...
	{
		{
			boolean __temp_executeDef161595 = true;
			switch (field.hashCode())
			{
				case 2020677750:
				{
	...
	{
		{
			boolean __temp_executeDef161596 = true;
			switch (field.hashCode())
			{
				case -855695937:
				{
	...
	{
		{
			boolean __temp_executeDef161597 = true;
			switch (field.hashCode())
			{
				case 2020677750:
				{
