...
public  class Activity extends haxor.core.Resource implements java.lang.Runnable, haxor.core.IRenderable, haxor.core.IUpdateable
{
	...
	public static   void __hx_ctor_haxor_thread_Activity(haxor.thread.Activity __temp_me151579, haxe.lang.Function p_callback, java.lang.Object p_threaded, java.lang.Object p_graphics_context)
	{
		haxor.core.Resource.__hx_ctor_haxor_core_Resource(__temp_me151579, null);
		boolean __temp_p_graphics_context151578 = ( (( p_graphics_context == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_graphics_context)) );
		boolean __temp_p_threaded151577 = ( (( p_threaded == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_threaded)) );
		if (( p_callback == null )) 
		{
			return ;
		}
		
		__temp_me151579.m_time_start = haxor.core.Time.m_elapsed;
		__temp_me151579.m_elapsed = 0.0;
		__temp_me151579.m_callback = p_callback;
		__temp_me151579.m_cancelled = false;
		if (__temp_p_graphics_context151578) 
		{
			__temp_p_threaded151577 = false;
		}
		
		if ( ! (__temp_p_threaded151577) ) 
		{
			if (__temp_p_graphics_context151578) 
			{
				haxor.context.EngineContext.render.Add(__temp_me151579);
			}
			 else 
			{
				haxor.context.EngineContext.update.Add(__temp_me151579);
			}
			
		}
		 else 
		{
			java.lang.Thread thread = new java.lang.Thread(((java.lang.Runnable) (__temp_me151579) ));
			thread.start();
		}
	...
	{
		boolean __temp_p_graphics_context151570 = ( (( p_graphics_context == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_graphics_context)) );
		boolean __temp_p_threaded151569 = ( (( p_threaded == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_threaded)) );
		int __temp_p_step151568 = ( (( p_step == null )) ? (((int) (1) )) : (((int) (haxe.lang.Runtime.toInt(p_step)) )) );
		haxe.root.Array<java.lang.Object> p_step1 = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_p_step151568});
	...
	{
		boolean __temp_p_graphics_context151572 = ( (( p_graphics_context == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_graphics_context)) );
		boolean __temp_p_threaded151571 = ( (( p_threaded == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_threaded)) );
		haxe.root.Array<haxe.lang.Function> p_callback1 = new haxe.root.Array<haxe.lang.Function>(new haxe.lang.Function[]{p_callback});
		...
		return new haxor.thread.Activity(((haxe.lang.Function) (new haxor.thread.Activity_Delay_62__Fun(((haxe.root.Array<haxe.lang.Function>) (p_callback1) ), ((haxe.root.Array<java.lang.Object>) (p_time1) ))) ), ((java.lang.Object) (__temp_p_threaded151571) ), ((java.lang.Object) (__temp_p_graphics_context151572) ));
	}
	...
	{
		boolean __temp_p_graphics_context151574 = ( (( p_graphics_context == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_graphics_context)) );
		boolean __temp_p_threaded151573 = ( (( p_threaded == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_threaded)) );
		return new haxor.thread.Activity(((haxe.lang.Function) (p_callback) ), ((java.lang.Object) (__temp_p_threaded151573) ), ((java.lang.Object) (__temp_p_graphics_context151574) ));
	}
	...
	{
		boolean __temp_p_graphics_context151576 = ( (( p_graphics_context == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_graphics_context)) );
		boolean __temp_p_threaded151575 = ( (( p_threaded == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_threaded)) );
		haxe.root.Array<haxe.lang.Function> p_callback1 = new haxe.root.Array<haxe.lang.Function>(new haxe.lang.Function[]{p_callback});
		return new haxor.thread.Activity(((haxe.lang.Function) (new haxor.thread.Activity_RunOnce_93__Fun(((haxe.root.Array<haxe.lang.Function>) (p_callback1) ))) ), ((java.lang.Object) (__temp_p_threaded151575) ), ((java.lang.Object) (__temp_p_graphics_context151576) ));
	}
	...
	{
		{
			boolean __temp_executeDef152455 = true;
	...
	{
		{
			boolean __temp_executeDef152456 = true;
			switch (field.hashCode())
			{
				case 688472063:
				{
	...
	{
		{
			boolean __temp_executeDef152457 = true;
			switch (field.hashCode())
			{
				case 113291:
				{
	...
	{
		{
			boolean __temp_executeDef152458 = true;
			switch (field.hashCode())
			{
				case 1247755178:
				{
	...
	{
		{
			boolean __temp_executeDef152459 = true;
			switch (field.hashCode())
			{
				case 113291:
				{
