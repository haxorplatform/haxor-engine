...
public  class RendererContext extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_context_RendererContext(haxor.context.RendererContext __temp_me160454)
	{
		__temp_me160454.rid = new haxor.context.UID();
		__temp_me160454.display = new haxe.root.Array<haxor.context.Process>(new haxor.context.Process[]{});
		__temp_me160454.sort = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		{
			int _g = 0;
			while (( _g < 32 ))
			{
				...
				__temp_me160454.display.push(((haxor.context.Process) (p) ));
				__temp_me160454.sort.push(false);
			}
	...
	{
		{
			boolean __temp_executeDef161166 = true;
	...
	{
		{
			boolean __temp_executeDef161167 = true;
			switch (field.hashCode())
			{
				case -846533090:
				{
	...
	{
		{
			boolean __temp_executeDef161168 = true;
			switch (field.hashCode())
			{
				case -846533090:
				{
