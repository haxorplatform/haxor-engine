...
public  class TextureContext extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_context_TextureContext(haxor.context.TextureContext __temp_me42357)
	{
		__temp_me42357.tid = 0;
		__temp_me42357.bind = null;
		__temp_me42357.target = null;
		__temp_me42357.active = new haxe.root.Array<haxor.graphics.texture.Texture>(new haxor.graphics.texture.Texture[]{});
		__temp_me42357.ids = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		__temp_me42357.framebuffers = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		__temp_me42357.renderbuffers = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
	}
	...
	public   void Alloc(haxor.graphics.texture.Texture p_texture)
	{
		...
		{
			java.lang.Object __temp_expr42568 = null;
		}
		 else 
		{
			this.bind = p_texture;
			int id = ((int) (haxe.lang.Runtime.toInt(this.ids.__get(this.bind._cid_))) );
			int target = 0;
			{
	...
	public   void Create(haxor.graphics.texture.Texture p_texture)
	{
		...
		this.ids.__set(p_texture._cid_, id);
		{
			...
			if (( p_texture == this.bind )) 
			{
				java.lang.Object __temp_expr42569 = null;
			}
			 else 
			{
				this.bind = p_texture;
				int id1 = ((int) (haxe.lang.Runtime.toInt(this.ids.__get(this.bind._cid_))) );
				int target1 = 0;
				{
					haxor.graphics.texture.Texture p_texture1 = this.bind;
					if (( p_texture1.get_type() == haxor.graphics.TextureType.Texture2D )) 
		...
		if (( p_texture.get_type() == haxor.graphics.TextureType.RenderTexture )) 
		{
			...
			if (( this.bind == null )) 
			{
				java.lang.Object __temp_expr42570 = null;
			}
			 else 
			{
				int target2 = 0;
	...
	public final   void UpdateParameters(haxor.graphics.texture.Texture p_texture)
	{
		...
		if (( p_texture == this.bind )) 
		{
			java.lang.Object __temp_expr42571 = null;
		}
		 else 
		{
			this.bind = p_texture;
	...
	public   void Update(haxor.graphics.texture.Texture p_texture)
	{
		...
		if (( p_texture == this.bind )) 
		{
			java.lang.Object __temp_expr42572 = null;
		}
		 else 
		{
			this.bind = p_texture;
	...
	public   int Activate(haxor.graphics.texture.Texture p_texture)
	{
		...
		if (( this.active.__get(p_texture._cid_) == p_texture )) 
		{
			return slot;
		}
		...
		if (( p_texture == this.bind )) 
		{
			java.lang.Object __temp_expr42573 = null;
		}
		 else 
		{
			this.bind = p_texture;
	...
	public   void UpdateMipmaps(haxor.graphics.texture.Texture p_texture)
	{
		if (( p_texture == this.bind )) 
		{
			java.lang.Object __temp_expr42574 = null;
		}
		 else 
		{
			this.bind = p_texture;
	...
	{
		{
			boolean __temp_executeDef42575 = true;
	...
	{
		{
			boolean __temp_executeDef42576 = true;
			switch (field.hashCode())
			{
				case 3023933:
				{
	...
	{
		{
			boolean __temp_executeDef42577 = true;
			switch (field.hashCode())
			{
				case -1072941094:
				{
	...
	{
		{
			boolean __temp_executeDef42578 = true;
			switch (field.hashCode())
			{
				case 114831:
				{
	...
	{
		{
			boolean __temp_executeDef42579 = true;
			switch (field.hashCode())
			{
				case -1072941094:
				{
