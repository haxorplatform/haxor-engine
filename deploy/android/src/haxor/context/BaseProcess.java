...
public  class BaseProcess extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_context_BaseProcess(haxor.context.BaseProcess __temp_me151, java.lang.String p_name, java.lang.Object p_update_cid)
	{
		boolean __temp_p_update_cid150 = ( (( p_update_cid == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_update_cid)) );
		__temp_me151.name = p_name;
		__temp_me151.__cid = haxor.context.BaseProcess.m_cid;
		haxor.core.Console.Log(( ( ( ( "\tProcess [" + p_name ) + "][" ) + __temp_me151.__cid ) + "] created." ), 8);
		if (__temp_p_update_cid150) 
		{
