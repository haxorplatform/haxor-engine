...
public  class CameraContext extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_context_CameraContext(haxor.context.CameraContext __temp_me80596)
	{
		__temp_me80596.cid = new haxor.context.UID();
		__temp_me80596.list = new haxe.root.Array<haxor.component.Camera>(new haxor.component.Camera[]{});
		__temp_me80596.front = new haxe.root.Array<haxor.graphics.texture.RenderTexture>(new haxor.graphics.texture.RenderTexture[]{});
		__temp_me80596.back = new haxe.root.Array<haxor.graphics.texture.RenderTexture>(new haxor.graphics.texture.RenderTexture[]{});
		{
			int _g = 0;
			while (( _g < 64 ))
			{
				int i = _g++;
				__temp_me80596.front.push(null);
				__temp_me80596.back.push(null);
			}
	...
	public   void UpdateViewport(haxor.component.Camera c)
	{
		...
		if (( grt == null )) 
		{
			if (need_buffer) 
			{
				haxor.graphics.PixelFormat tf = null;
				if (( c.m_target == null )) 
				{
					tf = haxor.graphics.PixelFormat.RGB8;
				}
				 else 
				{
				...
				this.front.__set(c.__cid, new haxor.graphics.texture.RenderTexture(((int) (aw) ), ((int) (ah) ), ((haxor.graphics.PixelFormat) (tf) ), ((java.lang.Object) (c.m_captureDepth) )));
				if (( c.get_filters().length <= 0 )) 
				{
				...
				{
					this.back.__set(c.__cid, new haxor.graphics.texture.RenderTexture(((int) (aw) ), ((int) (ah) ), ((haxor.graphics.PixelFormat) (tf) ), ((java.lang.Object) (c.m_captureDepth) )));
				}
	...
	{
		{
			boolean __temp_executeDef81262 = true;
	...
	{
		{
			boolean __temp_executeDef81263 = true;
			switch (field.hashCode())
			{
				case -1990951487:
				{
	...
	{
		{
			boolean __temp_executeDef81264 = true;
			switch (field.hashCode())
			{
				case -1990951487:
				{
