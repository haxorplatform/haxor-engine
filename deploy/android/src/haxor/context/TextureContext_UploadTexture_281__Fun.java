...
public  class TextureContext_UploadTexture_281__Fun extends haxe.lang.Function
{
	...
	@Override public   java.lang.Object __hx_invoke1_o(double __fn_float1, java.lang.Object __fn_dyn1)
	{
		...
		{
			java.lang.Object __temp_expr164867 = null;
		}
		 else 
		{
		...
		
		{
			...
			while (( _g1 < ((int) (haxe.lang.Runtime.toInt(this.steps.__get(0))) ) ))
			{
				...
				{
					{
						int __temp_arrIndex164471 = 0;
						int __temp_arrVal164469 = ((int) (haxe.lang.Runtime.toInt(this.py.__get(__temp_arrIndex164471))) );
						int __temp_arrRet164470 = __temp_arrVal164469++;
						this.py.__set(__temp_arrIndex164471, __temp_arrVal164469);
						int __temp_expr164868 = __temp_arrRet164470;
					}
				...
				{
					int __temp_arrIndex164474 = 0;
					int __temp_arrVal164472 = ((int) (haxe.lang.Runtime.toInt(this.py.__get(__temp_arrIndex164474))) );
					int __temp_arrRet164473 = __temp_arrVal164472++;
					this.py.__set(__temp_arrIndex164474, __temp_arrVal164472);
					int __temp_expr164869 = __temp_arrRet164473;
				}
