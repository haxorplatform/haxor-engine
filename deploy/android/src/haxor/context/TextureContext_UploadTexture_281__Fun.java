...
public  class TextureContext_UploadTexture_281__Fun extends haxe.lang.Function
{
	...
	@Override public   java.lang.Object __hx_invoke1_o(double __fn_float1, java.lang.Object __fn_dyn1)
	{
		...
		{
			java.lang.Object __temp_expr81321 = null;
		}
		 else 
		{
		...
		
		{
			...
			while (( _g1 < ((int) (haxe.lang.Runtime.toInt(this.steps.__get(0))) ) ))
			{
				...
				{
					{
						int __temp_arrIndex80867 = 0;
						int __temp_arrVal80865 = ((int) (haxe.lang.Runtime.toInt(this.py.__get(__temp_arrIndex80867))) );
						int __temp_arrRet80866 = __temp_arrVal80865++;
						this.py.__set(__temp_arrIndex80867, __temp_arrVal80865);
						int __temp_expr81322 = __temp_arrRet80866;
					}
				...
				{
					int __temp_arrIndex80870 = 0;
					int __temp_arrVal80868 = ((int) (haxe.lang.Runtime.toInt(this.py.__get(__temp_arrIndex80870))) );
					int __temp_arrRet80869 = __temp_arrVal80868++;
					this.py.__set(__temp_arrIndex80870, __temp_arrVal80868);
					int __temp_expr81323 = __temp_arrRet80869;
				}
