...
public  class MeshContext extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_context_MeshContext(haxor.context.MeshContext __temp_me33806)
	{
		__temp_me33806.attribs = new haxe.root.Array<java.lang.String>(new java.lang.String[]{"vertex", "normal", "uv0", "uv1", "uv2", "color", "weight", "index"});
		__temp_me33806.aid = 0;
		__temp_me33806.mid = 0;
		__temp_me33806.buffers = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		__temp_me33806.activated = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		{
			int _g = 0;
			while (( _g < 32 ))
			{
				int i = _g++;
				__temp_me33806.activated.push(false);
			}
		...
		int max_buffers = 512;
		{
			...
			{
				int i1 = _g1++;
				__temp_me33806.buffers.push(haxor.platform.graphics.GL.NULL);
			}
	...
	{
		{
			boolean __temp_executeDef33991 = true;
	...
	{
		{
			boolean __temp_executeDef33992 = true;
			switch (field.hashCode())
			{
				case 1126940025:
				{
	...
	{
		{
			boolean __temp_executeDef33993 = true;
			switch (field.hashCode())
			{
				case -1291178733:
				{
	...
	{
		{
			boolean __temp_executeDef33994 = true;
			switch (field.hashCode())
			{
				case 2044289195:
				{
	...
	{
		{
			boolean __temp_executeDef33995 = true;
			switch (field.hashCode())
			{
				case -1291178733:
				{
