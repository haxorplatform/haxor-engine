...
public  class MeshContext extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_context_MeshContext(haxor.context.MeshContext __temp_me164186)
	{
		__temp_me164186.attribs = new haxe.root.Array<java.lang.String>(new java.lang.String[]{"vertex", "normal", "uv0", "uv1", "uv2", "color", "weight", "index"});
		__temp_me164186.aid = new haxor.context.UID();
		__temp_me164186.mid = new haxor.context.UID();
		__temp_me164186.buffers = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		__temp_me164186.activated = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		{
			int _g = 0;
			while (( _g < 32 ))
			{
				int i = _g++;
				__temp_me164186.activated.push(false);
			}
		...
		int max_buffers = 512;
		{
			...
			{
				int i1 = _g1++;
				__temp_me164186.buffers.push(haxor.graphics.GL.INVALID);
			}
	...
	{
		{
			boolean __temp_executeDef164829 = true;
	...
	{
		{
			boolean __temp_executeDef164830 = true;
			switch (field.hashCode())
			{
				case 1126940025:
				{
	...
	{
		{
			boolean __temp_executeDef164831 = true;
			switch (field.hashCode())
			{
				case -1291178733:
				{
	...
	{
		{
			boolean __temp_executeDef164832 = true;
			switch (field.hashCode())
			{
				case 2044289195:
				{
	...
	{
		{
			boolean __temp_executeDef164833 = true;
			switch (field.hashCode())
			{
				case -1291178733:
				{
