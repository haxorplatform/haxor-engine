...
public  class MeshContext extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_context_MeshContext(haxor.context.MeshContext __temp_me149)
	{
		__temp_me149.attribs = new haxe.root.Array<java.lang.String>(new java.lang.String[]{"vertex", "normal", "uv0", "uv1", "uv2", "color", "weight", "bone"});
		__temp_me149.aid = new haxor.context.UID();
		__temp_me149.mid = new haxor.context.UID();
		__temp_me149.buffers = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		__temp_me149.activated = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		{
			int _g = 0;
			while (( _g < 32 ))
			{
				int i = _g++;
				__temp_me149.activated.push(false);
			}
		...
		int max_buffers = 512;
		{
			...
			{
				int i1 = _g1++;
				__temp_me149.buffers.push(haxor.graphics.GL.INVALID);
			}
	...
	{
		{
			boolean __temp_executeDef874 = true;
			switch (field.hashCode())
			{
				case -1291178733:
				{
