...
public  class UID extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_context_UID(haxor.context.UID __temp_me80610)
	{
		__temp_me80610.m_id = 0;
		__temp_me80610.m_cache = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
	}
	...
	{
		{
			boolean __temp_executeDef81327 = true;
	...
	{
		{
			boolean __temp_executeDef81328 = true;
			switch (field.hashCode())
			{
				case 767839536:
				{
	...
	{
		{
			boolean __temp_executeDef81329 = true;
			switch (field.hashCode())
			{
				case 767839536:
				{
	...
	{
		{
			boolean __temp_executeDef81330 = true;
			switch (field.hashCode())
			{
				case 3341869:
				{
	...
	{
		{
			boolean __temp_executeDef81331 = true;
			switch (field.hashCode())
			{
				case -905788904:
				{
