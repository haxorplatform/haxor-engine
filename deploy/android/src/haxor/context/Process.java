...
public  class Process<T> extends haxor.context.BaseProcess
{
	...
	public static  <T_c> void __hx_ctor_haxor_context_Process(haxor.context.Process<T_c> __temp_me154, java.lang.String p_name, int p_size, java.lang.Object p_update_cid)
	{
		haxor.context.BaseProcess.__hx_ctor_haxor_context_BaseProcess(__temp_me154, p_name, ( (( p_update_cid == null )) ? (((java.lang.Object) (true) )) : (p_update_cid) ));
		boolean __temp_p_update_cid153 = ( (( p_update_cid == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_update_cid)) );
		__temp_me154.list = new haxe.root.Array<T_c>(( (T_c[]) (new java.lang.Object[] {}) ));
		__temp_me154.m_length = 0;
		{
			int _g = 0;
			while (( _g < p_size ))
			{
				int i = _g++;
				__temp_me154.list.push(null);
			}
	...
	{
		boolean __temp_p_index_only152 = ( (( p_index_only == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_index_only)) );
	...
	{
		{
			boolean __temp_executeDef882 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			int __temp_hash885 = field.hashCode();
			boolean __temp_executeDef884 = true;
			switch (__temp_hash885)
			{
				case 65193517:case -1850743644:case 65665:case 974314479:
				{
					if (( (( ( __temp_hash885 == 65193517 ) && field.equals("Clear") )) || ( (( ( __temp_hash885 == -1850743644 ) && field.equals("Remove") )) || ( (( ( __temp_hash885 == 65665 ) && field.equals("Add") )) || field.equals("get_length") ) ) )) 
					{
