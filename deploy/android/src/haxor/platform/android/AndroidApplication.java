...
public  class AndroidApplication extends haxor.core.BaseApplication
{
	...
	public static   void __hx_ctor_haxor_platform_android_AndroidApplication(haxor.platform.android.AndroidApplication __temp_me7, java.lang.String p_name)
	{
		haxor.core.BaseApplication.__hx_ctor_haxor_core_BaseApplication(__temp_me7, p_name);
	}
	...
	{
		{
			boolean __temp_executeDef430 = true;
			switch (field.hashCode())
			{
				case -1244160288:
				{
	...
	{
		{
			boolean __temp_executeDef431 = true;
			switch (field.hashCode())
			{
				case 1535364104:
				{
