...
public  class AndroidApplication extends haxor.core.BaseApplication
{
	...
	public static   void __hx_ctor_haxor_platform_android_AndroidApplication(haxor.platform.android.AndroidApplication __temp_me255320, java.lang.String p_name)
	{
		haxor.core.BaseApplication.__hx_ctor_haxor_core_BaseApplication(__temp_me255320, p_name);
	}
	...
	{
		{
			boolean __temp_executeDef255702 = true;
	...
	{
		{
			boolean __temp_executeDef255703 = true;
			switch (field.hashCode())
			{
				case 1535364104:
				{
	...
	{
		{
			boolean __temp_executeDef255704 = true;
			switch (field.hashCode())
			{
				case -1244160288:
				{
	...
	{
		{
			boolean __temp_executeDef255705 = true;
			switch (field.hashCode())
			{
				case 1535364104:
				{
