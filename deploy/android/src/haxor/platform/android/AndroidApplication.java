...
public  class AndroidApplication extends haxor.core.BaseApplication
{
	...
	public static   void __hx_ctor_haxor_platform_android_AndroidApplication(haxor.platform.android.AndroidApplication __temp_me21720)
	{
		haxor.core.BaseApplication.__hx_ctor_haxor_core_BaseApplication(__temp_me21720);
		__temp_me21720.m_platform = haxor.core.Platform.Android;
		__temp_me21720.m_screen_width = 0.0;
		__temp_me21720.m_screen_height = 0.0;
	}
	...
	{
		{
			boolean __temp_executeDef21813 = true;
	...
	{
		{
			boolean __temp_executeDef21814 = true;
			switch (field.hashCode())
			{
				case 1535364104:
				{
	...
	{
		{
			boolean __temp_executeDef21815 = true;
			switch (field.hashCode())
			{
				case -1244160288:
				{
	...
	{
		{
			boolean __temp_executeDef21816 = true;
			switch (field.hashCode())
			{
				case 1535364104:
				{
