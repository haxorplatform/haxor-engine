...
public  class AndroidApplication extends haxor.core.BaseApplication
{
	...
	public static   void __hx_ctor_haxor_platform_android_AndroidApplication(haxor.platform.android.AndroidApplication __temp_me160375, java.lang.String p_name)
	{
		haxor.core.BaseApplication.__hx_ctor_haxor_core_BaseApplication(__temp_me160375, p_name);
	}
	...
	{
		{
			boolean __temp_executeDef160777 = true;
	...
	{
		{
			boolean __temp_executeDef160778 = true;
			switch (field.hashCode())
			{
				case 1535364104:
				{
	...
	{
		{
			boolean __temp_executeDef160779 = true;
			switch (field.hashCode())
			{
				case -1244160288:
				{
	...
	{
		{
			boolean __temp_executeDef160780 = true;
			switch (field.hashCode())
			{
				case 1535364104:
				{
