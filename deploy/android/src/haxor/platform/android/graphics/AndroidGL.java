...
public  class AndroidGL extends haxor.graphics.GraphicContext
{
	...
	public static   void __hx_ctor_haxor_platform_android_graphics_AndroidGL(haxor.platform.android.graphics.AndroidGL __temp_me160701, haxor.core.BaseApplication p_application)
	{
		haxor.graphics.GraphicContext.__hx_ctor_haxor_graphics_GraphicContext(__temp_me160701, p_application);
		__temp_me160701.m_api = haxor.graphics.GraphicAPI.OpenGLES;
	}
	...
	{
		int __temp_p_version160700 = ( (( p_version == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_version)) )) );
		if (( p_entry == null )) 
		{
		...
		haxor.core.Console.Log(( ( ( ( ( ( "Graphics> Initialize Android GLES version[" + __temp_p_version160700 ) + "] Resolution[" ) + w ) + "," ) + h ) + "]" ), 1);
		return true;
	}
	...
	@Override public   void CheckExtensions()
	{
		...
		haxe.root.Array<java.lang.String> exts = haxe.lang.StringExt.split(android.opengl.GLES20.glGetString(((int) (android.opengl.GLES20.GL_EXTENSIONS) )), " ");
		{
			...
			while (( _g1 < _g ))
			{
				...
				{
					java.lang.String __temp_svar161619 = (n);
					int __temp_hash161621 = __temp_svar161619.hashCode();
					switch (__temp_hash161621)
					{
						case 1647472438:
						{
							if (__temp_svar161619.equals("OES_texture_half_float")) 
							{
						...
						case 928981241:
						{
							if (__temp_svar161619.equals("WEBGL_depth_texture")) 
							{
						...
						case 221819982:
						{
							if (__temp_svar161619.equals("OES_texture_half_float_linear")) 
							{
						...
						case -915640650:
						{
							if (__temp_svar161619.equals("OES_texture_float")) 
							{
						...
						{
							if (( (( ( __temp_hash161621 == 133065385 ) && __temp_svar161619.equals("WEBKIT_EXT_texture_filter_anisotropic") )) || __temp_svar161619.equals("EXT_texture_filter_anisotropic") )) 
							{
	...
	{
		{
			boolean __temp_executeDef161622 = true;
	...
	{
		{
			boolean __temp_executeDef161623 = true;
			switch (field.hashCode())
			{
				case 483751295:
				{
	...
	{
		{
			int __temp_hash161625 = field.hashCode();
			boolean __temp_executeDef161624 = true;
			switch (__temp_hash161625)
			{
				...
				{
					if (( (( ( __temp_hash161625 == 483751295 ) && field.equals("GetErrorCode") )) || ( (( ( __temp_hash161625 == 1397397507 ) && field.equals("ReadPixels") )) || ( (( ( __temp_hash161625 == -711810116 ) && field.equals("Scissor") )) || ( (( ( __temp_hash161625 == 1261329606 ) && field.equals("Viewport") )) || ( (( ( __temp_hash161625 == 1234652470 ) && field.equals("ClearColor") )) || ( (( ( __temp_hash161625 == 1235282070 ) && field.equals("ClearDepth") )) || ( (( ( __temp_hash161625 == 65193517 ) && field.equals("Clear") )) || ( (( ( __temp_hash161625 == 2131299334 ) && field.equals("FrontFace") )) || ( (( ( __temp_hash161625 == 461794063 ) && field.equals("CullFace") )) || ( (( ( __temp_hash161625 == 1317758983 ) && field.equals("DepthFunc") )) || ( (( ( __temp_hash161625 == 1317948463 ) && field.equals("DepthMask") )) || ( (( ( __temp_hash161625 == 2079986083 ) && field.equals("Enable") )) || ( (( ( __temp_hash161625 == -959006008 ) && field.equals("Disable") )) || ( (( ( __temp_hash161625 == -1395603819 ) && field.equals("BlendFunc") )) || ( (( ( __temp_hash161625 == -1966618257 ) && field.equals("UniformMatrix4fv") )) || ( (( ( __temp_hash161625 == -1966619218 ) && field.equals("UniformMatrix3fv") )) || ( (( ( __temp_hash161625 == -1966620179 ) && field.equals("UniformMatrix2fv") )) || ( (( ( __temp_hash161625 == 1153697357 ) && field.equals("Uniform4iv") )) || ( (( ( __temp_hash161625 == 1153696396 ) && field.equals("Uniform3iv") )) || ( (( ( __temp_hash161625 == 1153695435 ) && field.equals("Uniform2iv") )) || ( (( ( __temp_hash161625 == 1153694474 ) && field.equals("Uniform1iv") )) || ( (( ( __temp_hash161625 == 1153697264 ) && field.equals("Uniform4fv") )) || ( (( ( __temp_hash161625 == 1153696303 ) && field.equals("Uniform3fv") )) || ( (( ( __temp_hash161625 == 1153695342 ) && field.equals("Uniform2fv") )) || ( (( ( __temp_hash161625 == 1153694381 ) && field.equals("Uniform1fv") )) || ( (( ( __temp_hash161625 == 1145594697 ) && field.equals("Uniform4i") )) || ( (( ( __temp_hash161625 == 1145594666 ) && field.equals("Uniform3i") )) || ( (( ( __temp_hash161625 == 1145594635 ) && field.equals("Uniform2i") )) || ( (( ( __temp_hash161625 == 1145594604 ) && field.equals("Uniform1i") )) || ( (( ( __temp_hash161625 == 1145594694 ) && field.equals("Uniform4f") )) || ( (( ( __temp_hash161625 == 1145594663 ) && field.equals("Uniform3f") )) || ( (( ( __temp_hash161625 == 1145594632 ) && field.equals("Uniform2f") )) || ( (( ( __temp_hash161625 == 1145594601 ) && field.equals("Uniform1f") )) || ( (( ( __temp_hash161625 == -1452160697 ) && field.equals("TexParameteri") )) || ( (( ( __temp_hash161625 == -1452160700 ) && field.equals("TexParameterf") )) || ( (( ( __temp_hash161625 == -1480581644 ) && field.equals("TexSubImage2D") )) || ( (( ( __temp_hash161625 == -51526673 ) && field.equals("TexImage2DAlloc") )) || ( (( ( __temp_hash161625 == 768888550 ) && field.equals("TexImage2D") )) || ( (( ( __temp_hash161625 == 1800947749 ) && field.equals("RenderbufferStorage") )) || ( (( ( __temp_hash161625 == 450629038 ) && field.equals("PixelStorei") )) || ( (( ( __temp_hash161625 == 1000706173 ) && field.equals("GenerateMipmap") )) || ( (( ( __temp_hash161625 == 962410336 ) && field.equals("FramebufferTexture2D") )) || ( (( ( __temp_hash161625 == 683029955 ) && field.equals("FramebufferRenderbuffer") )) || ( (( ( __temp_hash161625 == -823627568 ) && field.equals("DeleteTexture") )) || ( (( ( __temp_hash161625 == 1756641985 ) && field.equals("DeleteRenderbuffer") )) || ( (( ( __temp_hash161625 == 32403746 ) && field.equals("DeleteFramebuffer") )) || ( (( ( __temp_hash161625 == 1627662431 ) && field.equals("CreateTexture") )) || ( (( ( __temp_hash161625 == 710403218 ) && field.equals("CreateRenderbuffer") )) || ( (( ( __temp_hash161625 == 691390769 ) && field.equals("CreateFramebuffer") )) || ( (( ( __temp_hash161625 == -316071426 ) && field.equals("BindTexture") )) || ( (( ( __temp_hash161625 == -1967581613 ) && field.equals("BindRenderbuffer") )) || ( (( ( __temp_hash161625 == -1057563824 ) && field.equals("BindFramebuffer") )) || ( (( ( __temp_hash161625 == -1798288619 ) && field.equals("ActiveTexture") )) || ( (( ( __temp_hash161625 == 62838557 ) && field.equals("UseProgram") )) || ( (( ( __temp_hash161625 == -682516214 ) && field.equals("LinkProgram") )) || ( (( ( __temp_hash161625 == 1391327451 ) && field.equals("GetProgramParameter") )) || ( (( ( __temp_hash161625 == 662129000 ) && field.equals("GetProgramInfoLog") )) || ( (( ( __temp_hash161625 == 1131050867 ) && field.equals("GetUniformLocation") )) || ( (( ( __temp_hash161625 == -1248406155 ) && field.equals("GetAttribLocation") )) || ( (( ( __temp_hash161625 == 284801593 ) && field.equals("DeleteProgram") )) || ( (( ( __temp_hash161625 == -1558875704 ) && field.equals("CreateProgram") )) || ( (( ( __temp_hash161625 == 1781319260 ) && field.equals("BindAttribLocation") )) || ( (( ( __temp_hash161625 == -2011750742 ) && field.equals("AttachShader") )) || ( (( ( __temp_hash161625 == -1805459328 ) && field.equals("ShaderSource") )) || ( (( ( __temp_hash161625 == 1169816366 ) && field.equals("GetShaderParameter") )) || ( (( ( __temp_hash161625 == 1073071227 ) && field.equals("GetShaderInfoLog") )) || ( (( ( __temp_hash161625 == -607317616 ) && field.equals("DeleteShader") )) || ( (( ( __temp_hash161625 == -440035976 ) && field.equals("DetachShader") )) || ( (( ( __temp_hash161625 == 1688513569 ) && field.equals("CreateShader") )) || ( (( ( __temp_hash161625 == 490879960 ) && field.equals("CompileShader") )) || ( (( ( __temp_hash161625 == 1170563247 ) && field.equals("VertexAttribPointer") )) || ( (( ( __temp_hash161625 == -454645536 ) && field.equals("VertexAttrib4f") )) || ( (( ( __temp_hash161625 == -454645567 ) && field.equals("VertexAttrib3f") )) || ( (( ( __temp_hash161625 == 1857751761 ) && field.equals("EnableVertexAttrib") )) || ( (( ( __temp_hash161625 == 1204954230 ) && field.equals("DisableVertexAttrib") )) || ( (( ( __temp_hash161625 == -1081856533 ) && field.equals("DeleteBuffer") )) || ( (( ( __temp_hash161625 == -670686597 ) && field.equals("DrawElements") )) || ( (( ( __temp_hash161625 == 1387908030 ) && field.equals("DrawArrays") )) || ( (( ( __temp_hash161625 == 1213974652 ) && field.equals("CreateBuffer") )) || ( (( ( __temp_hash161625 == 1601301898 ) && field.equals("BufferSubData") )) || ( (( ( __temp_hash161625 == -395725782 ) && field.equals("BufferData") )) || ( (( ( __temp_hash161625 == -1896767747 ) && field.equals("BindBuffer") )) || field.equals("CheckExtensions") ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef161624 = false;
