...
public  class HTTPLoader<T> extends haxor.platform.android.HTTPRequest
{
	...
	{
		super(haxe.lang.EmptyObject.EMPTY);
		haxor.platform.android.HTTPLoader.__hx_ctor_haxor_platform_android_HTTPLoader(this, p_url, p_binary, p_callback);
	}
	
	
	public static  <T_c> void __hx_ctor_haxor_platform_android_HTTPLoader(haxor.platform.android.HTTPLoader<T_c> __temp_me54550, java.lang.String p_url, boolean p_binary, haxe.lang.Function p_callback)
	{
		haxor.platform.android.HTTPRequest.__hx_ctor_haxor_platform_android_HTTPRequest(__temp_me54550, p_url, "GET", p_binary, null);
		__temp_me54550.callback = p_callback;
	}
	
	
	public static   java.lang.Object __hx_createEmpty()
	{
		return new haxor.platform.android.HTTPLoader<java.lang.Object>(((haxe.lang.EmptyObject) (haxe.lang.EmptyObject.EMPTY) ));
	}
	
	
	public static   java.lang.Object __hx_create(haxe.root.Array arr)
	{
		return new haxor.platform.android.HTTPLoader<java.lang.Object>(haxe.lang.Runtime.toString(arr.__get(0)), haxe.lang.Runtime.toBool(arr.__get(1)), ((haxe.lang.Function) (arr.__get(2)) ));
	}
	...
	{
		{
			boolean __temp_executeDef54822 = true;
	...
	{
		{
			boolean __temp_executeDef54823 = true;
			switch (field.hashCode())
			{
				case 314785609:
				{
