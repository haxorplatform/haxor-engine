...
public  class HTTPLoader<T> extends haxor.platform.android.net.HTTPRequest
{
	...
	public static  <T_c> void __hx_ctor_haxor_platform_android_net_HTTPLoader(haxor.platform.android.net.HTTPLoader<T_c> __temp_me55753, java.lang.String p_url, boolean p_binary, haxe.lang.Function p_callback)
	{
		haxor.platform.android.net.HTTPRequest.__hx_ctor_haxor_platform_android_net_HTTPRequest(__temp_me55753, p_url, "GET", p_binary, null);
		__temp_me55753.callback = p_callback;
	}
	...
	{
		{
			boolean __temp_executeDef56021 = true;
	...
	{
		{
			boolean __temp_executeDef56022 = true;
			switch (field.hashCode())
			{
				case 314785609:
				{
