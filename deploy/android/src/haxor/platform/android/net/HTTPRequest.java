...
public  class HTTPRequest extends haxor.net.HTTPRequestTask<java.net.HttpURLConnection, java.io.ByteArrayOutputStream>
{
	...
	public static   void __hx_ctor_haxor_platform_android_net_HTTPRequest(haxor.platform.android.net.HTTPRequest __temp_me80831, java.lang.String p_url, java.lang.String p_method, boolean p_binary, java.lang.String p_data)
	{
		haxor.net.HTTPRequestTask.__hx_ctor_haxor_net_HTTPRequestTask(__temp_me80831, p_url, p_method, p_binary, ( (( p_data == null )) ? (haxe.lang.Runtime.toString(null)) : (p_data) ));
	}
	...
	{
		{
			boolean __temp_executeDef81700 = true;
	...
	{
		{
			boolean __temp_executeDef81701 = true;
			switch (field.hashCode())
			{
				case -130994088:
				{
