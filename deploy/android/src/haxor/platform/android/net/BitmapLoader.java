...
public  class BitmapLoader extends haxor.platform.android.net.HTTPLoader<haxor.io.Buffer>
{
	...
	public static   void __hx_ctor_haxor_platform_android_net_BitmapLoader(haxor.platform.android.net.BitmapLoader __temp_me255644, java.lang.String p_url, haxe.lang.Function p_callback)
	{
		haxor.platform.android.net.HTTPLoader.__hx_ctor_haxor_platform_android_net_HTTPLoader(__temp_me255644, p_url, true, ((haxe.lang.Function) (new haxe.lang.Closure(((java.lang.Object) (__temp_me255644) ), haxe.lang.Runtime.toString("OnBufferCallback"))) ));
		__temp_me255644.m_bitmap_callback = p_callback;
	}
	...
	public   void OnBufferCallback(haxor.io.Buffer p_data, double p_progress)
	{
		 ...
		 else 
		{
			...
			int cc = 0;
			{
				double x = ( ((double) (( ab.getRowBytes() * ab.getHeight() )) ) / (( w * h )) );
				cc = ((int) (x) );
			}
			
			haxor.core.PixelFormat fmt = haxor.core.PixelFormat.RGBA8;
			switch (cc)
			{
				case 1:
				{
				...
				case 4:
				{
					fmt = haxor.core.PixelFormat.RGBA8;
					break;
				}
			...
			haxor.graphics.texture.Bitmap b = new haxor.graphics.texture.Bitmap(((int) (w) ), ((int) (h) ), ((haxor.core.PixelFormat) (fmt) ));
			haxor.math.Color c = null;
			{
				haxor.context.DataContext _this = haxor.context.EngineContext.data;
				c = _this.m_c.__get(_this.m_nc = ( (( _this.m_nc + 1 )) % _this.m_c.length ));
			}
			
			{
				...
				while (( _g < w ))
				{
					...
					{
						int iy = _g1++;
						int pix = ab.getPixel(((int) (ix) ), ((int) (iy) ));
						c.set_argb(pix);
						b.SetPixel(ix, iy, c);
					}
	...
	{
		{
			boolean __temp_executeDef256503 = true;
	...
	{
		{
			boolean __temp_executeDef256504 = true;
			switch (field.hashCode())
			{
				case 314785609:
				{
	...
	{
		{
			boolean __temp_executeDef256505 = true;
			switch (field.hashCode())
			{
				case 314785609:
				{
