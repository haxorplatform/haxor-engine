...
public  class LoadBitmap extends haxor.platform.android.LoadDataTask<haxor.io.Buffer>
{
	public    LoadBitmap(haxe.lang.EmptyObject empty)
	{
		super(haxe.lang.EmptyObject.EMPTY);
	}
	
	
	public    LoadBitmap(java.lang.String p_url, haxe.lang.Function p_callback)
	{
		super(haxe.lang.EmptyObject.EMPTY);
		haxor.platform.android.LoadBitmap.__hx_ctor_haxor_platform_android_LoadBitmap(this, p_url, p_callback);
	}
	
	
	public static   void __hx_ctor_haxor_platform_android_LoadBitmap(haxor.platform.android.LoadBitmap __temp_me54147, java.lang.String p_url, haxe.lang.Function p_callback)
	{
		haxor.platform.android.LoadDataTask.__hx_ctor_haxor_platform_android_LoadDataTask(__temp_me54147, p_url, true, ((haxe.lang.Function) (new haxe.lang.Closure(((java.lang.Object) (__temp_me54147) ), haxe.lang.Runtime.toString("OnBufferCallback"))) ));
		__temp_me54147.m_bitmap_callback = p_callback;
	}
	
	
	public static   java.lang.Object __hx_createEmpty()
	{
		return new haxor.platform.android.LoadBitmap(((haxe.lang.EmptyObject) (haxe.lang.EmptyObject.EMPTY) ));
	}
	
	
	public static   java.lang.Object __hx_create(haxe.root.Array arr)
	{
		return new haxor.platform.android.LoadBitmap(haxe.lang.Runtime.toString(arr.__get(0)), ((haxe.lang.Function) (arr.__get(1)) ));
	}
	...
	{
		{
			boolean __temp_executeDef54419 = true;
	...
	{
		{
			boolean __temp_executeDef54420 = true;
			switch (field.hashCode())
			{
				case 314785609:
				{
	...
	{
		{
			boolean __temp_executeDef54421 = true;
			switch (field.hashCode())
			{
				case 314785609:
				{
