...
public  class GraphicContext extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_platform_graphics_GraphicContext(haxor.platform.graphics.GraphicContext __temp_me4480, haxor.core.BaseApplication p_application)
	{
		__temp_me4480.m_api = haxor.platform.graphics.GraphicAPI.None;
		__temp_me4480.m_application = p_application;
	}
	...
	{
		{
			boolean __temp_executeDef4656 = true;
	...
	{
		{
			boolean __temp_executeDef4657 = true;
			switch (field.hashCode())
			{
				case 2054294852:
				{
	...
	{
		{
			boolean __temp_executeDef4658 = true;
			switch (field.hashCode())
			{
				case 2054294852:
				{
