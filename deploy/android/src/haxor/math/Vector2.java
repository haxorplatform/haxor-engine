...
public  class Vector2 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_Vector2(haxor.math.Vector2 __temp_me164410, java.lang.Object p_x, java.lang.Object p_y)
	{
		double __temp_p_y164409 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x164408 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me164410.x = __temp_p_x164408;
		__temp_me164410.y = __temp_p_y164409;
	}
	...
	{
		double __temp_p_y164406 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x164405 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.x = __temp_p_x164405;
		this.y = __temp_p_y164406;
		return this;
	}
	...
	{
		int __temp_p_places164407 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		double __temp_stmt165258 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places164407) ));
			double __temp_stmt165259 = 0.0;
			{
				double p_v = ( this.x * d );
				__temp_stmt165259 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt165258 = ( __temp_stmt165259 / d );
		}
		
		double __temp_stmt165260 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places164407) ));
			double __temp_stmt165261 = 0.0;
			{
				double p_v1 = ( this.y * d1 );
				__temp_stmt165261 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt165260 = ( __temp_stmt165261 / d1 );
		}
		
		return ( ( ( ( "[" + haxe.lang.Runtime.toString(__temp_stmt165258) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt165260) ) + "]" );
	}
	...
	{
		{
			boolean __temp_executeDef165262 = true;
	...
	{
		{
			boolean __temp_executeDef165263 = true;
			switch (field.hashCode())
			{
				case 121:
				{
	...
	{
		{
			boolean __temp_executeDef165264 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			boolean __temp_executeDef165265 = true;
			switch (field.hashCode())
			{
				case 121:
				{
	...
	{
		{
			boolean __temp_executeDef165266 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
