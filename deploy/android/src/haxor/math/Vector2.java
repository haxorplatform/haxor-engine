...
public  class Vector2 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_Vector2(haxor.math.Vector2 __temp_me255608, java.lang.Object p_x, java.lang.Object p_y)
	{
		double __temp_p_y255607 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x255606 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me255608.x = __temp_p_x255606;
		__temp_me255608.y = __temp_p_y255607;
	}
	...
	{
		double __temp_p_y255604 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x255603 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.x = __temp_p_x255603;
		this.y = __temp_p_y255604;
		return this;
	}
	...
	{
		int __temp_p_places255605 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		double __temp_stmt256450 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places255605) ));
			double __temp_stmt256451 = 0.0;
			{
				double p_v = ( this.x * d );
				__temp_stmt256451 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt256450 = ( __temp_stmt256451 / d );
		}
		
		double __temp_stmt256452 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places255605) ));
			double __temp_stmt256453 = 0.0;
			{
				double p_v1 = ( this.y * d1 );
				__temp_stmt256453 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt256452 = ( __temp_stmt256453 / d1 );
		}
		
		return ( ( ( ( "[" + haxe.lang.Runtime.toString(__temp_stmt256450) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt256452) ) + "]" );
	}
	...
	{
		{
			boolean __temp_executeDef256454 = true;
	...
	{
		{
			boolean __temp_executeDef256455 = true;
			switch (field.hashCode())
			{
				case 121:
				{
	...
	{
		{
			boolean __temp_executeDef256456 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			boolean __temp_executeDef256457 = true;
			switch (field.hashCode())
			{
				case 121:
				{
	...
	{
		{
			boolean __temp_executeDef256458 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
