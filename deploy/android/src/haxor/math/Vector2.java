...
public  class Vector2 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_Vector2(haxor.math.Vector2 __temp_me339, java.lang.Object p_x, java.lang.Object p_y)
	{
		double __temp_p_y338 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x337 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me339.x = __temp_p_x337;
		__temp_me339.y = __temp_p_y338;
	}
	...
	{
		double __temp_p_y335 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x334 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.x = __temp_p_x334;
		this.y = __temp_p_y335;
		return this;
	}
	...
	{
		int __temp_p_places336 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		double __temp_stmt1270 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places336) ));
			double __temp_stmt1271 = 0.0;
			{
				double p_v = ( this.x * d );
				__temp_stmt1271 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt1270 = ( __temp_stmt1271 / d );
		}
		
		double __temp_stmt1272 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places336) ));
			double __temp_stmt1273 = 0.0;
			{
				double p_v1 = ( this.y * d1 );
				__temp_stmt1273 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt1272 = ( __temp_stmt1273 / d1 );
		}
		
		return ( ( ( ( "[" + haxe.lang.Runtime.toString(__temp_stmt1270) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt1272) ) + "]" );
	}
	...
	{
		{
			boolean __temp_executeDef1274 = true;
	...
	{
		{
			boolean __temp_executeDef1275 = true;
			switch (field.hashCode())
			{
				case 121:
				{
	...
	{
		{
			boolean __temp_executeDef1276 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			boolean __temp_executeDef1277 = true;
			switch (field.hashCode())
			{
				case 121:
				{
	...
	{
		{
			boolean __temp_executeDef1278 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
