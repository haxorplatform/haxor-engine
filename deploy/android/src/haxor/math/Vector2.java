...
public  class Vector2 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_Vector2(haxor.math.Vector2 __temp_me160661, java.lang.Object p_x, java.lang.Object p_y)
	{
		double __temp_p_y160660 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x160659 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me160661.x = __temp_p_x160659;
		__temp_me160661.y = __temp_p_y160660;
	}
	...
	{
		double __temp_p_y160657 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x160656 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.x = __temp_p_x160656;
		this.y = __temp_p_y160657;
		return this;
	}
	...
	{
		int __temp_p_places160658 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		double __temp_stmt161554 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places160658) ));
			double __temp_stmt161555 = 0.0;
			{
				double p_v = ( this.x * d );
				__temp_stmt161555 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt161554 = ( __temp_stmt161555 / d );
		}
		
		double __temp_stmt161556 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places160658) ));
			double __temp_stmt161557 = 0.0;
			{
				double p_v1 = ( this.y * d1 );
				__temp_stmt161557 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt161556 = ( __temp_stmt161557 / d1 );
		}
		
		return ( ( ( ( "[" + haxe.lang.Runtime.toString(__temp_stmt161554) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt161556) ) + "]" );
	}
	...
	{
		{
			boolean __temp_executeDef161558 = true;
	...
	{
		{
			boolean __temp_executeDef161559 = true;
			switch (field.hashCode())
			{
				case 121:
				{
	...
	{
		{
			boolean __temp_executeDef161560 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			boolean __temp_executeDef161561 = true;
			switch (field.hashCode())
			{
				case 121:
				{
	...
	{
		{
			boolean __temp_executeDef161562 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
