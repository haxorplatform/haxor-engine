...
public  class AABB2 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_AABB2(haxor.math.AABB2 __temp_me80635, java.lang.Object p_x, java.lang.Object p_y, java.lang.Object p_width, java.lang.Object p_height)
	{
		double __temp_p_height80634 = ( (( p_height == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_height)) )) );
		double __temp_p_width80633 = ( (( p_width == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_width)) )) );
		double __temp_p_y80632 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x80631 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me80635.SetXYWH(__temp_p_x80631, __temp_p_y80632, __temp_p_width80633, __temp_p_height80634);
	}
	...
	{
		double hw = 0.0;
		double __temp_stmt81340 = 0.0;
		{
			double p_a = ( this.get_xMax() - this.get_xMin() );
			__temp_stmt81340 = ( (( p_a < 0 )) ? ( - (p_a) ) : (p_a) );
		}
		
		hw = ( __temp_stmt81340 * 0.5 );
		double hh = 0.0;
		double __temp_stmt81341 = 0.0;
		{
			double p_a1 = ( this.get_yMax() - this.get_yMin() );
			__temp_stmt81341 = ( (( p_a1 < 0 )) ? ( - (p_a1) ) : (p_a1) );
		}
		
		hh = ( __temp_stmt81341 * 0.5 );
		this.m_xMin = ( v.x - hw );
		this.m_xMax = ( v.x + hw );
		this.m_yMin = ( v.y - hh );
		this.m_yMax = ( v.y + hh );
	...
	{
		double __temp_stmt81342 = 0.0;
		{
			double p_a = ( this.get_xMax() - this.get_xMin() );
			__temp_stmt81342 = ( (( p_a < 0 )) ? ( - (p_a) ) : (p_a) );
		}
		
		double __temp_stmt81343 = 0.0;
		{
			double p_a1 = ( this.get_yMax() - this.get_yMin() );
			__temp_stmt81343 = ( (( p_a1 < 0 )) ? ( - (p_a1) ) : (p_a1) );
		}
		
		return new haxor.math.Vector2(((java.lang.Object) (__temp_stmt81342) ), ((java.lang.Object) (__temp_stmt81343) ));
	}
	...
	{
		{
			...
			double __temp_expr81344 = v1;
		}
		
		{
			double v2 = v.y;
			this.set_yMax(( this.get_yMin() + v2 ));
			double __temp_expr81345 = v2;
		}
	...
	{
		double __temp_stmt81346 = 0.0;
		{
			double b = this.get_xMin();
			__temp_stmt81346 = java.lang.Math.min(p_point.x, b);
		}
		
		this.set_xMin(__temp_stmt81346);
		double __temp_stmt81347 = 0.0;
		{
			double b1 = this.get_xMax();
			__temp_stmt81347 = java.lang.Math.max(p_point.x, b1);
		}
		
		this.set_xMax(__temp_stmt81347);
		double __temp_stmt81348 = 0.0;
		{
			double b2 = this.get_yMin();
			__temp_stmt81348 = java.lang.Math.min(p_point.y, b2);
		}
		
		this.set_yMin(__temp_stmt81348);
		double __temp_stmt81349 = 0.0;
		{
			double b3 = this.get_yMax();
			__temp_stmt81349 = java.lang.Math.max(p_point.y, b3);
		}
		
		this.set_yMax(__temp_stmt81349);
	}
	
	
	public   haxor.math.AABB2 Encapsulate3(java.lang.Object p_x, java.lang.Object p_y)
	{
		double __temp_p_y80629 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x80628 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.m_xMin = java.lang.Math.min(__temp_p_x80628, this.m_xMin);
		this.m_xMax = java.lang.Math.max(__temp_p_x80628, this.m_xMax);
		this.m_yMin = java.lang.Math.min(__temp_p_y80629, this.m_yMin);
		this.m_yMax = java.lang.Math.max(__temp_p_y80629, this.m_yMax);
		this.Validate();
		return this;
	}
	...
	{
		int __temp_p_places80630 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		java.lang.String s0 = null;
		double __temp_stmt81350 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places80630) ));
			double __temp_stmt81351 = 0.0;
			{
				double p_v = ( this.m_xMin * d );
				__temp_stmt81351 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt81350 = ( __temp_stmt81351 / d );
		}
		
		s0 = ( haxe.lang.Runtime.toString(__temp_stmt81350) + "" );
		java.lang.String s1 = null;
		double __temp_stmt81352 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places80630) ));
			double __temp_stmt81353 = 0.0;
			{
				double p_v1 = ( this.m_xMax * d1 );
				__temp_stmt81353 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt81352 = ( __temp_stmt81353 / d1 );
		}
		
		s1 = ( haxe.lang.Runtime.toString(__temp_stmt81352) + "" );
		java.lang.String s2 = null;
		double __temp_stmt81354 = 0.0;
		{
			double d2 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places80630) ));
			double __temp_stmt81355 = 0.0;
			{
				double p_v2 = ( this.m_yMin * d2 );
				__temp_stmt81355 = ((double) (((int) (( p_v2 + (( (( p_v2 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt81354 = ( __temp_stmt81355 / d2 );
		}
		
		s2 = ( haxe.lang.Runtime.toString(__temp_stmt81354) + "" );
		java.lang.String s3 = null;
		double __temp_stmt81356 = 0.0;
		{
			double d3 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places80630) ));
			double __temp_stmt81357 = 0.0;
			{
				double p_v3 = ( this.m_yMax * d3 );
				__temp_stmt81357 = ((double) (((int) (( p_v3 + (( (( p_v3 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt81356 = ( __temp_stmt81357 / d3 );
		}
		
		s3 = ( haxe.lang.Runtime.toString(__temp_stmt81356) + "" );
		return ( ( ( ( ( ( ( ( "[" + s0 ) + "," ) + s1 ) + "|" ) + s2 ) + "," ) + s3 ) + "]" );
	}
	...
	{
		{
			boolean __temp_executeDef81358 = true;
	...
	{
		{
			boolean __temp_executeDef81359 = true;
			switch (field.hashCode())
			{
				case 3530753:
				{
	...
	{
		{
			boolean __temp_executeDef81360 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			boolean __temp_executeDef81361 = true;
			switch (field.hashCode())
			{
				case -1221029593:
				{
	...
	{
		{
			boolean __temp_executeDef81362 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
