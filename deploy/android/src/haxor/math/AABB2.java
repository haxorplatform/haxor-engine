...
public  class AABB2 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_AABB2(haxor.math.AABB2 __temp_me164232, java.lang.Object p_x, java.lang.Object p_y, java.lang.Object p_width, java.lang.Object p_height)
	{
		double __temp_p_height164231 = ( (( p_height == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_height)) )) );
		double __temp_p_width164230 = ( (( p_width == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_width)) )) );
		double __temp_p_y164229 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x164228 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me164232.SetXYWH(__temp_p_x164228, __temp_p_y164229, __temp_p_width164230, __temp_p_height164231);
	}
	...
	{
		double hw = 0.0;
		double __temp_stmt164905 = 0.0;
		{
			double p_a = ( this.get_xMax() - this.get_xMin() );
			__temp_stmt164905 = ( (( p_a < 0 )) ? ( - (p_a) ) : (p_a) );
		}
		
		hw = ( __temp_stmt164905 * 0.5 );
		double hh = 0.0;
		double __temp_stmt164906 = 0.0;
		{
			double p_a1 = ( this.get_yMax() - this.get_yMin() );
			__temp_stmt164906 = ( (( p_a1 < 0 )) ? ( - (p_a1) ) : (p_a1) );
		}
		
		hh = ( __temp_stmt164906 * 0.5 );
		this.m_xMin = ( v.x - hw );
		this.m_xMax = ( v.x + hw );
		this.m_yMin = ( v.y - hh );
		this.m_yMax = ( v.y + hh );
	...
	{
		double __temp_stmt164907 = 0.0;
		{
			double p_a = ( this.get_xMax() - this.get_xMin() );
			__temp_stmt164907 = ( (( p_a < 0 )) ? ( - (p_a) ) : (p_a) );
		}
		
		double __temp_stmt164908 = 0.0;
		{
			double p_a1 = ( this.get_yMax() - this.get_yMin() );
			__temp_stmt164908 = ( (( p_a1 < 0 )) ? ( - (p_a1) ) : (p_a1) );
		}
		
		return new haxor.math.Vector2(((java.lang.Object) (__temp_stmt164907) ), ((java.lang.Object) (__temp_stmt164908) ));
	}
	...
	{
		{
			...
			double __temp_expr164909 = v1;
		}
		
		{
			double v2 = v.y;
			this.set_yMax(( this.get_yMin() + v2 ));
			double __temp_expr164910 = v2;
		}
	...
	{
		double __temp_stmt164911 = 0.0;
		{
			double b = this.get_xMin();
			__temp_stmt164911 = java.lang.Math.min(p_point.x, b);
		}
		
		this.set_xMin(__temp_stmt164911);
		double __temp_stmt164912 = 0.0;
		{
			double b1 = this.get_xMax();
			__temp_stmt164912 = java.lang.Math.max(p_point.x, b1);
		}
		
		this.set_xMax(__temp_stmt164912);
		double __temp_stmt164913 = 0.0;
		{
			double b2 = this.get_yMin();
			__temp_stmt164913 = java.lang.Math.min(p_point.y, b2);
		}
		
		this.set_yMin(__temp_stmt164913);
		double __temp_stmt164914 = 0.0;
		{
			double b3 = this.get_yMax();
			__temp_stmt164914 = java.lang.Math.max(p_point.y, b3);
		}
		
		this.set_yMax(__temp_stmt164914);
	}
	
	
	public   haxor.math.AABB2 Encapsulate3(java.lang.Object p_x, java.lang.Object p_y)
	{
		double __temp_p_y164226 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x164225 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.m_xMin = java.lang.Math.min(__temp_p_x164225, this.m_xMin);
		this.m_xMax = java.lang.Math.max(__temp_p_x164225, this.m_xMax);
		this.m_yMin = java.lang.Math.min(__temp_p_y164226, this.m_yMin);
		this.m_yMax = java.lang.Math.max(__temp_p_y164226, this.m_yMax);
		this.Validate();
		return this;
	}
	...
	{
		int __temp_p_places164227 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		java.lang.String s0 = null;
		double __temp_stmt164915 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places164227) ));
			double __temp_stmt164916 = 0.0;
			{
				double p_v = ( this.m_xMin * d );
				__temp_stmt164916 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt164915 = ( __temp_stmt164916 / d );
		}
		
		s0 = ( haxe.lang.Runtime.toString(__temp_stmt164915) + "" );
		java.lang.String s1 = null;
		double __temp_stmt164917 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places164227) ));
			double __temp_stmt164918 = 0.0;
			{
				double p_v1 = ( this.m_xMax * d1 );
				__temp_stmt164918 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt164917 = ( __temp_stmt164918 / d1 );
		}
		
		s1 = ( haxe.lang.Runtime.toString(__temp_stmt164917) + "" );
		java.lang.String s2 = null;
		double __temp_stmt164919 = 0.0;
		{
			double d2 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places164227) ));
			double __temp_stmt164920 = 0.0;
			{
				double p_v2 = ( this.m_yMin * d2 );
				__temp_stmt164920 = ((double) (((int) (( p_v2 + (( (( p_v2 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt164919 = ( __temp_stmt164920 / d2 );
		}
		
		s2 = ( haxe.lang.Runtime.toString(__temp_stmt164919) + "" );
		java.lang.String s3 = null;
		double __temp_stmt164921 = 0.0;
		{
			double d3 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places164227) ));
			double __temp_stmt164922 = 0.0;
			{
				double p_v3 = ( this.m_yMax * d3 );
				__temp_stmt164922 = ((double) (((int) (( p_v3 + (( (( p_v3 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt164921 = ( __temp_stmt164922 / d3 );
		}
		
		s3 = ( haxe.lang.Runtime.toString(__temp_stmt164921) + "" );
		return ( ( ( ( ( ( ( ( "[" + s0 ) + "," ) + s1 ) + "|" ) + s2 ) + "," ) + s3 ) + "]" );
	}
	...
	{
		{
			boolean __temp_executeDef164923 = true;
	...
	{
		{
			boolean __temp_executeDef164924 = true;
			switch (field.hashCode())
			{
				case 3530753:
				{
	...
	{
		{
			boolean __temp_executeDef164925 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			boolean __temp_executeDef164926 = true;
			switch (field.hashCode())
			{
				case -1221029593:
				{
	...
	{
		{
			boolean __temp_executeDef164927 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
