...
public  class AABB2 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_AABB2(haxor.math.AABB2 __temp_me255426, java.lang.Object p_x, java.lang.Object p_y, java.lang.Object p_width, java.lang.Object p_height)
	{
		double __temp_p_height255425 = ( (( p_height == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_height)) )) );
		double __temp_p_width255424 = ( (( p_width == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_width)) )) );
		double __temp_p_y255423 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x255422 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me255426.SetXYWH(__temp_p_x255422, __temp_p_y255423, __temp_p_width255424, __temp_p_height255425);
	}
	...
	{
		double hw = 0.0;
		double __temp_stmt256101 = 0.0;
		{
			double p_a = ( this.get_xMax() - this.get_xMin() );
			__temp_stmt256101 = ( (( p_a < 0 )) ? ( - (p_a) ) : (p_a) );
		}
		
		hw = ( __temp_stmt256101 * 0.5 );
		double hh = 0.0;
		double __temp_stmt256102 = 0.0;
		{
			double p_a1 = ( this.get_yMax() - this.get_yMin() );
			__temp_stmt256102 = ( (( p_a1 < 0 )) ? ( - (p_a1) ) : (p_a1) );
		}
		
		hh = ( __temp_stmt256102 * 0.5 );
		this.m_xMin = ( v.x - hw );
		this.m_xMax = ( v.x + hw );
		this.m_yMin = ( v.y - hh );
		this.m_yMax = ( v.y + hh );
	...
	{
		double __temp_stmt256103 = 0.0;
		{
			double p_a = ( this.get_xMax() - this.get_xMin() );
			__temp_stmt256103 = ( (( p_a < 0 )) ? ( - (p_a) ) : (p_a) );
		}
		
		double __temp_stmt256104 = 0.0;
		{
			double p_a1 = ( this.get_yMax() - this.get_yMin() );
			__temp_stmt256104 = ( (( p_a1 < 0 )) ? ( - (p_a1) ) : (p_a1) );
		}
		
		return new haxor.math.Vector2(((java.lang.Object) (__temp_stmt256103) ), ((java.lang.Object) (__temp_stmt256104) ));
	}
	...
	{
		{
			...
			double __temp_expr256105 = v1;
		}
		
		{
			double v2 = v.y;
			this.set_yMax(( this.get_yMin() + v2 ));
			double __temp_expr256106 = v2;
		}
	...
	{
		double __temp_stmt256107 = 0.0;
		{
			double b = this.get_xMin();
			__temp_stmt256107 = java.lang.Math.min(p_point.x, b);
		}
		
		this.set_xMin(__temp_stmt256107);
		double __temp_stmt256108 = 0.0;
		{
			double b1 = this.get_xMax();
			__temp_stmt256108 = java.lang.Math.max(p_point.x, b1);
		}
		
		this.set_xMax(__temp_stmt256108);
		double __temp_stmt256109 = 0.0;
		{
			double b2 = this.get_yMin();
			__temp_stmt256109 = java.lang.Math.min(p_point.y, b2);
		}
		
		this.set_yMin(__temp_stmt256109);
		double __temp_stmt256110 = 0.0;
		{
			double b3 = this.get_yMax();
			__temp_stmt256110 = java.lang.Math.max(p_point.y, b3);
		}
		
		this.set_yMax(__temp_stmt256110);
	}
	
	
	public   haxor.math.AABB2 Encapsulate3(java.lang.Object p_x, java.lang.Object p_y)
	{
		double __temp_p_y255420 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x255419 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.m_xMin = java.lang.Math.min(__temp_p_x255419, this.m_xMin);
		this.m_xMax = java.lang.Math.max(__temp_p_x255419, this.m_xMax);
		this.m_yMin = java.lang.Math.min(__temp_p_y255420, this.m_yMin);
		this.m_yMax = java.lang.Math.max(__temp_p_y255420, this.m_yMax);
		this.Validate();
		return this;
	}
	...
	{
		int __temp_p_places255421 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		java.lang.String s0 = null;
		double __temp_stmt256111 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places255421) ));
			double __temp_stmt256112 = 0.0;
			{
				double p_v = ( this.m_xMin * d );
				__temp_stmt256112 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt256111 = ( __temp_stmt256112 / d );
		}
		
		s0 = ( haxe.lang.Runtime.toString(__temp_stmt256111) + "" );
		java.lang.String s1 = null;
		double __temp_stmt256113 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places255421) ));
			double __temp_stmt256114 = 0.0;
			{
				double p_v1 = ( this.m_xMax * d1 );
				__temp_stmt256114 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt256113 = ( __temp_stmt256114 / d1 );
		}
		
		s1 = ( haxe.lang.Runtime.toString(__temp_stmt256113) + "" );
		java.lang.String s2 = null;
		double __temp_stmt256115 = 0.0;
		{
			double d2 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places255421) ));
			double __temp_stmt256116 = 0.0;
			{
				double p_v2 = ( this.m_yMin * d2 );
				__temp_stmt256116 = ((double) (((int) (( p_v2 + (( (( p_v2 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt256115 = ( __temp_stmt256116 / d2 );
		}
		
		s2 = ( haxe.lang.Runtime.toString(__temp_stmt256115) + "" );
		java.lang.String s3 = null;
		double __temp_stmt256117 = 0.0;
		{
			double d3 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places255421) ));
			double __temp_stmt256118 = 0.0;
			{
				double p_v3 = ( this.m_yMax * d3 );
				__temp_stmt256118 = ((double) (((int) (( p_v3 + (( (( p_v3 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt256117 = ( __temp_stmt256118 / d3 );
		}
		
		s3 = ( haxe.lang.Runtime.toString(__temp_stmt256117) + "" );
		return ( ( ( ( ( ( ( ( "[" + s0 ) + "," ) + s1 ) + "|" ) + s2 ) + "," ) + s3 ) + "]" );
	}
	...
	{
		{
			boolean __temp_executeDef256119 = true;
	...
	{
		{
			boolean __temp_executeDef256120 = true;
			switch (field.hashCode())
			{
				case 3530753:
				{
	...
	{
		{
			boolean __temp_executeDef256121 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			boolean __temp_executeDef256122 = true;
			switch (field.hashCode())
			{
				case -1221029593:
				{
	...
	{
		{
			boolean __temp_executeDef256123 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
