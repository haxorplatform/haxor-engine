...
public  class Vector3 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_Vector3(haxor.math.Vector3 __temp_me71, java.lang.Object p_x, java.lang.Object p_y, java.lang.Object p_z)
	{
		double __temp_p_z70 = ( (( p_z == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_z)) )) );
		double __temp_p_y69 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x68 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me71.x = __temp_p_x68;
		__temp_me71.y = __temp_p_y69;
		__temp_me71.z = __temp_p_z70;
	}
	...
	{
		double __temp_p_z66 = ( (( p_z == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_z)) )) );
		double __temp_p_y65 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x64 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.x = __temp_p_x64;
		this.y = __temp_p_y65;
		this.z = __temp_p_z66;
		return this;
	...
	{
		int __temp_p_places67 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		double __temp_stmt713 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places67) ));
			double __temp_stmt714 = 0.0;
			{
				double p_v = ( this.x * d );
				__temp_stmt714 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt713 = ( __temp_stmt714 / d );
		}
		
		double __temp_stmt715 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places67) ));
			double __temp_stmt716 = 0.0;
			{
				double p_v1 = ( this.y * d1 );
				__temp_stmt716 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt715 = ( __temp_stmt716 / d1 );
		}
		
		double __temp_stmt717 = 0.0;
		{
			double d2 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places67) ));
			double __temp_stmt718 = 0.0;
			{
				double p_v2 = ( this.z * d2 );
				__temp_stmt718 = ((double) (((int) (( p_v2 + (( (( p_v2 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt717 = ( __temp_stmt718 / d2 );
		}
		
		return ( ( ( ( ( ( "[" + haxe.lang.Runtime.toString(__temp_stmt713) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt715) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt717) ) + "]" );
	}
