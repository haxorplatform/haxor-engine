...
public  class Quaternion extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_Quaternion(haxor.math.Quaternion __temp_me84, java.lang.Object p_x, java.lang.Object p_y, java.lang.Object p_z, java.lang.Object p_w)
	{
		double __temp_p_w83 = ( (( p_w == null )) ? (((double) (1.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_w)) )) );
		double __temp_p_z82 = ( (( p_z == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_z)) )) );
		double __temp_p_y81 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x80 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me84.x = __temp_p_x80;
		__temp_me84.y = __temp_p_y81;
		__temp_me84.z = __temp_p_z82;
		__temp_me84.w = __temp_p_w83;
	}
	...
	public static   haxor.math.Quaternion FromEuler(haxor.math.Vector3 p_euler, haxor.math.Quaternion p_result)
	{
		...
		haxor.math.Vector3 __temp_stmt746 = null;
		{
			haxor.context.DataContext _this2 = haxor.context.EngineContext.data;
			__temp_stmt746 = _this2.m_v3.__get(_this2.m_nv3 = ( (( _this2.m_nv3 + 1 )) % _this2.m_v3.length ));
		}
		
		haxor.math.Vector3 e = __temp_stmt746.Set(( p_euler.x * k ), ( p_euler.y * k ), ( p_euler.z * k ));
	...
	public static   haxor.math.Quaternion Slerp(haxor.math.Quaternion p_a, haxor.math.Quaternion p_b, double p_ratio)
	{
		...
		haxor.math.Quaternion __temp_stmt747 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt747 = _this.m_q.__get(_this.m_nq = ( (( _this.m_nq + 1 )) % _this.m_q.length ));
		}
		
		haxor.math.Quaternion z = __temp_stmt747.SetQuaternion(p_b);
		...
		if (( cosTheta > 0.9999 )) 
		{
			double __temp_stmt748 = 0.0;
			{
				double p_a1 = p_a.x;
				__temp_stmt748 = ( p_a1 + ( (( z.x - p_a1 )) * p_ratio ) );
			}
			
			double __temp_stmt749 = 0.0;
			{
				double p_a2 = p_a.y;
				__temp_stmt749 = ( p_a2 + ( (( z.y - p_a2 )) * p_ratio ) );
			}
			
			double __temp_stmt750 = 0.0;
			{
				double p_a3 = p_a.z;
				__temp_stmt750 = ( p_a3 + ( (( z.z - p_a3 )) * p_ratio ) );
			}
			
			double __temp_stmt751 = 0.0;
			{
				double p_a4 = p_a.w;
				__temp_stmt751 = ( p_a4 + ( (( z.w - p_a4 )) * p_ratio ) );
			}
			
			qm.Set(__temp_stmt748, __temp_stmt749, __temp_stmt750, __temp_stmt751);
		}
		 else 
		{
	...
	public static   haxor.math.Quaternion FromAxisAngle(haxor.math.Vector3 p_axis, double p_angle)
	{
		...
		double __temp_stmt752 = 0.0;
		{
			double p_a = ( l - 1.0 );
			__temp_stmt752 = ( (( p_a < 0 )) ? ( - (p_a) ) : (p_a) );
		}
		
		if (( __temp_stmt752 > 0.0001 )) 
		{
			p_axis.Normalize();
		}
	...
	{
		haxor.math.Matrix4 __temp_stmt754 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt754 = _this.m_m4.__get(_this.m_nq = ( (( _this.m_nm4 + 1 )) % _this.m_m4.length ));
		}
		
		haxor.math.Matrix4 __temp_stmt753 = haxor.math.Matrix4.LookAt(p_eye, p_at, p_up, __temp_stmt754);
		return haxor.math.Quaternion.FromMatrix4(__temp_stmt753, p_result);
	}
	...
	{
		{
			haxor.math.Matrix4 _this = null;
			{
				...
				haxor.math.Vector3 __temp_stmt756 = null;
				{
					haxor.context.DataContext _this2 = haxor.context.EngineContext.data;
					__temp_stmt756 = _this2.m_v3.__get(_this2.m_nv3 = ( (( _this2.m_nv3 + 1 )) % _this2.m_v3.length ));
				}
				
				haxor.math.Vector3 __temp_stmt755 = __temp_stmt756.Set(0, 0, 0);
				_this = haxor.math.Matrix4.LookAt(__temp_stmt755, p_forward, p_up, p_result);
			}
			
			haxor.math.Matrix4 __temp_stmt759 = null;
			{
				haxor.context.DataContext _this3 = haxor.context.EngineContext.data;
				__temp_stmt759 = _this3.m_m4.__get(_this3.m_nq = ( (( _this3.m_nm4 + 1 )) % _this3.m_m4.length ));
			}
			
			haxor.math.Matrix4 __temp_stmt758 = __temp_stmt759.SetMatrix4(_this);
			haxor.math.Matrix4 __temp_stmt757 = __temp_stmt758.ToRotation();
			return haxor.math.Quaternion.FromMatrix4(__temp_stmt757, null);
		}
	...
	{
		double __temp_p_w77 = ( (( p_w == null )) ? (((double) (1.0) )) : (((double) (haxe.lang.Runtime.toDouble(p_w)) )) );
		double __temp_p_z76 = ( (( p_z == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_z)) )) );
		double __temp_p_y75 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x74 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.x = __temp_p_x74;
		this.y = __temp_p_y75;
		this.z = __temp_p_z76;
		this.w = __temp_p_w77;
	...
	{
		boolean __temp_p_normalize78 = ( (( p_normalize == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_normalize)) );
	...
	public   haxor.math.Vector3 Transform(haxor.math.Vector3 p_v)
	{
		...
		p_v.y *= nl;
		p_v.z *= nl;
		haxor.math.Quaternion __temp_stmt727 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt727 = _this.m_q.__get(_this.m_nq = ( (( _this.m_nq + 1 )) % _this.m_q.length ));
		}
		
		haxor.math.Quaternion qv = __temp_stmt727.Set(p_v.x, p_v.y, p_v.z, 0);
		haxor.math.Quaternion __temp_stmt728 = null;
		{
			haxor.context.DataContext _this1 = haxor.context.EngineContext.data;
			__temp_stmt728 = _this1.m_q.__get(_this1.m_nq = ( (( _this1.m_nq + 1 )) % _this1.m_q.length ));
		}
		
		haxor.math.Quaternion a = __temp_stmt728.SetQuaternion(this);
		haxor.math.Quaternion __temp_stmt729 = null;
		{
			haxor.context.DataContext _this2 = haxor.context.EngineContext.data;
			__temp_stmt729 = _this2.m_q.__get(_this2.m_nq = ( (( _this2.m_nq + 1 )) % _this2.m_q.length ));
		}
		
		haxor.math.Quaternion c = __temp_stmt729.Set( - (this.x) ,  - (this.y) ,  - (this.z) , this.w);
	...
	{
		haxor.math.Quaternion __temp_stmt731 = null;
		{
			haxor.context.DataContext _this = haxor.context.EngineContext.data;
			__temp_stmt731 = _this.m_q.__get(_this.m_nq = ( (( _this.m_nq + 1 )) % _this.m_q.length ));
		}
		
		haxor.math.Quaternion __temp_stmt730 = haxor.math.Quaternion.DeltaRotation(this, p_q, __temp_stmt731);
		return this.SetQuaternion(__temp_stmt730);
	}
	...
	public   haxor.math.Quaternion SetAxisAngle(haxor.math.Vector3 p_axis, double p_angle)
	{
		p_angle = ( ( p_angle * 0.5 ) * 0.01745329251994329576923690768489 );
		double l = java.lang.Math.sqrt(( ( ( p_axis.x * p_axis.x ) + ( p_axis.y * p_axis.y ) ) + ( p_axis.z * p_axis.z ) ));
		double __temp_stmt732 = 0.0;
		{
			double p_a = ( l - 1.0 );
			__temp_stmt732 = ( (( p_a < 0 )) ? ( - (p_a) ) : (p_a) );
		}
		
		if (( __temp_stmt732 > 0.0001 )) 
		{
			p_axis.Normalize();
		}
	...
	{
		int __temp_p_places79 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		double __temp_stmt733 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places79) ));
			double __temp_stmt734 = 0.0;
			{
				double p_v = ( this.x * d );
				__temp_stmt734 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt733 = ( __temp_stmt734 / d );
		}
		
		double __temp_stmt735 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places79) ));
			double __temp_stmt736 = 0.0;
			{
				double p_v1 = ( this.y * d1 );
				__temp_stmt736 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt735 = ( __temp_stmt736 / d1 );
		}
		
		double __temp_stmt737 = 0.0;
		{
			double d2 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places79) ));
			double __temp_stmt738 = 0.0;
			{
				double p_v2 = ( this.z * d2 );
				__temp_stmt738 = ((double) (((int) (( p_v2 + (( (( p_v2 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt737 = ( __temp_stmt738 / d2 );
		}
		
		double __temp_stmt739 = 0.0;
		{
			double d3 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places79) ));
			double __temp_stmt740 = 0.0;
			{
				double p_v3 = ( this.w * d3 );
				__temp_stmt740 = ((double) (((int) (( p_v3 + (( (( p_v3 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt739 = ( __temp_stmt740 / d3 );
		}
		
		return ( ( ( ( ( ( ( ( "[" + haxe.lang.Runtime.toString(__temp_stmt733) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt735) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt737) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt739) ) + "]" );
	}
