...
public  class Vector4 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_Vector4(haxor.math.Vector4 __temp_me160679, java.lang.Object p_x, java.lang.Object p_y, java.lang.Object p_z, java.lang.Object p_w)
	{
		double __temp_p_w160678 = ( (( p_w == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_w)) )) );
		double __temp_p_z160677 = ( (( p_z == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_z)) )) );
		double __temp_p_y160676 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x160675 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me160679.x = __temp_p_x160675;
		__temp_me160679.y = __temp_p_y160676;
		__temp_me160679.z = __temp_p_z160677;
		__temp_me160679.w = __temp_p_w160678;
	}
	...
	{
		double __temp_p_w160673 = ( (( p_w == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_w)) )) );
		double __temp_p_z160672 = ( (( p_z == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_z)) )) );
		double __temp_p_y160671 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x160670 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.x = __temp_p_x160670;
		this.y = __temp_p_y160671;
		this.z = __temp_p_z160672;
		this.w = __temp_p_w160673;
		return this;
	}
	...
	{
		int __temp_p_places160674 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		double __temp_stmt161574 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places160674) ));
			double __temp_stmt161575 = 0.0;
			{
				double p_v = ( this.x * d );
				__temp_stmt161575 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt161574 = ( __temp_stmt161575 / d );
		}
		
		double __temp_stmt161576 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places160674) ));
			double __temp_stmt161577 = 0.0;
			{
				double p_v1 = ( this.y * d1 );
				__temp_stmt161577 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt161576 = ( __temp_stmt161577 / d1 );
		}
		
		double __temp_stmt161578 = 0.0;
		{
			double d2 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places160674) ));
			double __temp_stmt161579 = 0.0;
			{
				double p_v2 = ( this.z * d2 );
				__temp_stmt161579 = ((double) (((int) (( p_v2 + (( (( p_v2 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt161578 = ( __temp_stmt161579 / d2 );
		}
		
		double __temp_stmt161580 = 0.0;
		{
			double d3 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places160674) ));
			double __temp_stmt161581 = 0.0;
			{
				double p_v3 = ( this.w * d3 );
				__temp_stmt161581 = ((double) (((int) (( p_v3 + (( (( p_v3 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt161580 = ( __temp_stmt161581 / d3 );
		}
		
		return ( ( ( ( ( ( ( ( "[" + haxe.lang.Runtime.toString(__temp_stmt161574) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt161576) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt161578) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt161580) ) + "]" );
	}
	...
	{
		{
			boolean __temp_executeDef161582 = true;
	...
	{
		{
			boolean __temp_executeDef161583 = true;
			switch (field.hashCode())
			{
				case 119:
				{
	...
	{
		{
			boolean __temp_executeDef161584 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			boolean __temp_executeDef161585 = true;
			switch (field.hashCode())
			{
				case 119:
				{
	...
	{
		{
			boolean __temp_executeDef161586 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
