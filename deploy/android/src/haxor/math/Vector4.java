...
public  class Vector4 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_math_Vector4(haxor.math.Vector4 __temp_me349, java.lang.Object p_x, java.lang.Object p_y, java.lang.Object p_z, java.lang.Object p_w)
	{
		double __temp_p_w348 = ( (( p_w == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_w)) )) );
		double __temp_p_z347 = ( (( p_z == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_z)) )) );
		double __temp_p_y346 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x345 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		__temp_me349.x = __temp_p_x345;
		__temp_me349.y = __temp_p_y346;
		__temp_me349.z = __temp_p_z347;
		__temp_me349.w = __temp_p_w348;
	}
	...
	{
		double __temp_p_w343 = ( (( p_w == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_w)) )) );
		double __temp_p_z342 = ( (( p_z == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_z)) )) );
		double __temp_p_y341 = ( (( p_y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_y)) )) );
		double __temp_p_x340 = ( (( p_x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(p_x)) )) );
		this.x = __temp_p_x340;
		this.y = __temp_p_y341;
		this.z = __temp_p_z342;
		this.w = __temp_p_w343;
		return this;
	}
	...
	{
		int __temp_p_places344 = ( (( p_places == null )) ? (((int) (2) )) : (((int) (haxe.lang.Runtime.toInt(p_places)) )) );
		double __temp_stmt1279 = 0.0;
		{
			double d = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places344) ));
			double __temp_stmt1280 = 0.0;
			{
				double p_v = ( this.x * d );
				__temp_stmt1280 = ((double) (((int) (( p_v + (( (( p_v < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt1279 = ( __temp_stmt1280 / d );
		}
		
		double __temp_stmt1281 = 0.0;
		{
			double d1 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places344) ));
			double __temp_stmt1282 = 0.0;
			{
				double p_v1 = ( this.y * d1 );
				__temp_stmt1282 = ((double) (((int) (( p_v1 + (( (( p_v1 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt1281 = ( __temp_stmt1282 / d1 );
		}
		
		double __temp_stmt1283 = 0.0;
		{
			double d2 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places344) ));
			double __temp_stmt1284 = 0.0;
			{
				double p_v2 = ( this.z * d2 );
				__temp_stmt1284 = ((double) (((int) (( p_v2 + (( (( p_v2 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt1283 = ( __temp_stmt1284 / d2 );
		}
		
		double __temp_stmt1285 = 0.0;
		{
			double d3 = java.lang.Math.pow(((double) (10) ), ((double) (__temp_p_places344) ));
			double __temp_stmt1286 = 0.0;
			{
				double p_v3 = ( this.w * d3 );
				__temp_stmt1286 = ((double) (((int) (( p_v3 + (( (( p_v3 < 0 )) ? (-0.5) : (0.5) )) )) )) );
			}
			
			__temp_stmt1285 = ( __temp_stmt1286 / d3 );
		}
		
		return ( ( ( ( ( ( ( ( "[" + haxe.lang.Runtime.toString(__temp_stmt1279) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt1281) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt1283) ) + "," ) + haxe.lang.Runtime.toString(__temp_stmt1285) ) + "]" );
	}
	...
	{
		{
			boolean __temp_executeDef1287 = true;
	...
	{
		{
			boolean __temp_executeDef1288 = true;
			switch (field.hashCode())
			{
				case 119:
				{
	...
	{
		{
			boolean __temp_executeDef1289 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
	...
	{
		{
			boolean __temp_executeDef1290 = true;
			switch (field.hashCode())
			{
				case 119:
				{
	...
	{
		{
			boolean __temp_executeDef1291 = true;
			switch (field.hashCode())
			{
				case -1712277876:
				{
