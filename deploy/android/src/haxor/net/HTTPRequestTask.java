...
public  class HTTPRequestTask<T, U> extends haxor.thread.Task
{
	...
	public static  <T_c, U_c> void __hx_ctor_haxor_net_HTTPRequestTask(haxor.net.HTTPRequestTask<T_c, U_c> __temp_me255641, java.lang.String p_url, java.lang.String p_method, boolean p_binary, java.lang.Object p_data)
	{
		haxor.thread.Task.__hx_ctor_haxor_thread_Task(__temp_me255641, null, null);
		if (( haxe.lang.StringExt.indexOf(p_url, "./", null) >= 0 )) 
		{
			p_url = haxe.root.StringTools.replace(p_url, "./", haxor.net.Web.root);
		}
		
		__temp_me255641.url = p_url;
		__temp_me255641.binary = p_binary;
		__temp_me255641.method = p_method;
		__temp_me255641.data = p_data;
		__temp_me255641.bytesLoaded = 0;
		__temp_me255641.bytesTotal = 0;
		__temp_me255641.error = "";
		haxor.core.Console.Log(( "HTTPRequest> " + __temp_me255641.url ), 4);
	}
	...
	{
		{
			boolean __temp_executeDef256494 = true;
	...
	{
		{
			boolean __temp_executeDef256495 = true;
			switch (field.hashCode())
			{
				case 96784904:
				{
	...
	{
		{
			boolean __temp_executeDef256496 = true;
			switch (field.hashCode())
			{
				case 314785609:
				{
	...
	{
		{
			boolean __temp_executeDef256497 = true;
			switch (field.hashCode())
			{
				case 1382331801:
				{
	...
	{
		{
			boolean __temp_executeDef256498 = true;
			switch (field.hashCode())
			{
				case 327758243:
				{
