...
public  class Int32Array extends haxor.io.Buffer
{
	...
	public static   void __hx_ctor_haxor_io_Int32Array(haxor.io.Int32Array __temp_me54516, int p_length)
	{
		haxor.io.Buffer.__hx_ctor_haxor_io_Buffer(__temp_me54516, p_length);
		__temp_me54516.aux = __temp_me54516.m_buffer.asIntBuffer();
	}
	...
	{
		int __temp_p_offset54515 = ( (( p_offset == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_offset)) )) );
		int _g1 = 0;
		int _g = p_data.length;
		while (( _g1 < _g ))
		{
			int i = _g1++;
			this.Set(( i + __temp_p_offset54515 ), ((int) (haxe.lang.Runtime.toInt(p_data.__get(i))) ));
		}
	...
	{
		{
			boolean __temp_executeDef54777 = true;
	...
	{
		{
			boolean __temp_executeDef54778 = true;
			switch (field.hashCode())
			{
				case 119371723:
				{
	...
	{
		{
			int __temp_hash54780 = field.hashCode();
			boolean __temp_executeDef54779 = true;
			switch (__temp_hash54780)
			{
				case 119371723:case -829503743:
				{
					if (( (( ( __temp_hash54780 == 119371723 ) && field.equals("SetViewSlice") )) || field.equals("get_bytesPerElement") )) 
					{
						__temp_executeDef54779 = false;
