...
public  class Buffer extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_Buffer(haxor.io.Buffer __temp_me278, int p_length)
	{
		__temp_me278.Resize(p_length);
	}
	...
	{
		int __temp_p_offset273 = ( (( p_offset == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_offset)) )) );
		int _g1 = 0;
		int _g = p_list.length;
		while (( _g1 < _g ))
		{
			int i = _g1++;
			this.SetByte(( i + __temp_p_offset273 ), ((int) (haxe.lang.Runtime.toInt(p_list.__get(i))) ));
		}
	...
	{
		int __temp_p_offset274 = ( (( p_offset == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_offset)) )) );
		int _g1 = 0;
		int _g = ( p_target.m_length * p_target.get_bytesPerElement() );
		while (( _g1 < _g ))
		{
			int i = _g1++;
			this.SetByte(( i + __temp_p_offset274 ), p_target.GetByte(i));
		}
	...
	{
		int __temp_p_length276 = ( (( p_length == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_length)) )) );
		int __temp_p_offset275 = ( (( p_offset == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_offset)) )) );
		int len = 0;
		if (( __temp_p_length276 <= 0 )) 
		{
			len = ( this.m_length * this.get_bytesPerElement() );
		}
		 else 
		{
			len = __temp_p_length276;
		}
		...
		haxe.root.StringBuf s = new haxe.root.StringBuf();
		{
			...
			{
				int i = _g++;
				s.addChar(this.GetByte(( i + __temp_p_offset275 )));
			}
	...
	{
		int __temp_p_offset277 = ( (( p_offset == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_offset)) )) );
		int _g1 = 0;
		int _g = p_string.length();
		while (( _g1 < _g ))
		{
			int i = _g1++;
			this.SetByte(( i + __temp_p_offset277 ), ((int) (haxe.lang.Runtime.toInt(haxe.lang.StringExt.charCodeAt(p_string, i))) ));
		}
	...
	{
		{
			boolean __temp_executeDef1088 = true;
	...
	{
		{
			boolean __temp_executeDef1089 = true;
			switch (field.hashCode())
			{
				case -1705094408:
				{
	...
	{
		{
			boolean __temp_executeDef1090 = true;
			switch (field.hashCode())
			{
				case 305726883:
				{
	...
	{
		{
			boolean __temp_executeDef1091 = true;
			switch (field.hashCode())
			{
				case -1705094408:
				{
	...
	{
		{
			boolean __temp_executeDef1092 = true;
			switch (field.hashCode())
			{
				case 305726883:
				{
