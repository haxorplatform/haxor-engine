...
public  class Buffer extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_Buffer(haxor.io.Buffer __temp_me4475, int p_length)
	{
		__temp_me4475.m_length = p_length;
		int len = ( __temp_me4475.m_length * __temp_me4475.get_bytesPerElement() );
		__temp_me4475.m_buffer = java.nio.ByteBuffer.allocateDirect(((int) (len) )).order(((java.nio.ByteOrder) (java.nio.ByteOrder.nativeOrder()) ));
	}
	...
	{
		{
			boolean __temp_executeDef4639 = true;
	...
	{
		{
			boolean __temp_executeDef4640 = true;
			switch (field.hashCode())
			{
				case -1705094408:
				{
	...
	{
		{
			boolean __temp_executeDef4641 = true;
			switch (field.hashCode())
			{
				case -645846934:
				{
	...
	{
		{
			boolean __temp_executeDef4642 = true;
			switch (field.hashCode())
			{
				case -1705094408:
				{
	...
	{
		{
			boolean __temp_executeDef4643 = true;
			switch (field.hashCode())
			{
				case -645846934:
				{
