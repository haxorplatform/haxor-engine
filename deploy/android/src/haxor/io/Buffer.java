...
public  class Buffer extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_Buffer(haxor.io.Buffer __temp_me56120, int p_length)
	{
		__temp_me56120.m_length = p_length;
		int len = ( __temp_me56120.m_length * __temp_me56120.get_bytesPerElement() );
		__temp_me56120.m_offset = 0;
		__temp_me56120.m_buffer = java.nio.ByteBuffer.allocateDirect(((int) (len) )).order(((java.nio.ByteOrder) (java.nio.ByteOrder.nativeOrder()) ));
	}
	...
	{
		{
			boolean __temp_executeDef56454 = true;
	...
	{
		{
			boolean __temp_executeDef56455 = true;
			switch (field.hashCode())
			{
				case -1705094408:
				{
	...
	{
		{
			boolean __temp_executeDef56456 = true;
			switch (field.hashCode())
			{
				case 305726883:
				{
	...
	{
		{
			boolean __temp_executeDef56457 = true;
			switch (field.hashCode())
			{
				case -1705094408:
				{
	...
	{
		{
			boolean __temp_executeDef56458 = true;
			switch (field.hashCode())
			{
				case 305726883:
				{
