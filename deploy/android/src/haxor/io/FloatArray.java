...
public  class FloatArray extends haxor.io.Buffer
{
	...
	public static   void __hx_ctor_haxor_io_FloatArray(haxor.io.FloatArray __temp_me4477, int p_length)
	{
		haxor.io.Buffer.__hx_ctor_haxor_io_Buffer(__temp_me4477, p_length);
		__temp_me4477.aux = __temp_me4477.m_buffer.asFloatBuffer();
	}
	...
	{
		int __temp_p_offset4476 = ( (( p_offset == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(p_offset)) )) );
		int _g1 = 0;
		int _g = p_data.length;
		while (( _g1 < _g ))
		{
			int i = _g1++;
			this.Set(( i + __temp_p_offset4476 ), ((double) (haxe.lang.Runtime.toDouble(p_data.__get(i))) ));
		}
	...
	{
		{
			boolean __temp_executeDef4644 = true;
	...
	{
		{
			boolean __temp_executeDef4645 = true;
			switch (field.hashCode())
			{
				case 1467637275:
				{
	...
	{
		{
			boolean __temp_executeDef4646 = true;
			switch (field.hashCode())
			{
				case -829503743:
				{
