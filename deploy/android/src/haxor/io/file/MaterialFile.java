...
public  class MaterialFile extends haxor.io.file.AssetXML
{
	...
	public static   void __hx_ctor_haxor_io_file_MaterialFile(haxor.io.file.MaterialFile __temp_me255535, java.lang.String p_src)
	{
		__temp_me255535.mguid = "";
		__temp_me255535.mname = "";
		__temp_me255535.queue = "opaque";
		__temp_me255535.offset = 0;
		__temp_me255535.shader = "";
		__temp_me255535.ztest = true;
		__temp_me255535.zfunc = "lessequal";
		__temp_me255535.zwrite = true;
		__temp_me255535.blend = false;
		__temp_me255535.blendSrc = "one";
		__temp_me255535.blendDst = "zero";
		__temp_me255535.invert = false;
		__temp_me255535.lighting = false;
		__temp_me255535.grab = false;
		__temp_me255535.cull = "back";
		__temp_me255535.uniforms = new haxe.root.Array<haxor.io.file.MaterialFileUniform>(new haxor.io.file.MaterialFileUniform[]{});
		haxor.io.file.AssetXML.__hx_ctor_haxor_io_file_AssetXML(__temp_me255535, "", p_src);
	}
	...
	@Override public   java.lang.Object get_asset()
	{
		...
		m.m_guid = this.mguid;
		{
			...
			{
				java.lang.String __temp_svar256343 = (_g);
				switch (__temp_svar256343.hashCode())
				{
					case -1332194002:
					{
						if (__temp_svar256343.equals("background")) 
						{
							m.queue = 0;
						}
					...
					case 502623545:
					{
						if (__temp_svar256343.equals("interface")) 
						{
							m.queue = 4000;
						}
					...
					case -1010695135:
					{
						if (__temp_svar256343.equals("opaque")) 
						{
							m.queue = 1000;
						}
					...
					case -1091287984:
					{
						if (__temp_svar256343.equals("overlay")) 
						{
							m.queue = 3000;
						}
					...
					case -1726194350:
					{
						if (__temp_svar256343.equals("transparent")) 
						{
							m.queue = 2000;
						}
		...
		m.zfunc = 515;
		{
			...
			{
				java.lang.String __temp_svar256345 = (_g1);
				switch (__temp_svar256345.hashCode())
				{
					case 104712844:
					{
						if (__temp_svar256345.equals("never")) 
						{
							m.zfunc = 512;
						}
					...
					case -1369217158:
					{
						if (__temp_svar256345.equals("greaterequal")) 
						{
							m.zfunc = 518;
						}
					...
					case -1414557169:
					{
						if (__temp_svar256345.equals("always")) 
						{
							m.zfunc = 519;
						}
					...
					case 283601914:
					{
						if (__temp_svar256345.equals("greater")) 
						{
							m.zfunc = 516;
						}
					...
					case 1582008385:
					{
						if (__temp_svar256345.equals("notequal")) 
						{
							m.zfunc = 517;
						}
					...
					case 371449147:
					{
						if (__temp_svar256345.equals("lessequal")) 
						{
							m.zfunc = 515;
						}
					...
					case 96757556:
					{
						if (__temp_svar256345.equals("equal")) 
						{
							m.zfunc = 514;
						}
					...
					case 3318169:
					{
						if (__temp_svar256345.equals("less")) 
						{
							m.zfunc = 513;
						}
		...
		m.grab = this.grab;
		{
			...
			{
				java.lang.String __temp_svar256347 = (_g2);
				switch (__temp_svar256347.hashCode())
				{
					case 3387192:
					{
						if (__temp_svar256347.equals("none")) 
						{
							m.cull = 0;
						}
					...
					case 3015911:
					{
						if (__temp_svar256347.equals("back")) 
						{
							m.cull = 2;
						}
					...
					case 97705513:
					{
						if (__temp_svar256347.equals("front")) 
						{
							m.cull = 1;
						}
		...
		
		{
			...
			while (( _g11 < _g3 ))
			{
				...
				haxe.root.Array<java.lang.Object> a = this.stof32a(u.value, null);
				{
					...
					{
						java.lang.String __temp_svar256349 = (_g21);
						switch (__temp_svar256349.hashCode())
						{
							case 104431:
							{
								if (__temp_svar256349.equals("int")) 
								{
							...
							case -1417816805:
							{
								if (__temp_svar256349.equals("texture")) 
								{
							...
							case 3615518:
							{
								if (__temp_svar256349.equals("vec2")) 
								{
							...
							case 94842723:
							{
								if (__temp_svar256349.equals("color")) 
								{
							...
							case 3615519:
							{
								if (__temp_svar256349.equals("vec3")) 
								{
							...
							case 3344084:
							{
								if (__temp_svar256349.equals("mat4")) 
								{
									haxor.math.Matrix4 __temp_stmt256342 = null;
									{
										haxor.context.DataContext _this = haxor.context.EngineContext.data;
										__temp_stmt256342 = _this.m_m4.__get(_this.m_nq = ( (( _this.m_nm4 + 1 )) % _this.m_m4.length ));
									}
									
									m.SetMatrix4(u.name, haxor.math.Matrix4.FromArray(a, __temp_stmt256342), null);
								}
							...
							case 3615520:
							{
								if (__temp_svar256349.equals("vec4")) 
								{
									m.SetFloat4(u.name, ((double) (haxe.lang.Runtime.toDouble(a.__get(0))) ), ((double) (haxe.lang.Runtime.toDouble(a.__get(1))) ), ((double) (haxe.lang.Runtime.toDouble(a.__get(2))) ), ((double) (haxe.lang.Runtime.toDouble(a.__get(3))) ));
								}
	...
	@Override public   void Parse(haxe.root.Xml n)
	{
		...
		{
			java.lang.String __temp_svar256351 = (_g);
			switch (__temp_svar256351.hashCode())
			{
				case 299066663:
				{
					if (__temp_svar256351.equals("material")) 
					{
				...
				case -304784065:
				{
					if (__temp_svar256351.equals("uniforms")) 
					{
				...
				case 107944209:
				{
					if (__temp_svar256351.equals("queue")) 
					{
				...
				case 3065202:
				{
					if (__temp_svar256351.equals("cull")) 
					{
				...
				case -903579675:
				{
					if (__temp_svar256351.equals("shader")) 
					{
				...
				case 3181132:
				{
					if (__temp_svar256351.equals("grab")) 
					{
				...
				case 116226060:
				{
					if (__temp_svar256351.equals("ztest")) 
					{
				...
				case 991970060:
				{
					if (__temp_svar256351.equals("lighting")) 
					{
				...
				case 115824190:
				{
					if (__temp_svar256351.equals("zfunc")) 
					{
				...
				case -1183703082:
				{
					if (__temp_svar256351.equals("invert")) 
					{
				...
				case -688811099:
				{
					if (__temp_svar256351.equals("zwrite")) 
					{
				...
				case 93823057:
				{
					if (__temp_svar256351.equals("blend")) 
					{
	...
	{
		{
			java.lang.String __temp_svar256353 = (b);
			switch (__temp_svar256353.hashCode())
			{
				case 3735208:
				{
					if (__temp_svar256353.equals("zero")) 
					{
						return 0;
					}
				...
				case 1634088617:
				{
					if (__temp_svar256353.equals("srcalphasaturate")) 
					{
						return 776;
					}
				...
				case 110182:
				{
					if (__temp_svar256353.equals("one")) 
					{
						return 1;
					}
				...
				case -1707287416:
				{
					if (__temp_svar256353.equals("oneminusdstcolor")) 
					{
						return 775;
					}
				...
				case -414941185:
				{
					if (__temp_svar256353.equals("srccolor")) 
					{
						return 768;
					}
				...
				case 586906814:
				{
					if (__temp_svar256353.equals("dstcolor")) 
					{
						return 774;
					}
				...
				case 1585831881:
				{
					if (__temp_svar256353.equals("oneminussrccolor")) 
					{
						return 769;
					}
				...
				case -1709220221:
				{
					if (__temp_svar256353.equals("oneminusdstalpha")) 
					{
						return 773;
					}
				...
				case -416873990:
				{
					if (__temp_svar256353.equals("srcalpha")) 
					{
						return 770;
					}
				...
				case 584974009:
				{
					if (__temp_svar256353.equals("dstalpha")) 
					{
						return 772;
					}
				...
				case 1583899076:
				{
					if (__temp_svar256353.equals("oneminussrcalpha")) 
					{
						return 771;
					}
	...
	{
		{
			boolean __temp_executeDef256355 = true;
	...
	{
		{
			boolean __temp_executeDef256356 = true;
			switch (field.hashCode())
			{
				case -304784065:
				{
	...
	{
		{
			boolean __temp_executeDef256357 = true;
			switch (field.hashCode())
			{
				case 849145115:
				{
	...
	{
		{
			boolean __temp_executeDef256358 = true;
			switch (field.hashCode())
			{
				case -1019779949:
				{
	...
	{
		{
			int __temp_hash256360 = field.hashCode();
			boolean __temp_executeDef256359 = true;
			switch (__temp_hash256360)
			{
				case 76884627:case 1130071239:
				{
					if (( (( ( __temp_hash256360 == 76884627 ) && field.equals("Parse") )) || field.equals("get_asset") )) 
					{
						__temp_executeDef256359 = false;
