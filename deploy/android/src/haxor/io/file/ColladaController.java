...
public  class ColladaController extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaController(haxor.io.file.ColladaController __temp_me303)
	{
		__temp_me303.bones = null;
		__temp_me303.weights = null;
		__temp_me303.indexes = null;
		__temp_me303.vcount = null;
		__temp_me303.inputs = null;
		__temp_me303.joints = null;
		__temp_me303.binds = null;
		__temp_me303.matrix = null;
		__temp_me303.name = "";
		__temp_me303.id = "";
		__temp_me303.source = "";
		__temp_me303.type = "";
		__temp_me303.matrix = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		__temp_me303.binds = new haxe.root.Array<haxe.root.Array>(new haxe.root.Array[]{});
		__temp_me303.inputs = new haxe.root.Array<haxor.io.file.ColladaInput>(new haxor.io.file.ColladaInput[]{});
		__temp_me303.joints = new haxe.root.Array<java.lang.String>(new java.lang.String[]{});
		__temp_me303.vcount = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		__temp_me303.indexes = new haxe.root.Array<haxe.root.Array>(new haxe.root.Array[]{});
	}
	...
	{
		{
			boolean __temp_executeDef1185 = true;
	...
	{
		{
			boolean __temp_executeDef1186 = true;
			switch (field.hashCode())
			{
				case -1909438370:
				{
	...
	{
		{
			boolean __temp_executeDef1187 = true;
			switch (field.hashCode())
			{
				case -1019779949:
				{
	...
	{
		{
			boolean __temp_executeDef1188 = true;
			switch (field.hashCode())
			{
				case -1909438370:
				{
