...
public  class ColladaMaterial extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaMaterial(haxor.io.file.ColladaMaterial __temp_me307)
	{
		{
			__temp_me307.name = "";
			__temp_me307.id = "";
	...
	{
		{
			boolean __temp_executeDef1200 = true;
	...
	{
		{
			boolean __temp_executeDef1201 = true;
			switch (field.hashCode())
			{
				case 3373707:
				{
