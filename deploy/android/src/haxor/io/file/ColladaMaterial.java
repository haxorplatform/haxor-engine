...
public  class ColladaMaterial extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaMaterial(haxor.io.file.ColladaMaterial __temp_me80721)
	{
		{
			__temp_me80721.name = "";
			__temp_me80721.id = "";
	...
	{
		{
			boolean __temp_executeDef81550 = true;
	...
	{
		{
			boolean __temp_executeDef81551 = true;
			switch (field.hashCode())
			{
				case 3373707:
				{
