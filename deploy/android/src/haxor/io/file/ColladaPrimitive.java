...
public  class ColladaPrimitive extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaPrimitive(haxor.io.file.ColladaPrimitive __temp_me164325)
	{
		__temp_me164325.indexes = null;
		__temp_me164325.vcount = null;
		__temp_me164325.inputs = null;
		__temp_me164325.material = "";
		__temp_me164325.type = "";
		__temp_me164325.inputs = new haxe.root.Array<haxor.io.file.ColladaInput>(new haxor.io.file.ColladaInput[]{});
		__temp_me164325.vcount = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		__temp_me164325.indexes = new haxe.root.Array<haxe.root.Array>(new haxe.root.Array[]{});
		__temp_me164325.m_triangles = null;
	}
	...
	{
		int __temp_p_set164321 = ( (( p_set == null )) ? (((int) (-1) )) : (((int) (haxe.lang.Runtime.toInt(p_set)) )) );
		{
			int _g1 = 0;
			int _g = this.inputs.length;
			while (( _g1 < _g ))
			{
				...
				{
					if (( __temp_p_set164321 < 0 )) 
					{
						return this.inputs.__get(i);
					}
					 else 
					{
						if (( __temp_p_set164321 == this.inputs.__get(i).set )) 
						{
							return this.inputs.__get(i);
						}
	...
	{
		boolean __temp_p_debug164323 = ( (( p_debug == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(p_debug)) );
		int __temp_p_set164322 = ( (( p_set == null )) ? (((int) (-1) )) : (((int) (haxe.lang.Runtime.toInt(p_set)) )) );
		haxor.io.file.ColladaInput ci = this.GetInput(p_semantic, __temp_p_set164322);
		if (( ci == null )) 
		{
	...
	{
		int __temp_p_set164324 = ( (( p_set == null )) ? (((int) (-1) )) : (((int) (haxe.lang.Runtime.toInt(p_set)) )) );
		java.lang.Object res = new haxe.root.Array(new java.lang.Object[]{});
		{
			int _g1 = 0;
			int _g = this.inputs.length;
			while (( _g1 < _g ))
			{
				...
				if (haxe.lang.Runtime.valEq(this.inputs.__get(i).semantic, p_semantic)) 
				{
					...
					{
						if (( __temp_p_set164324 == this.inputs.__get(i).set )) 
						{
							res = this.inputs.__get(i).GetVectorArray();
							break;
						}
	...
	{
		{
			boolean __temp_executeDef165108 = true;
	...
	{
		{
			boolean __temp_executeDef165109 = true;
			switch (field.hashCode())
			{
				case -1088027200:
				{
	...
	{
		{
			boolean __temp_executeDef165110 = true;
			switch (field.hashCode())
			{
				case -1019779949:
				{
	...
	{
		{
			boolean __temp_executeDef165111 = true;
			switch (field.hashCode())
			{
				case -1088027200:
				{
