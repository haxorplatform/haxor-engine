...
public  class ColladaAnimationChannel extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaAnimationChannel(haxor.io.file.ColladaAnimationChannel __temp_me160585)
	{
		__temp_me160585.target = "";
		__temp_me160585.source = "";
		__temp_me160585.keyframes = new haxe.root.Array<haxor.io.file.ColladaAnimationKeyFrame>(new haxor.io.file.ColladaAnimationKeyFrame[]{});
	}
	...
	{
		{
			boolean __temp_executeDef161436 = true;
	...
	{
		{
			boolean __temp_executeDef161437 = true;
			switch (field.hashCode())
			{
				case -1446666299:
				{
