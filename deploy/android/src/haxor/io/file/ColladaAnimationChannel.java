...
public  class ColladaAnimationChannel extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaAnimationChannel(haxor.io.file.ColladaAnimationChannel __temp_me309)
	{
		__temp_me309.target = "";
		__temp_me309.source = "";
		__temp_me309.keyframes = new haxe.root.Array<haxor.io.file.ColladaAnimationKeyFrame>(new haxor.io.file.ColladaAnimationKeyFrame[]{});
	}
	...
	{
		{
			boolean __temp_executeDef1204 = true;
	...
	{
		{
			boolean __temp_executeDef1205 = true;
			switch (field.hashCode())
			{
				case -1446666299:
				{
