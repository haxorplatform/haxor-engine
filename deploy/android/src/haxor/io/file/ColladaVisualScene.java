...
public  class ColladaVisualScene extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaVisualScene(haxor.io.file.ColladaVisualScene __temp_me160580)
	{
		__temp_me160580.children = null;
		__temp_me160580.name = "";
		__temp_me160580.id = "";
		__temp_me160580.type = "";
		__temp_me160580.children = new haxe.root.Array<haxor.io.file.ColladaNode>(new haxor.io.file.ColladaNode[]{});
	}
	...
	{
		{
			boolean __temp_executeDef161421 = true;
	...
	{
		{
			boolean __temp_executeDef161422 = true;
			switch (field.hashCode())
			{
				case 265423742:
				{
	...
	{
		{
			boolean __temp_executeDef161423 = true;
			switch (field.hashCode())
			{
				case 265423742:
				{
