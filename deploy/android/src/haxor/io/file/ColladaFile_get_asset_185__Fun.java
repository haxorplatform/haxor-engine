...
public  class ColladaFile_get_asset_185__Fun extends haxe.lang.Function
{
	public    ColladaFile_get_asset_185__Fun(haxe.root.Array<haxe.root.Array> skinned_meshes, haxe.root.Array<haxe.root.Array> joint_nodes, haxe.root.Array<haxe.ds.ObjectMap> cm, haxe.root.Array<haxor.core.Entity> re, haxe.root.Array<haxe.ds.ObjectMap> mm, haxe.root.Array<haxe.root.Array> joint_transforms, haxe.root.Array<haxe.ds.ObjectMap> hm, haxe.root.Array<haxor.io.file.ColladaFile> _g3)
	{
		super(1, 0);
	...
	@Override public   java.lang.Object __hx_invoke1_o(double __fn_float1, java.lang.Object __fn_dyn1)
	{
		...
		if ( ! (haxe.lang.Runtime.valEq(n.data, "")) ) 
		{
			...
			catch (java.lang.Throwable __temp_catchallException256286)
			{
				java.lang.Object __temp_catchall256287 = __temp_catchallException256286;
				if (( __temp_catchall256287 instanceof haxe.lang.HaxeException )) 
				{
					__temp_catchall256287 = ((haxe.lang.HaxeException) (__temp_catchallException256286) ).obj;
				}
				
				{
					java.lang.Object err = __temp_catchall256287;
					{
					}
		...
		((haxe.ds.ObjectMap<haxor.io.file.ColladaNode, haxor.core.Entity>) (((haxe.ds.ObjectMap) (this.hm.__get(0)) )) ).set(n, ne);
		{
			...
			while (( _g11 < _g4 ))
			{
				...
				java.lang.String cg_target = "";
				{
					...
					{
						java.lang.String __temp_svar256290 = (_g21);
						switch (__temp_svar256290.hashCode())
						{
							case 102970646:
							{
								if (__temp_svar256290.equals("light")) 
								{
									...
									
									{
										...
										{
											java.lang.String __temp_svar256288 = (_g41);
											switch (__temp_svar256288.hashCode())
											{
												case -892145000:
												{
													if (__temp_svar256288.equals("ambient")) 
													{
														{
														}
												...
												case -1631834134:
												{
													if (__temp_svar256288.equals("directional")) 
													{
														{
														}
												...
												case 106845584:
												{
													if (__temp_svar256288.equals("point")) 
													{
							...
							case 637428636:
							{
								if (__temp_svar256290.equals("controller")) 
								{
							...
							case 1846020210:
							{
								if (__temp_svar256290.equals("geometry")) 
								{
									cg_target = ci.target;
								}
