...
public  class ColladaFile extends haxor.io.file.AssetXML
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaFile(haxor.io.file.ColladaFile __temp_me80706, java.lang.String p_name, java.lang.String p_src)
	{
		__temp_me80706.xmlns = "";
		__temp_me80706.version = "";
		__temp_me80706.data = new haxor.io.file.ColladaAssetData();
		__temp_me80706.geometries = new haxe.root.Array<haxor.io.file.ColladaGeometry>(new haxor.io.file.ColladaGeometry[]{});
		__temp_me80706.images = new haxe.root.Array<haxor.io.file.ColladaImage>(new haxor.io.file.ColladaImage[]{});
		__temp_me80706.controllers = new haxe.root.Array<haxor.io.file.ColladaController>(new haxor.io.file.ColladaController[]{});
		__temp_me80706.materials = new haxe.root.Array<haxor.io.file.ColladaMaterial>(new haxor.io.file.ColladaMaterial[]{});
		__temp_me80706.animations = new haxe.root.Array<haxor.io.file.ColladaAnimation>(new haxor.io.file.ColladaAnimation[]{});
		__temp_me80706.lights = new haxe.root.Array<haxor.io.file.ColladaLight>(new haxor.io.file.ColladaLight[]{});
		__temp_me80706.scene = null;
		{
			double x = ( java.lang.Math.random() * 16777215 );
			__temp_me80706.m_id = ((int) (x) );
		}
		
		haxor.io.file.AssetXML.__hx_ctor_haxor_io_file_AssetXML(__temp_me80706, p_name, p_src);
	}
	...
	public static   haxe.root.Array<haxe.root.Array> GenerateTriangles(java.lang.String p_type, haxe.root.Array<haxe.root.Array> p_indexes, haxe.root.Array<java.lang.Object> p_vcount)
	{
		...
		{
			java.lang.String __temp_svar81506 = (p_type);
			switch (__temp_svar81506.hashCode())
			{
				case -814008469:
				{
					if (__temp_svar81506.equals("triangles")) 
					{
				...
				case 561939050:
				{
					if (__temp_svar81506.equals("polylist")) 
					{
						int k = 0;
						{
							int _g11 = 0;
				...
				case 561795705:
				{
					if (__temp_svar81506.equals("polygons")) 
					{
						int _g1 = 0;
	...
	{
		int __temp_o80705 = ( (( o == null )) ? (((int) (0) )) : (((int) (haxe.lang.Runtime.toInt(o)) )) );
		int i = 0;
		int i0 = 0;
		int i1 = 1;
		int i2 = 2;
		...
		while (( i2 < c ))
		{
			res.push(((haxe.root.Array) (((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (t.__get(( i0 + __temp_o80705 ))) )) ).copy()) )) )) ));
			res.push(((haxe.root.Array) (((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (t.__get(( i1 + __temp_o80705 ))) )) ).copy()) )) )) ));
			res.push(((haxe.root.Array) (((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (t.__get(( i2 + __temp_o80705 ))) )) ).copy()) )) )) ));
			i1++;
			i2++;
		}
	...
	@Override public   java.lang.Object get_asset()
	{
		...
		haxe.root.Array<haxe.root.IMap> hm = new haxe.root.Array<haxe.root.IMap>(new haxe.root.IMap[]{((haxe.root.IMap) (new haxe.ds.ObjectMap<haxor.io.file.ColladaNode, haxor.core.Entity>()) )});
		haxe.root.Array<haxe.root.IMap> cm = new haxe.root.Array<haxe.root.IMap>(new haxe.root.IMap[]{((haxe.root.IMap) (new haxe.ds.ObjectMap<haxor.component.Transform, haxor.io.file.ColladaController>()) )});
		haxe.root.Array<haxe.root.IMap> mm = new haxe.root.Array<haxe.root.IMap>(new haxe.root.IMap[]{((haxe.root.IMap) (new haxe.ds.ObjectMap<haxor.io.file.ColladaMaterial, haxor.graphics.material.Material>()) )});
		...
		haxe.root.Array<haxe.root.Array> skinned_meshes = new haxe.root.Array<haxe.root.Array>(new haxe.root.Array[]{((haxe.root.Array) (new haxe.root.Array<haxor.component.SkinnedMeshRenderer>(new haxor.component.SkinnedMeshRenderer[]{})) )});
		{
			...
			while (( _g1 < _g ))
			{
				...
				((haxe.ds.ObjectMap<haxor.io.file.ColladaMaterial, haxor.graphics.material.Material>) (mm.__get(0)) ).set(m, mat);
			}
		...
		this.scene.Traverse(new haxor.io.file.ColladaFile_get_asset_184__Fun(((haxe.root.Array<haxe.root.Array>) (joint_nodes) ), ((haxe.root.Array<haxe.root.IMap>) (hm) ), ((haxe.root.Array<haxe.root.IMap>) (mm) ), ((haxe.root.Array<haxor.core.Entity>) (re) ), ((haxe.root.Array<haxe.root.Array>) (skinned_meshes) ), ((haxe.root.Array<haxe.root.Array>) (joint_transforms) ), ((haxe.root.Array<haxor.io.file.ColladaFile>) (_g3) ), ((haxe.root.Array<haxe.root.IMap>) (cm) )));
		{
			...
			while (( _g12 < _g6 ))
			{
				...
				if (((haxe.ds.ObjectMap<haxor.component.Transform, haxor.io.file.ColladaController>) (cm.__get(0)) ).exists(skr.m_entity.m_transform)) 
				{
					cc1 = ((haxe.ds.ObjectMap<haxor.component.Transform, haxor.io.file.ColladaController>) (cm.__get(0)) ).get(skr.m_entity.m_transform);
				}
				 else 
				{
					cc1 = null;
		...
		java.lang.Object nit = ((haxe.ds.ObjectMap<haxor.io.file.ColladaNode, haxor.core.Entity>) (hm.__get(0)) ).keys();
		while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(nit, "hasNext", null)))
		{
			...
			haxor.core.Entity e = ((haxe.ds.ObjectMap<haxor.io.file.ColladaNode, haxor.core.Entity>) (hm.__get(0)) ).get(n1);
			if (( e == re.__get(0) )) 
			{
				continue;
			}
	...
	{
		boolean __temp_p_exact80704 = ( (( p_exact == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(p_exact)) );
	}
	...
	public   haxor.io.file.ColladaNode FindNodeById(java.lang.String p_id)
	{
		...
		this.scene.Traverse(new haxor.io.file.ColladaFile_FindNodeById_511__Fun(((haxe.root.Array<java.lang.String>) (p_id1) ), ((haxe.root.Array<haxor.io.file.ColladaNode>) (res) )));
		return res.__get(0);
	}
	...
	@Override public   void Parse(haxe.root.Xml n)
	{
		...
		{
			java.lang.String __temp_svar81475 = (_g);
			switch (__temp_svar81475.hashCode())
			{
				case 1667423762:
				{
					if (__temp_svar81475.equals("COLLADA")) 
					{
				...
				case 1821806113:
				{
					if (__temp_svar81475.equals("library_lights")) 
					{
				...
				case 93121264:
				{
					if (__temp_svar81475.equals("asset")) 
					{
				...
				case 582210419:
				{
					if (__temp_svar81475.equals("library_animations")) 
					{
				...
				case -1363060354:
				{
					if (__temp_svar81475.equals("library_effects")) 
					{
						{
						}
				...
				case -264676670:
				{
					if (__temp_svar81475.equals("library_visual_scenes")) 
					{
				...
				case -2081164888:
				{
					if (__temp_svar81475.equals("library_materials")) 
					{
				...
				case 1739432572:
				{
					if (__temp_svar81475.equals("library_images")) 
					{
				...
				case 109254796:
				{
					if (__temp_svar81475.equals("scene")) 
					{
						{
						}
				...
				case -1992142125:
				{
					if (__temp_svar81475.equals("library_controllers")) 
					{
				...
				case 472056468:
				{
					if (__temp_svar81475.equals("library_geometries")) 
					{
	...
	public   void ParseLightLibrary(haxe.root.Xml n)
	{
		...
		while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(it, "hasNext", null)))
		{
			...
			haxe.root.Array<java.lang.Object> ca = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{((java.lang.Object) (1) ), ((java.lang.Object) (1) ), ((java.lang.Object) (1) ), ((java.lang.Object) (1) )});
			{
				...
				{
					java.lang.String __temp_svar81477 = (_g);
					switch (__temp_svar81477.hashCode())
					{
						case 106845584:
						{
							if (__temp_svar81477.equals("point")) 
							{
						...
						case -1631834134:
						{
							if (__temp_svar81477.equals("directional")) 
							{
								ca = this._f32a(haxe.lang.Runtime.toString(this._p(ln, "color.$text", "", null, null)));
							}
						...
						case -892145000:
						{
							if (__temp_svar81477.equals("ambient")) 
							{
								ca = this._f32a(haxe.lang.Runtime.toString(this._p(ln, "color.$text", "", null, null)));
							}
			...
			ln = ((haxe.root.Xml) (haxe.lang.Runtime.callField(lit, "next", null)) );
			{
				...
				{
					java.lang.String __temp_svar81479 = (_g1);
					switch (__temp_svar81479.hashCode())
					{
						case 106845584:
						{
							if (__temp_svar81479.equals("point")) 
							{
						...
						case -1631834134:
						{
							if (__temp_svar81479.equals("directional")) 
							{
								l.intensity = haxe.root.Std.parseFloat(haxe.lang.Runtime.toString(this._p(ln, "multiplier.$text", "1.0", null, null)));
							}
						...
						case -892145000:
						{
							if (__temp_svar81479.equals("ambient")) 
							{
								{
								}
					...
					while (( _g1 < _g ))
					{
						...
						while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(input_iterator, "hasNext", null)))
						{
							haxe.root.Xml chsi = ((haxe.root.Xml) (haxe.lang.Runtime.callField(input_iterator, "next", null)) );
							{
								...
								{
									java.lang.String __temp_svar81481 = (_g2);
									switch (__temp_svar81481.hashCode())
									{
										case 100358090:
										{
											if (__temp_svar81481.equals("input")) 
											{
										...
										case -1005512447:
										{
											if (__temp_svar81481.equals("output")) 
											{
	...
	public   void ParseMaterialLibrary(haxe.root.Xml n)
	{
		...
		while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(it, "hasNext", null)))
		{
			n = ((haxe.root.Xml) (haxe.lang.Runtime.callField(it, "next", null)) );
			{
				java.lang.String _g = n.get_nodeName();
				{
					java.lang.String __temp_svar81483 = (_g);
					switch (__temp_svar81483.hashCode())
					{
						case 299066663:
						{
							if (__temp_svar81483.equals("material")) 
							{
	...
	public   void ParseSceneLibrary(haxe.root.Xml n)
	{
		...
		while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(it, "hasNext", null)))
		{
			n = ((haxe.root.Xml) (haxe.lang.Runtime.callField(it, "next", null)) );
			{
				java.lang.String _g = n.get_nodeName();
				{
					java.lang.String __temp_svar81485 = (_g);
					switch (__temp_svar81485.hashCode())
					{
						case 1946587853:
						{
							if (__temp_svar81485.equals("visual_scene")) 
							{
	...
	public   haxor.io.file.ColladaNode ParseVisualSceneNode(haxor.io.file.ColladaVisualScene scn, haxor.io.file.ColladaNode p, haxe.root.Xml n)
	{
		...
		cn.scene = scn;
		int __temp_stmt81487 = 0;
		{
			double x = ( java.lang.Math.random() * 16777215 );
			__temp_stmt81487 = ((int) (x) );
		}
		
		cn.sid = this._a(n, "sid", ( "node" + __temp_stmt81487 ));
		...
		while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(iit, "hasNext", null)))
		{
			...
			haxor.io.file.ColladaInstance ni = null;
			{
				...
				{
					java.lang.String __temp_svar81488 = (_g);
					switch (__temp_svar81488.hashCode())
					{
						case -818152228:
						{
							if (__temp_svar81488.equals("instance_geometry")) 
							{
						...
						case 96965648:
						{
							if (__temp_svar81488.equals("extra")) 
							{
						...
						case 168224134:
						{
							if (__temp_svar81488.equals("instance_controller")) 
							{
								ni = new haxor.io.file.ColladaInstance();
								ni.type = "controller";
								ni.target = haxe.lang.StringExt.substr(this._a(nin, "url", ""), 1, null);
						...
						case 85436652:
						{
							if (__temp_svar81488.equals("instance_light")) 
							{
								ni = new haxor.io.file.ColladaInstance();
								ni.type = "light";
								ni.target = haxe.lang.StringExt.substr(this._a(nin, "url", ""), 1, null);
	...
	public   void ParseController(haxor.io.file.ColladaController c, haxe.root.Xml n)
	{
		...
		
		{
			...
			{
				java.lang.String __temp_svar81490 = (_g);
				switch (__temp_svar81490.hashCode())
				{
					case 3532157:
					{
						if (__temp_svar81490.equals("skin")) 
						{
					...
					case 104083720:
					{
						if (__temp_svar81490.equals("morph")) 
						{
							{
							}
		...
		if (( jn != null )) 
		{
			...
			while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(jn_it, "hasNext", null)))
			{
				...
				
				{
					...
					{
						java.lang.String __temp_svar81493 = (_g);
						switch (__temp_svar81493.hashCode())
						{
							case 101304458:
							{
								if (__temp_svar81493.equals("joint")) 
								{
									java.lang.String __temp_stmt81492 = null;
									{
										java.lang.String s = haxe.root.StringTools.replace(haxe.lang.Runtime.toString(this._p(sn, "Name_array.$text", "", null, null)), "\n", " ");
										__temp_stmt81492 = s.trim();
									}
									
									c.joints = haxe.lang.StringExt.split(__temp_stmt81492, " ");
								}
							...
							case -1885129035:
							{
								if (__temp_svar81493.equals("inv_bind_matrix")) 
								{
	...
	public   void ParseGeometry(haxor.io.file.ColladaGeometry g, haxe.root.Xml n)
	{
		...
		
		{
			...
			{
				java.lang.String __temp_svar81495 = (_g);
				switch (__temp_svar81495.hashCode())
				{
					case 3347949:
					{
						if (__temp_svar81495.equals("mesh")) 
						{
					...
					case -895858735:
					{
						if (__temp_svar81495.equals("spline")) 
						{
							{
							}
					...
					case -930854843:
					{
						if (__temp_svar81495.equals("convex_mesh")) 
						{
							{
							}
	...
	public   haxe.root.Array<haxor.io.file.ColladaInput> ParseInputList(haxe.root.Xml p, haxe.root.Xml n)
	{
		...
		while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(it, "hasNext", null)))
		{
			...
			{
				double x = ((double) (haxe.lang.Runtime.toDouble(this._p(sn, "technique_common.accessor.@stride", "0", null, null))) );
				ci.stride = ((int) (x) );
			}
	...
	{
		java.lang.String __temp_stmt81497 = null;
		{
			java.lang.String s = haxe.root.StringTools.replace(v, "\n", " ");
			__temp_stmt81497 = s.trim();
		}
		
		haxe.root.Array<java.lang.String> l = haxe.lang.StringExt.split(__temp_stmt81497, " ");
	...
	{
		java.lang.String __temp_stmt81498 = null;
		{
			java.lang.String s = haxe.root.StringTools.replace(v, "\n", " ");
			__temp_stmt81498 = s.trim();
		}
		
		haxe.root.Array<java.lang.String> l = haxe.lang.StringExt.split(__temp_stmt81498, " ");
		haxe.root.Array<java.lang.Object> a = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{});
		{
			int _g1 = 0;
			int _g = l.length;
	...
	{
		java.lang.String __temp_stmt81499 = null;
		{
			java.lang.String s1 = haxe.root.StringTools.replace(v, "\n", " ");
			__temp_stmt81499 = s1.trim();
		}
		
		haxe.root.Array<java.lang.String> l = haxe.lang.StringExt.split(__temp_stmt81499, " ");
		java.lang.String tl = "";
	...
	{
		{
			boolean __temp_executeDef81500 = true;
	...
	{
		{
			boolean __temp_executeDef81501 = true;
			switch (field.hashCode())
			{
				case 3341869:
				{
	...
	{
		{
			boolean __temp_executeDef81502 = true;
			switch (field.hashCode())
			{
				case -1476712900:
				{
	...
	{
		{
			boolean __temp_executeDef81503 = true;
			switch (field.hashCode())
			{
				case 3341869:
				{
	...
	{
		{
			int __temp_hash81505 = field.hashCode();
			boolean __temp_executeDef81504 = true;
			switch (__temp_hash81505)
			{
				case 265423742:case 76884627:case 1130071239:
				{
					if (( (( ( __temp_hash81505 == 265423742 ) && field.equals("TraverseStep") )) || ( (( ( __temp_hash81505 == 76884627 ) && field.equals("Parse") )) || field.equals("get_asset") ) )) 
					{
						__temp_executeDef81504 = false;
