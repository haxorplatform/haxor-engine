...
public  class AssetXML extends haxor.io.file.AssetFile
{
	...
	public static   void __hx_ctor_haxor_io_file_AssetXML(haxor.io.file.AssetXML __temp_me160565, java.lang.String p_name, java.lang.String p_src)
	{
		haxor.io.file.AssetFile.__hx_ctor_haxor_io_file_AssetFile(__temp_me160565, p_name);
		__temp_me160565.x = haxe.root.Xml.parse(p_src);
		__temp_me160565.TraverseStep(__temp_me160565.x.firstElement());
	}
	...
	public   java.lang.String _tla(haxe.root.Xml n, java.lang.String a, java.lang.Object v)
	{
		if (n.exists(a)) 
		{
			java.lang.String __temp_stmt161351 = null;
			{
				java.lang.String s = n.get(a);
				__temp_stmt161351 = s.trim();
			}
			
			return __temp_stmt161351.toLowerCase();
		}
		 else 
		{
			return haxe.lang.Runtime.toString(v);
	...
	{
		boolean __temp_tl160564 = ( (( tl == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(tl)) );
		boolean __temp_t160563 = ( (( t == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(t)) );
		...
		haxe.root.Xml it = n;
		{
			...
			while (( _g1 < _g ))
			{
				...
				{
					java.lang.String __temp_svar161352 = (tk);
					boolean __temp_executeDef161353 = true;
					switch (__temp_svar161352.hashCode())
					{
						case 36803409:
						{
							if (__temp_svar161352.equals("$text")) 
							{
								__temp_executeDef161353 = false;
	...
	{
		{
			boolean __temp_executeDef161354 = true;
	...
	{
		{
			boolean __temp_executeDef161355 = true;
			switch (field.hashCode())
			{
				case 3047:
				{
	...
	{
		{
			boolean __temp_executeDef161356 = true;
			switch (field.hashCode())
			{
				case 3047:
				{
