...
public  class AssetXML extends haxor.io.file.AssetFile
{
	...
	public static   void __hx_ctor_haxor_io_file_AssetXML(haxor.io.file.AssetXML __temp_me289, java.lang.String p_name, java.lang.String p_src)
	{
		haxor.io.file.AssetFile.__hx_ctor_haxor_io_file_AssetFile(__temp_me289, p_name);
		__temp_me289.x = haxe.root.Xml.parse(p_src);
		__temp_me289.TraverseStep(__temp_me289.x.firstElement());
	}
	...
	public   java.lang.String _tla(haxe.root.Xml n, java.lang.String a, java.lang.Object v)
	{
		if (n.exists(a)) 
		{
			java.lang.String __temp_stmt1113 = null;
			{
				java.lang.String s = n.get(a);
				__temp_stmt1113 = s.trim();
			}
			
			return __temp_stmt1113.toLowerCase();
		}
		 else 
		{
			return haxe.lang.Runtime.toString(v);
	...
	{
		boolean __temp_tl288 = ( (( tl == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(tl)) );
		boolean __temp_t287 = ( (( t == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(t)) );
		...
		haxe.root.Xml it = n;
		{
			...
			while (( _g1 < _g ))
			{
				...
				{
					java.lang.String __temp_svar1114 = (tk);
					boolean __temp_executeDef1115 = true;
					switch (__temp_svar1114.hashCode())
					{
						case 36803409:
						{
							if (__temp_svar1114.equals("$text")) 
							{
								__temp_executeDef1115 = false;
	...
	{
		{
			boolean __temp_executeDef1116 = true;
	...
	{
		{
			boolean __temp_executeDef1117 = true;
			switch (field.hashCode())
			{
				case 3047:
				{
	...
	{
		{
			boolean __temp_executeDef1118 = true;
			switch (field.hashCode())
			{
				case 3047:
				{
