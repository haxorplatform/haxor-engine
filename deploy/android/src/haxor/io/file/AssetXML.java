...
public  class AssetXML extends haxor.io.file.AssetFile
{
	...
	public static   void __hx_ctor_haxor_io_file_AssetXML(haxor.io.file.AssetXML __temp_me80703, java.lang.String p_name, java.lang.String p_src)
	{
		haxor.io.file.AssetFile.__hx_ctor_haxor_io_file_AssetFile(__temp_me80703, p_name);
		__temp_me80703.x = haxe.root.Xml.parse(p_src);
		__temp_me80703.TraverseStep(__temp_me80703.x.firstElement());
	}
	...
	public   java.lang.String _tla(haxe.root.Xml n, java.lang.String a, java.lang.Object v)
	{
		if (n.exists(a)) 
		{
			java.lang.String __temp_stmt81469 = null;
			{
				java.lang.String s = n.get(a);
				__temp_stmt81469 = s.trim();
			}
			
			return __temp_stmt81469.toLowerCase();
		}
		 else 
		{
			return haxe.lang.Runtime.toString(v);
	...
	{
		boolean __temp_tl80702 = ( (( tl == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(tl)) );
		boolean __temp_t80701 = ( (( t == null )) ? (haxe.lang.Runtime.toBool(false)) : (haxe.lang.Runtime.toBool(t)) );
		...
		haxe.root.Xml it = n;
		{
			...
			while (( _g1 < _g ))
			{
				...
				{
					java.lang.String __temp_svar81470 = (tk);
					boolean __temp_executeDef81471 = true;
					switch (__temp_svar81470.hashCode())
					{
						case 36803409:
						{
							if (__temp_svar81470.equals("$text")) 
							{
								__temp_executeDef81471 = false;
	...
	{
		{
			boolean __temp_executeDef81472 = true;
	...
	{
		{
			boolean __temp_executeDef81473 = true;
			switch (field.hashCode())
			{
				case 3047:
				{
	...
	{
		{
			boolean __temp_executeDef81474 = true;
			switch (field.hashCode())
			{
				case 3047:
				{
