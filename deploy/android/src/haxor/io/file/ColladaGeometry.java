...
public  class ColladaGeometry extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaGeometry(haxor.io.file.ColladaGeometry __temp_me294)
	{
		{
			__temp_me294.mesh = null;
			__temp_me294.name = "";
			__temp_me294.id = "";
		}
	...
	{
		{
			boolean __temp_executeDef1168 = true;
	...
	{
		{
			boolean __temp_executeDef1169 = true;
			switch (field.hashCode())
			{
				case 3347949:
				{
