...
public  class ColladaInput extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaInput(haxor.io.file.ColladaInput __temp_me301)
	{
		__temp_me301.stride = 0;
		__temp_me301.values = null;
		__temp_me301.set = -1;
		__temp_me301.offset = 0;
		__temp_me301.semantic = "";
		__temp_me301.values = new haxe.root.Array(new java.lang.Object[]{});
	}
	...
	{
		{
			boolean __temp_executeDef1176 = true;
	...
	{
		{
			boolean __temp_executeDef1177 = true;
			switch (field.hashCode())
			{
				case -891986215:
				{
	...
	{
		{
			boolean __temp_executeDef1178 = true;
			switch (field.hashCode())
			{
				case -1088027200:
				{
	...
	{
		{
			boolean __temp_executeDef1179 = true;
			switch (field.hashCode())
			{
				case -891986215:
				{
	...
	{
		{
			boolean __temp_executeDef1180 = true;
			switch (field.hashCode())
			{
				case -1088027200:
				{
