...
public  class ColladaInput extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaInput(haxor.io.file.ColladaInput __temp_me80715)
	{
		__temp_me80715.stride = 0;
		__temp_me80715.values = null;
		__temp_me80715.set = -1;
		__temp_me80715.offset = 0;
		__temp_me80715.semantic = "";
		__temp_me80715.values = new haxe.root.Array(new java.lang.Object[]{});
	}
	...
	{
		{
			boolean __temp_executeDef81526 = true;
	...
	{
		{
			boolean __temp_executeDef81527 = true;
			switch (field.hashCode())
			{
				case -891986215:
				{
	...
	{
		{
			boolean __temp_executeDef81528 = true;
			switch (field.hashCode())
			{
				case -1088027200:
				{
	...
	{
		{
			boolean __temp_executeDef81529 = true;
			switch (field.hashCode())
			{
				case -891986215:
				{
	...
	{
		{
			boolean __temp_executeDef81530 = true;
			switch (field.hashCode())
			{
				case -1088027200:
				{
