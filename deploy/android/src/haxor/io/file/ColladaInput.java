...
public  class ColladaInput extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaInput(haxor.io.file.ColladaInput __temp_me255524)
	{
		__temp_me255524.stride = 0;
		__temp_me255524.values = null;
		__temp_me255524.set = -1;
		__temp_me255524.offset = 0;
		__temp_me255524.semantic = "";
		__temp_me255524.values = new haxe.root.Array(new java.lang.Object[]{});
	}
	...
	{
		{
			boolean __temp_executeDef256304 = true;
	...
	{
		{
			boolean __temp_executeDef256305 = true;
			switch (field.hashCode())
			{
				case -891986215:
				{
	...
	{
		{
			boolean __temp_executeDef256306 = true;
			switch (field.hashCode())
			{
				case -1088027200:
				{
	...
	{
		{
			boolean __temp_executeDef256307 = true;
			switch (field.hashCode())
			{
				case -891986215:
				{
	...
	{
		{
			boolean __temp_executeDef256308 = true;
			switch (field.hashCode())
			{
				case -1088027200:
				{
