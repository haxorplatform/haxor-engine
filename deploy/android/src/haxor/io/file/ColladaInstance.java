...
public  class ColladaInstance extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxor_io_file_ColladaInstance(haxor.io.file.ColladaInstance __temp_me164331)
	{
		__temp_me164331.target = "";
		__temp_me164331.type = "";
		__temp_me164331.materials = new haxe.root.Array<java.lang.String>(new java.lang.String[]{});
	}
	...
	{
		{
			boolean __temp_executeDef165134 = true;
	...
	{
		{
			boolean __temp_executeDef165135 = true;
			switch (field.hashCode())
			{
				case 681132076:
				{
