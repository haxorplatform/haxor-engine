...
public  class StringMap<T> extends haxe.lang.HxObject implements haxe.root.IMap<java.lang.String, T>
{
	...
	public static  <T_c> void __hx_ctor_haxe_ds_StringMap(haxe.ds.StringMap<T_c> __temp_me42346)
	{
		__temp_me42346.cachedIndex = -1;
	}
	...
	public   void set(java.lang.String key, T value)
	{
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					boolean __temp_stmt42496 = false;
					{
						int v = flag = hashes1[i];
						__temp_stmt42496 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv42497 = false;
					if ( ! (__temp_stmt42496) ) 
					{
						__temp_boolv42497 = ( ( flag == k ) && haxe.lang.Runtime.valEq(this._keys[i], key) );
					}
					
					boolean __temp_stmt42495 = ( __temp_stmt42496 || __temp_boolv42497 );
					if ( ! ((__temp_stmt42495)) ) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
	...
	public   int lookup(java.lang.String key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				boolean __temp_stmt42501 = false;
				{
					int v = flag = hashes[i];
					__temp_stmt42501 = ( v == 0 );
				}
				
				boolean __temp_boolv42500 =  ! (__temp_stmt42501) ;
				boolean __temp_boolv42499 = false;
				if (__temp_boolv42500) 
				{
					__temp_boolv42499 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (haxe.lang.Runtime.valEq(keys[i], key))  ));
				}
				
				boolean __temp_stmt42498 = ( __temp_boolv42500 && __temp_boolv42499 );
				if (__temp_stmt42498) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
	...
	public   void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			{
				int k1 = 0;
				boolean __temp_stmt42502 = false;
				{
					int v1 = k1 = hashes[j];
					__temp_stmt42502 = ( (( v1 & -2 )) == 0 );
				}
				...
				if ( ! (__temp_stmt42502) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k1;
						boolean __temp_boolv42505 = ( i < nBuckets );
						boolean __temp_boolv42504 = false;
						if (__temp_boolv42505) 
						{
							boolean __temp_stmt42506 = false;
							{
								int v2 = k1 = hashes[i];
								__temp_stmt42506 = ( (( v2 & -2 )) == 0 );
							}
							
							__temp_boolv42504 =  ! (__temp_stmt42506) ;
						}
						
						boolean __temp_stmt42503 = ( __temp_boolv42505 && __temp_boolv42504 );
						if (__temp_stmt42503) 
						{
							{
	...
	{
		{
			boolean __temp_executeDef42507 = true;
	...
	{
		{
			boolean __temp_executeDef42508 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef42509 = true;
			switch (field.hashCode())
			{
				case -934610812:
				{
	...
	{
		{
			boolean __temp_executeDef42510 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef42511 = true;
			switch (field.hashCode())
			{
				case -934610812:
				{
