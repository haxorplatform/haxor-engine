...
public  class StringMap<T> extends haxe.lang.HxObject implements haxe.root.IMap<java.lang.String, T>
{
	...
	public static  <T_c> void __hx_ctor_haxe_ds_StringMap(haxe.ds.StringMap<T_c> __temp_me33798)
	{
		__temp_me33798.cachedIndex = -1;
	}
	...
	public   void set(java.lang.String key, T value)
	{
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					boolean __temp_stmt33933 = false;
					{
						int v = flag = hashes1[i];
						__temp_stmt33933 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv33934 = false;
					if ( ! (__temp_stmt33933) ) 
					{
						__temp_boolv33934 = ( ( flag == k ) && haxe.lang.Runtime.valEq(this._keys[i], key) );
					}
					
					boolean __temp_stmt33932 = ( __temp_stmt33933 || __temp_boolv33934 );
					if ( ! ((__temp_stmt33932)) ) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
	...
	public   int lookup(java.lang.String key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				boolean __temp_stmt33938 = false;
				{
					int v = flag = hashes[i];
					__temp_stmt33938 = ( v == 0 );
				}
				
				boolean __temp_boolv33937 =  ! (__temp_stmt33938) ;
				boolean __temp_boolv33936 = false;
				if (__temp_boolv33937) 
				{
					__temp_boolv33936 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (haxe.lang.Runtime.valEq(keys[i], key))  ));
				}
				
				boolean __temp_stmt33935 = ( __temp_boolv33937 && __temp_boolv33936 );
				if (__temp_stmt33935) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
	...
	public   void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			{
				int k1 = 0;
				boolean __temp_stmt33939 = false;
				{
					int v1 = k1 = hashes[j];
					__temp_stmt33939 = ( (( v1 & -2 )) == 0 );
				}
				...
				if ( ! (__temp_stmt33939) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k1;
						boolean __temp_boolv33942 = ( i < nBuckets );
						boolean __temp_boolv33941 = false;
						if (__temp_boolv33942) 
						{
							boolean __temp_stmt33943 = false;
							{
								int v2 = k1 = hashes[i];
								__temp_stmt33943 = ( (( v2 & -2 )) == 0 );
							}
							
							__temp_boolv33941 =  ! (__temp_stmt33943) ;
						}
						
						boolean __temp_stmt33940 = ( __temp_boolv33942 && __temp_boolv33941 );
						if (__temp_stmt33940) 
						{
							{
	...
	{
		{
			boolean __temp_executeDef33944 = true;
	...
	{
		{
			boolean __temp_executeDef33945 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef33946 = true;
			switch (field.hashCode())
			{
				case -934610812:
				{
	...
	{
		{
			boolean __temp_executeDef33947 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef33948 = true;
			switch (field.hashCode())
			{
				case -934610812:
				{
