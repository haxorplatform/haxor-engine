...
public  class StringMap<T> extends haxe.lang.HxObject implements haxe.root.IMap<java.lang.String, T>
{
	...
	public static  <T_c> void __hx_ctor_haxe_ds_StringMap(haxe.ds.StringMap<T_c> __temp_me4443)
	{
		__temp_me4443.cachedIndex = -1;
	}
	...
	public   void set(java.lang.String key, T value)
	{
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					boolean __temp_stmt4548 = false;
					{
						int v = flag = hashes1[i];
						__temp_stmt4548 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv4549 = false;
					if ( ! (__temp_stmt4548) ) 
					{
						__temp_boolv4549 = ( ( flag == k ) && haxe.lang.Runtime.valEq(this._keys[i], key) );
					}
					
					boolean __temp_stmt4547 = ( __temp_stmt4548 || __temp_boolv4549 );
					if ( ! ((__temp_stmt4547)) ) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
	...
	public   int lookup(java.lang.String key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				boolean __temp_stmt4553 = false;
				{
					int v = flag = hashes[i];
					__temp_stmt4553 = ( v == 0 );
				}
				
				boolean __temp_boolv4552 =  ! (__temp_stmt4553) ;
				boolean __temp_boolv4551 = false;
				if (__temp_boolv4552) 
				{
					__temp_boolv4551 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (haxe.lang.Runtime.valEq(keys[i], key))  ));
				}
				
				boolean __temp_stmt4550 = ( __temp_boolv4552 && __temp_boolv4551 );
				if (__temp_stmt4550) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
	...
	public   void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			{
				int k1 = 0;
				boolean __temp_stmt4554 = false;
				{
					int v1 = k1 = hashes[j];
					__temp_stmt4554 = ( (( v1 & -2 )) == 0 );
				}
				...
				if ( ! (__temp_stmt4554) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k1;
						boolean __temp_boolv4557 = ( i < nBuckets );
						boolean __temp_boolv4556 = false;
						if (__temp_boolv4557) 
						{
							boolean __temp_stmt4558 = false;
							{
								int v2 = k1 = hashes[i];
								__temp_stmt4558 = ( (( v2 & -2 )) == 0 );
							}
							
							__temp_boolv4556 =  ! (__temp_stmt4558) ;
						}
						
						boolean __temp_stmt4555 = ( __temp_boolv4557 && __temp_boolv4556 );
						if (__temp_stmt4555) 
						{
							{
	...
	{
		{
			boolean __temp_executeDef4559 = true;
	...
	{
		{
			boolean __temp_executeDef4560 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef4561 = true;
			switch (field.hashCode())
			{
				case -934610812:
				{
	...
	{
		{
			boolean __temp_executeDef4562 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef4563 = true;
			switch (field.hashCode())
			{
				case -934610812:
				{
