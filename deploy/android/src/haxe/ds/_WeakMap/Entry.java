...
public  class Entry<K, V> extends java.lang.ref.WeakReference<K> implements haxe.lang.IHxObject
{
	...
	{
		{
			boolean __temp_executeDef160932 = true;
	...
	{
		{
			boolean __temp_executeDef160933 = true;
			switch (field.hashCode())
			{
				case 3195150:
				{
	...
	{
		{
			boolean __temp_executeDef160934 = true;
			switch (field.hashCode())
			{
				case 1324341926:
				{
	...
	{
		{
			boolean __temp_executeDef160935 = true;
			switch (field.hashCode())
			{
				case 3195150:
				{
	...
	{
		{
			int __temp_hash160937 = field.hashCode();
			boolean __temp_executeDef160936 = true;
			switch (__temp_hash160937)
			{
				case 1324341926:case 102230:case -1594257912:case 94746189:
				{
					if (( (( ( __temp_hash160937 == 1324341926 ) && field.equals("isEnqueued") )) || ( (( ( __temp_hash160937 == 102230 ) && field.equals("get") )) || ( (( ( __temp_hash160937 == -1594257912 ) && field.equals("enqueue") )) || field.equals("clear") ) ) )) 
					{
						__temp_executeDef160936 = false;
