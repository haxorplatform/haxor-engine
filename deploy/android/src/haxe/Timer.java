...
public  class Timer extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_Timer(haxe.Timer __temp_me160386, int time_ms)
	{
		__temp_me160386.run = ( (( haxe.Timer___hx_ctor_haxe_Timer_113__Fun.__hx_current != null )) ? (haxe.Timer___hx_ctor_haxe_Timer_113__Fun.__hx_current) : (haxe.Timer___hx_ctor_haxe_Timer_113__Fun.__hx_current = ((haxe.Timer___hx_ctor_haxe_Timer_113__Fun) (new haxe.Timer___hx_ctor_haxe_Timer_113__Fun()) )) );
		__temp_me160386.timer = new java.util.Timer();
		__temp_me160386.timer.scheduleAtFixedRate(((java.util.TimerTask) (__temp_me160386.task = new haxe._Timer.TimerTask(((haxe.Timer) (__temp_me160386) ))) ), ((long) (time_ms) ), ((long) (time_ms) ));
	}
	...
	{
		{
			boolean __temp_executeDef160813 = true;
	...
	{
		{
			boolean __temp_executeDef160814 = true;
			switch (field.hashCode())
			{
				case 113291:
				{
	...
	{
		{
			boolean __temp_executeDef160815 = true;
			switch (field.hashCode())
			{
				case 3540994:
				{
