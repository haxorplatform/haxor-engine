...
public  class StringBuf extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__StringBuf(haxe.root.StringBuf __temp_me1815)
	{
		__temp_me1815.b = new java.lang.StringBuilder();
	}
	...
	{
		{
			boolean __temp_executeDef1885 = true;
	...
	{
		{
			boolean __temp_executeDef1886 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
	...
	{
		{
			boolean __temp_executeDef1887 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
