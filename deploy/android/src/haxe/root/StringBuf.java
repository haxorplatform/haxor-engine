...
public  class StringBuf extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__StringBuf(haxe.root.StringBuf __temp_me54058)
	{
		__temp_me54058.b = new java.lang.StringBuilder();
	}
	...
	{
		{
			boolean __temp_executeDef54210 = true;
	...
	{
		{
			boolean __temp_executeDef54211 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
	...
	{
		{
			boolean __temp_executeDef54212 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
