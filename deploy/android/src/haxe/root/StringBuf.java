...
public  class StringBuf extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__StringBuf(haxe.root.StringBuf __temp_me164129)
	{
		__temp_me164129.b = new java.lang.StringBuilder();
	}
	...
	{
		{
			boolean __temp_executeDef164519 = true;
	...
	{
		{
			boolean __temp_executeDef164520 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
	...
	{
		{
			boolean __temp_executeDef164521 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
