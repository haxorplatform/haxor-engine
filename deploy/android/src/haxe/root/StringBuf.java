...
public  class StringBuf extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__StringBuf(haxe.root.StringBuf __temp_me33792)
	{
		__temp_me33792.b = new java.lang.StringBuilder();
	}
	...
	{
		{
			boolean __temp_executeDef33917 = true;
	...
	{
		{
			boolean __temp_executeDef33918 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
	...
	{
		{
			boolean __temp_executeDef33919 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
