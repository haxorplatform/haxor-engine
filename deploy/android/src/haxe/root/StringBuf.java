...
public  class StringBuf extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__StringBuf(haxe.root.StringBuf __temp_me54460)
	{
		__temp_me54460.b = new java.lang.StringBuilder();
	}
	...
	{
		{
			boolean __temp_executeDef54612 = true;
	...
	{
		{
			boolean __temp_executeDef54613 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
	...
	{
		{
			boolean __temp_executeDef54614 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
