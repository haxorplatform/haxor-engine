...
public  class StringBuf extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__StringBuf(haxe.root.StringBuf __temp_me42340)
	{
		__temp_me42340.b = new java.lang.StringBuilder();
	}
	...
	{
		{
			boolean __temp_executeDef42480 = true;
	...
	{
		{
			boolean __temp_executeDef42481 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
	...
	{
		{
			boolean __temp_executeDef42482 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
