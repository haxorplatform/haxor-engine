...
public final class Array<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array(haxe.root.Array<T_c> __temp_me42330)
	{
		__temp_me42330.length = 0;
		__temp_me42330.__a = ((T_c[]) (((java.lang.Object) (new java.lang.Object[((int) (0) )]) )) );
	}
	...
	{
		{
			boolean __temp_executeDef42442 = true;
	...
	{
		{
			boolean __temp_executeDef42443 = true;
			switch (field.hashCode())
			{
				case 94337:
				{
	...
	{
		{
			boolean __temp_executeDef42444 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
	...
	{
		{
			boolean __temp_executeDef42445 = true;
			switch (field.hashCode())
			{
				case -1106363674:
				{
	...
	{
		{
			boolean __temp_executeDef42446 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
