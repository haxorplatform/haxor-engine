...
public final class Array<T> extends haxe.lang.HxObject
{
	...
	{
		{
			boolean __temp_executeDef403 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
	...
	{
		{
			boolean __temp_executeDef404 = true;
			switch (field.hashCode())
			{
				case -1106363674:
				{
