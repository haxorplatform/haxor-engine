...
public final class Array<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array(haxe.root.Array<T_c> __temp_me55654)
	{
		__temp_me55654.length = 0;
		__temp_me55654.__a = ((T_c[]) (((java.lang.Object) (new java.lang.Object[((int) (0) )]) )) );
	}
	...
	{
		{
			boolean __temp_executeDef55778 = true;
	...
	{
		{
			boolean __temp_executeDef55779 = true;
			switch (field.hashCode())
			{
				case 94337:
				{
	...
	{
		{
			boolean __temp_executeDef55780 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
	...
	{
		{
			boolean __temp_executeDef55781 = true;
			switch (field.hashCode())
			{
				case -1106363674:
				{
	...
	{
		{
			boolean __temp_executeDef55782 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
