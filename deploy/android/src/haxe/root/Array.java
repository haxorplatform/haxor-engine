...
public final class Array<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array(haxe.root.Array<T_c> __temp_me33782)
	{
		__temp_me33782.length = 0;
		__temp_me33782.__a = ((T_c[]) (((java.lang.Object) (new java.lang.Object[((int) (0) )]) )) );
	}
	...
	{
		{
			boolean __temp_executeDef33879 = true;
	...
	{
		{
			boolean __temp_executeDef33880 = true;
			switch (field.hashCode())
			{
				case 94337:
				{
	...
	{
		{
			boolean __temp_executeDef33881 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
	...
	{
		{
			boolean __temp_executeDef33882 = true;
			switch (field.hashCode())
			{
				case -1106363674:
				{
	...
	{
		{
			boolean __temp_executeDef33883 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
