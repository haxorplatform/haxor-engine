...
public final class Array<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array(haxe.root.Array<T_c> __temp_me151263)
	{
		__temp_me151263.length = 0;
		__temp_me151263.__a = ((T_c[]) (((java.lang.Object) (new java.lang.Object[((int) (0) )]) )) );
	}
	...
	{
		{
			boolean __temp_executeDef151629 = true;
	...
	{
		{
			boolean __temp_executeDef151630 = true;
			switch (field.hashCode())
			{
				case 94337:
				{
	...
	{
		{
			boolean __temp_executeDef151631 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
	...
	{
		{
			boolean __temp_executeDef151632 = true;
			switch (field.hashCode())
			{
				case -1106363674:
				{
	...
	{
		{
			boolean __temp_executeDef151633 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
