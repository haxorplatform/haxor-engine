...
public  class Main_Initialize_185__Fun extends haxe.lang.Function
{
	public    Main_Initialize_185__Fun(haxe.root.Array<java.lang.Object> px, haxe.root.Array<java.lang.Object> l, haxe.root.Array<java.lang.Object> pz, haxe.root.Array<java.lang.Object> py, haxe.root.Array<haxe.root.Main> _g)
	{
		super(1, 0);
		this.px = px;
		this.l = l;
	...
	@Override public   java.lang.Object __hx_invoke1_o(double __fn_float1, java.lang.Object __fn_dyn1)
	{
		...
		{
			int __temp_index80850 = 0;
			this.px.__set(__temp_index80850, ( ((double) (haxe.lang.Runtime.toDouble(this.px.__get(__temp_index80850))) ) + 0.12 ));
		}
		...
		if (( ((double) (haxe.lang.Runtime.toDouble(this.px.__get(0))) ) >= ((double) (haxe.lang.Runtime.toDouble(this.l.__get(0))) ) )) 
		{
			this.px.__set(0, 0.0);
			{
				int __temp_index80851 = 0;
				this.pz.__set(__temp_index80851, ( ((double) (haxe.lang.Runtime.toDouble(this.pz.__get(__temp_index80851))) ) + 0.12 ));
			}
			...
			if (( ((double) (haxe.lang.Runtime.toDouble(this.pz.__get(0))) ) >= ((double) (haxe.lang.Runtime.toDouble(this.l.__get(0))) ) )) 
			{
				this.pz.__set(0, 0.0);
				{
					int __temp_index80852 = 0;
					this.py.__set(__temp_index80852, ( ((double) (haxe.lang.Runtime.toDouble(this.py.__get(__temp_index80852))) ) + 0.12 ));
				}
