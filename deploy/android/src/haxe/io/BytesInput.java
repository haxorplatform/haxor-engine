...
public  class BytesInput extends haxe.io.Input
{
	...
	public static   void __hx_ctor_haxe_io_BytesInput(haxe.io.BytesInput __temp_me80560, haxe.io.Bytes b, java.lang.Object pos, java.lang.Object len)
	{
		if (( pos == null )) 
		{
			pos = 0;
		...
		__temp_me80560.b = b.b;
		__temp_me80560.pos = ((int) (haxe.lang.Runtime.toInt(pos)) );
		__temp_me80560.len = ((int) (haxe.lang.Runtime.toInt(len)) );
		__temp_me80560.totlen = ((int) (haxe.lang.Runtime.toInt(len)) );
	}
	...
	{
		{
			boolean __temp_executeDef81121 = true;
	...
	{
		{
			boolean __temp_executeDef81122 = true;
			switch (field.hashCode())
			{
				case 747804969:
				{
	...
	{
		{
			boolean __temp_executeDef81123 = true;
			switch (field.hashCode())
			{
				case -1140063115:
				{
	...
	{
		{
			boolean __temp_executeDef81124 = true;
			switch (field.hashCode())
			{
				case -1106363674:
				{
	...
	{
		{
			int __temp_hash81126 = field.hashCode();
			boolean __temp_executeDef81125 = true;
			switch (__temp_hash81126)
			{
				case -1140063115:case -868060226:
				{
					if (( (( ( __temp_hash81126 == -1140063115 ) && field.equals("readBytes") )) || field.equals("readByte") )) 
					{
						__temp_executeDef81125 = false;
