...
public  class BytesOutput extends haxe.io.Output
{
	...
	public static   void __hx_ctor_haxe_io_BytesOutput(haxe.io.BytesOutput __temp_me160408)
	{
		__temp_me160408.b = new haxe.io.BytesBuffer();
	}
	...
	{
		{
			boolean __temp_executeDef160998 = true;
	...
	{
		{
			boolean __temp_executeDef160999 = true;
			switch (field.hashCode())
			{
				case 1950049973:
				{
	...
	{
		{
			boolean __temp_executeDef161000 = true;
			switch (field.hashCode())
			{
				case -1106363674:
				{
	...
	{
		{
			int __temp_hash161002 = field.hashCode();
			boolean __temp_executeDef161001 = true;
			switch (__temp_hash161002)
			{
				case -662729780:case -1406851705:
				{
					if (( (( ( __temp_hash161002 == -662729780 ) && field.equals("writeBytes") )) || field.equals("writeByte") )) 
					{
						__temp_executeDef161001 = false;
