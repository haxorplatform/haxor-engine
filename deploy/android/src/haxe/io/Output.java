...
public  class Output extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_io_Output(haxe.io.Output __temp_me54066)
	{
		{
		}
	...
	{
		{
			boolean __temp_executeDef54248 = true;
	...
	{
		{
			boolean __temp_executeDef54249 = true;
			switch (field.hashCode())
			{
				case 1412235472:
				{
