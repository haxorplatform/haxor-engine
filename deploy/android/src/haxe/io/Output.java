...
public  class Output extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_io_Output(haxe.io.Output __temp_me54468)
	{
		{
		}
	...
	{
		{
			boolean __temp_executeDef54650 = true;
	...
	{
		{
			boolean __temp_executeDef54651 = true;
			switch (field.hashCode())
			{
				case 1412235472:
				{
