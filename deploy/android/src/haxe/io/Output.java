...
public  class Output extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_io_Output(haxe.io.Output __temp_me21732)
	{
		{
		}
	...
	{
		{
			boolean __temp_executeDef21862 = true;
	...
	{
		{
			boolean __temp_executeDef21863 = true;
			switch (field.hashCode())
			{
				case 1412235472:
				{
