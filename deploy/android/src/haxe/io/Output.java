...
public  class Output extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_io_Output(haxe.io.Output __temp_me164145)
	{
		{
		}
	...
	{
		{
			boolean __temp_executeDef164633 = true;
	...
	{
		{
			boolean __temp_executeDef164634 = true;
			switch (field.hashCode())
			{
				case 1412235472:
				{
