...
public  class Output extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_io_Output(haxe.io.Output __temp_me42348)
	{
		{
		}
	...
	{
		{
			boolean __temp_executeDef42518 = true;
	...
	{
		{
			boolean __temp_executeDef42519 = true;
			switch (field.hashCode())
			{
				case 1412235472:
				{
