...
public  class Base64 extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_crypto_Base64(haxe.crypto.Base64 __temp_me21)
	{
		{
		}
	...
	{
		boolean __temp_complement19 = ( (( complement == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(complement)) );
		java.lang.String str = new haxe.crypto.BaseCode(((haxe.io.Bytes) (haxe.crypto.Base64.BYTES) )).encodeBytes(bytes).toString();
		if (__temp_complement19) 
		{
			int _g1 = 0;
	...
	{
		boolean __temp_complement20 = ( (( complement == null )) ? (haxe.lang.Runtime.toBool(true)) : (haxe.lang.Runtime.toBool(complement)) );
		if (__temp_complement20) 
		{
