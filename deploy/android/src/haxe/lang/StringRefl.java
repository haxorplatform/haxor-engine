...
public  class StringRefl
{
	...
	{
		{
			java.lang.String __temp_svar1345 = (f);
			int __temp_hash1347 = __temp_svar1345.hashCode();
			boolean __temp_executeDef1346 = true;
			switch (__temp_hash1347)
			{
				case -1106363674:
				{
					if (__temp_svar1345.equals("length")) 
					{
						__temp_executeDef1346 = false;
						return str.length();
					}
				...
				{
					if (( (( ( __temp_hash1347 == 530542161 ) && __temp_svar1345.equals("substring") )) || ( (( ( __temp_hash1347 == -891529231 ) && __temp_svar1345.equals("substr") )) || ( (( ( __temp_hash1347 == 109648666 ) && __temp_svar1345.equals("split") )) || ( (( ( __temp_hash1347 == -467511597 ) && __temp_svar1345.equals("lastIndexOf") )) || ( (( ( __temp_hash1347 == 1943291465 ) && __temp_svar1345.equals("indexOf") )) || ( (( ( __temp_hash1347 == 397153782 ) && __temp_svar1345.equals("charCodeAt") )) || ( (( ( __temp_hash1347 == -1361633751 ) && __temp_svar1345.equals("charAt") )) || ( (( ( __temp_hash1347 == -1137582698 ) && __temp_svar1345.equals("toLowerCase") )) || __temp_svar1345.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef1346 = false;
