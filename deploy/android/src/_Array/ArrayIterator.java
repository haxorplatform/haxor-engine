...
public final class ArrayIterator<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array_ArrayIterator(_Array.ArrayIterator<T_c> __temp_me27862, haxe.root.Array<T_c> a)
	{
		__temp_me27862.arr = a;
		__temp_me27862.len = a.length;
		__temp_me27862.i = 0;
	}
	...
	{
		{
			boolean __temp_executeDef27948 = true;
	...
	{
		{
			boolean __temp_executeDef27949 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef27950 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
	...
	{
		{
			boolean __temp_executeDef27951 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef27952 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
