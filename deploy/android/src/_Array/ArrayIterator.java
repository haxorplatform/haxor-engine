...
public final class ArrayIterator<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array_ArrayIterator(_Array.ArrayIterator<T_c> __temp_me56058, haxe.root.Array<T_c> a)
	{
		__temp_me56058.arr = a;
		__temp_me56058.len = a.length;
		__temp_me56058.i = 0;
	}
	...
	{
		{
			boolean __temp_executeDef56260 = true;
	...
	{
		{
			boolean __temp_executeDef56261 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef56262 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
	...
	{
		{
			boolean __temp_executeDef56263 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef56264 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
