...
public final class ArrayIterator<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array_ArrayIterator(_Array.ArrayIterator<T_c> __temp_me1805, haxe.root.Array<T_c> a)
	{
		__temp_me1805.arr = a;
		__temp_me1805.len = a.length;
		__temp_me1805.i = 0;
	}
	...
	{
		{
			boolean __temp_executeDef1855 = true;
	...
	{
		{
			boolean __temp_executeDef1856 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef1857 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
	...
	{
		{
			boolean __temp_executeDef1858 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef1859 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
