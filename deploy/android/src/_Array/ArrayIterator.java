...
public final class ArrayIterator<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array_ArrayIterator(_Array.ArrayIterator<T_c> __temp_me55655, haxe.root.Array<T_c> a)
	{
		__temp_me55655.arr = a;
		__temp_me55655.len = a.length;
		__temp_me55655.i = 0;
	}
	...
	{
		{
			boolean __temp_executeDef55783 = true;
	...
	{
		{
			boolean __temp_executeDef55784 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef55785 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
	...
	{
		{
			boolean __temp_executeDef55786 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef55787 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
