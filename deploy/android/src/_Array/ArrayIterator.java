...
public final class ArrayIterator<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array_ArrayIterator(_Array.ArrayIterator<T_c> __temp_me80522, haxe.root.Array<T_c> a)
	{
		__temp_me80522.arr = a;
		__temp_me80522.len = a.length;
		__temp_me80522.i = 0;
	}
	...
	{
		{
			boolean __temp_executeDef80881 = true;
	...
	{
		{
			boolean __temp_executeDef80882 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef80883 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
	...
	{
		{
			boolean __temp_executeDef80884 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef80885 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
