...
public final class ArrayIterator<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array_ArrayIterator(_Array.ArrayIterator<T_c> __temp_me21715, haxe.root.Array<T_c> a)
	{
		__temp_me21715.arr = a;
		__temp_me21715.len = a.length;
		__temp_me21715.i = 0;
	}
	...
	{
		{
			boolean __temp_executeDef21791 = true;
	...
	{
		{
			boolean __temp_executeDef21792 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef21793 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
	...
	{
		{
			boolean __temp_executeDef21794 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef21795 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
