...
public final class ArrayIterator<T> extends haxe.lang.HxObject
{
	...
	public static  <T_c> void __hx_ctor__Array_ArrayIterator(_Array.ArrayIterator<T_c> __temp_me164120, haxe.root.Array<T_c> a)
	{
		__temp_me164120.arr = a;
		__temp_me164120.len = a.length;
		__temp_me164120.i = 0;
	}
	...
	{
		{
			boolean __temp_executeDef164486 = true;
	...
	{
		{
			boolean __temp_executeDef164487 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef164488 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
	...
	{
		{
			boolean __temp_executeDef164489 = true;
			switch (field.hashCode())
			{
				case 105:
				{
	...
	{
		{
			boolean __temp_executeDef164490 = true;
			switch (field.hashCode())
			{
				case 3377907:
				{
