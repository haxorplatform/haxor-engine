...
var MainIE8 = function() {
	this.log = "";
	haxor.core.Application.call(this);
};
$hxClasses["MainIE8"] = MainIE8;
MainIE8.__name__ = ["MainIE8"];
MainIE8.__interfaces__ = [haxor.core.IRenderable,haxor.core.IUpdateable];
MainIE8.main = function() {
	haxor.platform.html.Entry.Initialize();
};
MainIE8.__super__ = haxor.core.Application;
MainIE8.prototype = $extend(haxor.core.Application.prototype,{
	Load: function() {
		return true;
	}
	,Initialize: function() {
		...
		this.ff = _this.createElement("p");
		this.ff.textContent = "0fps";
		this.field = window.document.getElementById("fps");
		this.field.appendChild(this.ff);
		...
		while(_g < 3000) {
			...
			it = _this1.createElement("p");
			it.style.fontSize = "7px";
			it.style.display = "inline";
			it.innerText = " 0";
			this.pl.push(it);
			this.field.appendChild(it);
		}
	}
	,OnUpdate: function() {
		if(this.pl == null) return;
		var p = this.field.parentElement;
		this.field.remove();
		var _g1 = 0;
		var _g = this.pl.length;
		while(_g1 < _g) {
			var i = _g1++;
			this.pl[i].innerText = haxor.math.Random.RangeInt(0,30) + " ";
		}
		this.ff.innerText = haxor.core.Time.m_fps + " fps";
		p.appendChild(this.field);
	}
	,OnRender: function() {
	}
	,__class__: MainIE8
