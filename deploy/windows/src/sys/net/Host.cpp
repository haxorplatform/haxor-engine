...
::String Host_obj::reverse( ){
	HX_STACK_FRAME("sys.net.Host","reverse",0x015c156e,"sys.net.Host.reverse","F:\\development\\resource\\platform\\haxe\\3_1_3\\haxe\\std/cpp/_std/sys/net/Host.hx",37,0x7ed80650)
	HX_STACK_THIS(this)
	HX_STACK_LINE(38)
	::String _g = ::sys::net::Host_obj::host_reverse(this->ip);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(38)
	return ::String(_g);
}
