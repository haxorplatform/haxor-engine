...
::haxor::graphics::TextureFilter TextureFilter_obj::Linear;

::haxor::graphics::TextureFilter TextureFilter_obj::LinearMipmapLinear;

::haxor::graphics::TextureFilter TextureFilter_obj::LinearMipmapNearest;

::haxor::graphics::TextureFilter TextureFilter_obj::Nearest;

::haxor::graphics::TextureFilter TextureFilter_obj::NearestMipmapLinear;

::haxor::graphics::TextureFilter TextureFilter_obj::NearestMipmapNearest;

::haxor::graphics::TextureFilter TextureFilter_obj::Trilinear;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxor.graphics.TextureFilter"), hx::TCanCast< TextureFilter_obj >,sStaticFields,sMemberFields,
