...
#ifndef INCLUDED_haxor_graphics_CullMode
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxor.graphics.CullMode"), hx::TCanCast< CullMode_obj> ,sStaticFields,sMemberFields,
