...
::haxor::graphics::PixelFormat PixelFormat_obj::Alpha8;

::haxor::graphics::PixelFormat PixelFormat_obj::Depth;

::haxor::graphics::PixelFormat PixelFormat_obj::_Float;

::haxor::graphics::PixelFormat PixelFormat_obj::Float3;

::haxor::graphics::PixelFormat PixelFormat_obj::Float4;

::haxor::graphics::PixelFormat PixelFormat_obj::Half;

::haxor::graphics::PixelFormat PixelFormat_obj::Half3;

::haxor::graphics::PixelFormat PixelFormat_obj::Half4;

::haxor::graphics::PixelFormat PixelFormat_obj::Luminance;

::haxor::graphics::PixelFormat PixelFormat_obj::RGB8;

::haxor::graphics::PixelFormat PixelFormat_obj::RGBA8;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxor.graphics.PixelFormat"), hx::TCanCast< PixelFormat_obj >,sStaticFields,sMemberFields,
