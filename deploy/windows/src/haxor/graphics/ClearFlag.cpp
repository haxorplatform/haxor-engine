...
#include <haxor/graphics/ClearFlag.h>
#endif
namespace haxor{
namespace graphics{
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxor.graphics.ClearFlag"), hx::TCanCast< ClearFlag_obj> ,sStaticFields,sMemberFields,
