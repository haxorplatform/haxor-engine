...
{
HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","new",0x2a1bb8f3,"haxor.graphics.mesh.MeshLayout.new","haxor/graphics/mesh/MeshLayout.hx",79,0x92e5291c)
HX_STACK_THIS(this)
...
Dynamic MeshLayout_obj::get_vertex( ){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","get_vertex",0xce4beafa,"haxor.graphics.mesh.MeshLayout.get_vertex","haxor/graphics/mesh/MeshLayout.hx",25,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(25)
...
Dynamic MeshLayout_obj::set_vertex( Dynamic v){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","set_vertex",0xd1c9896e,"haxor.graphics.mesh.MeshLayout.set_vertex","haxor/graphics/mesh/MeshLayout.hx",26,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(26)
...
Dynamic MeshLayout_obj::get_normal( ){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","get_normal",0x5d6d81bd,"haxor.graphics.mesh.MeshLayout.get_normal","haxor/graphics/mesh/MeshLayout.hx",33,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)
...
Dynamic MeshLayout_obj::set_normal( Dynamic v){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","set_normal",0x60eb2031,"haxor.graphics.mesh.MeshLayout.set_normal","haxor/graphics/mesh/MeshLayout.hx",34,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(34)
...
Array< ::Dynamic > MeshLayout_obj::get_color( ){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","get_color",0x1b7ee68d,"haxor.graphics.mesh.MeshLayout.get_color","haxor/graphics/mesh/MeshLayout.hx",42,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(42)
	return this->m_color;
}
...
Array< ::Dynamic > MeshLayout_obj::set_color( Array< ::Dynamic > v){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","set_color",0xfecfd299,"haxor.graphics.mesh.MeshLayout.set_color","haxor/graphics/mesh/MeshLayout.hx",43,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(43)
...
Dynamic MeshLayout_obj::get_uv0( ){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","get_uv0",0xda912559,"haxor.graphics.mesh.MeshLayout.get_uv0","haxor/graphics/mesh/MeshLayout.hx",50,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(50)
	return this->m_uv0;
}
...
Dynamic MeshLayout_obj::set_uv0( Dynamic v){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","set_uv0",0xcd92b665,"haxor.graphics.mesh.MeshLayout.set_uv0","haxor/graphics/mesh/MeshLayout.hx",51,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(51)
...
Dynamic MeshLayout_obj::get_uv1( ){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","get_uv1",0xda91255a,"haxor.graphics.mesh.MeshLayout.get_uv1","haxor/graphics/mesh/MeshLayout.hx",58,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(58)
	return this->m_uv1;
}
...
Dynamic MeshLayout_obj::set_uv1( Dynamic v){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","set_uv1",0xcd92b666,"haxor.graphics.mesh.MeshLayout.set_uv1","haxor/graphics/mesh/MeshLayout.hx",59,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(59)
...
Dynamic MeshLayout_obj::get_tangent( ){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","get_tangent",0x7157306f,"haxor.graphics.mesh.MeshLayout.get_tangent","haxor/graphics/mesh/MeshLayout.hx",66,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(66)
...
Dynamic MeshLayout_obj::set_tangent( Dynamic v){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","set_tangent",0x7bc4377b,"haxor.graphics.mesh.MeshLayout.set_tangent","haxor/graphics/mesh/MeshLayout.hx",67,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(67)
...
Dynamic MeshLayout_obj::get_binormal( ){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","get_binormal",0xa5de7844,"haxor.graphics.mesh.MeshLayout.get_binormal","haxor/graphics/mesh/MeshLayout.hx",74,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(74)
...
Dynamic MeshLayout_obj::set_binormal( Dynamic v){
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","set_binormal",0xbad79bb8,"haxor.graphics.mesh.MeshLayout.set_binormal","haxor/graphics/mesh/MeshLayout.hx",75,0x92e5291c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(75)
...
bool p_is_color = __o_p_is_color.Default(false);
	HX_STACK_FRAME("haxor.graphics.mesh.MeshLayout","UpdateAttribute",0x629341c6,"haxor.graphics.mesh.MeshLayout.UpdateAttribute","haxor/graphics/mesh/MeshLayout.hx",103,0x92e5291c)
	HX_STACK_THIS(this)
