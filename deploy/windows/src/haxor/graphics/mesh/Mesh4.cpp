...
{
HX_STACK_FRAME("haxor.graphics.mesh.Mesh4","new",0x8eabee4f,"haxor.graphics.mesh.Mesh4.new","haxor/graphics/mesh/MeshLayout.hx",164,0x92e5291c)
HX_STACK_THIS(this)
...
{  hx::ObjectPtr< Mesh4_obj > result = new Mesh4_obj();
...
Dynamic Mesh4_obj::__Field(const ::String &inName,bool inCallProp)
{
	return super::__Field(inName,inCallProp);
}

Dynamic Mesh4_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	return super::__SetField(inName,inValue,inCallProp);
}

void Mesh4_obj::__GetFields(Array< ::String> &outFields)
{
...
Class Mesh4_obj::__mClass;

void Mesh4_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxor.graphics.mesh.Mesh4"), hx::TCanCast< Mesh4_obj> ,sStaticFields,sMemberFields,
