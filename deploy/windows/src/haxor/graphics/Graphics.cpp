...
{
		HX_STACK_FRAME("haxor.graphics.Graphics","Viewport",0x9c269ab2,"haxor.graphics.Graphics.Viewport","haxor/graphics/Graphics.hx",30,0x1a55985c)
			...
			HX_STACK_LINE(41)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::haxor::math::AABB2 &vp){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/graphics/Graphics.hx",41,0x1a55985c)
						{
							HX_STACK_LINE(41)
...
{
		HX_STACK_FRAME("haxor.graphics.Graphics","Clear",0x675b7bc1,"haxor.graphics.Graphics.Clear","haxor/graphics/Graphics.hx",51,0x1a55985c)
...
{
		HX_STACK_FRAME("haxor.graphics.Graphics","Render",0x06324ea2,"haxor.graphics.Graphics.Render","haxor/graphics/Graphics.hx",83,0x1a55985c)
...
Float p_height = __o_p_height.Default(256);
	HX_STACK_FRAME("haxor.graphics.Graphics","DrawTexture",0x9028b66b,"haxor.graphics.Graphics.DrawTexture","haxor/graphics/Graphics.hx",99,0x1a55985c)
		...
		if (((p_color == null()))){
			struct _Function_2_1{
				inline static ::haxor::math::Color Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/graphics/Graphics.hx",105,0x1a55985c)
					{
						HX_STACK_LINE(105)
