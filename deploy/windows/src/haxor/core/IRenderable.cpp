...
HX_DEFINE_DYNAMIC_FUNC0(IRenderable_obj,OnRender,)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("haxor.core.IRenderable"), hx::TCanCast< IRenderable_obj> ,0,sMemberFields,
	0, 0,
