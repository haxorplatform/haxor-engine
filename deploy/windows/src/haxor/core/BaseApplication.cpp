...
bool BaseApplication_obj::get_runOnBackground( ){
	HX_STACK_FRAME("haxor.core.BaseApplication","get_runOnBackground",0xbdf4b2bd,"haxor.core.BaseApplication.get_runOnBackground","haxor/core/BaseApplication.hx",152,0x69cdc962)
	HX_STACK_THIS(this)
	HX_STACK_LINE(152)
...
bool BaseApplication_obj::set_runOnBackground( bool v){
	HX_STACK_FRAME("haxor.core.BaseApplication","set_runOnBackground",0xfa91a5c9,"haxor.core.BaseApplication.set_runOnBackground","haxor/core/BaseApplication.hx",153,0x69cdc962)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(153)
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnBuild",0x9c1cda3d,"haxor.core.BaseApplication.OnBuild","haxor/core/BaseApplication.hx",170,0x69cdc962)
		HX_STACK_THIS(this)
		HX_STACK_LINE(171)
		this->super::OnBuild();
		HX_STACK_LINE(172)
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","LoadScene",0xcd598d74,"haxor.core.BaseApplication.LoadScene","haxor/core/BaseApplication.hx",189,0x69cdc962)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","DestroyScene",0xc01a3a84,"haxor.core.BaseApplication.DestroyScene","haxor/core/BaseApplication.hx",198,0x69cdc962)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_name,"p_name")
	}
return null();
...
bool BaseApplication_obj::Load( ){
	HX_STACK_FRAME("haxor.core.BaseApplication","Load",0xae5c20b8,"haxor.core.BaseApplication.Load","haxor/core/BaseApplication.hx",206,0x69cdc962)
	HX_STACK_THIS(this)
	HX_STACK_LINE(206)
	return true;
}
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","Initialize",0xd9c5f162,"haxor.core.BaseApplication.Initialize","haxor/core/BaseApplication.hx",214,0x69cdc962)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","LoadComplete",0x8e795591,"haxor.core.BaseApplication.LoadComplete","haxor/core/BaseApplication.hx",222,0x69cdc962)
		HX_STACK_THIS(this)
		HX_STACK_LINE(222)
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnLoadProgress",0xf02474c4,"haxor.core.BaseApplication.OnLoadProgress","haxor/core/BaseApplication.hx",230,0x69cdc962)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnLoadComplete",0xe9c17dd0,"haxor.core.BaseApplication.OnLoadComplete","haxor/core/BaseApplication.hx",237,0x69cdc962)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_id,"p_id")
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","Update",0x44c6551b,"haxor.core.BaseApplication.Update","haxor/core/BaseApplication.hx",243,0x69cdc962)
		HX_STACK_THIS(this)
		HX_STACK_LINE(244)
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","Render",0xc2ea3a68,"haxor.core.BaseApplication.Render","haxor/core/BaseApplication.hx",256,0x69cdc962)
		HX_STACK_THIS(this)
		HX_STACK_LINE(257)
		...
		HX_STACK_LINE(264)
		hx::AddEq(this->m_frame_ms,::haxor::core::Time_obj::m_delta);
		HX_STACK_LINE(266)
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnQuit",0xab5517a0,"haxor.core.BaseApplication.OnQuit","haxor/core/BaseApplication.hx",288,0x69cdc962)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnFocus",0xe5bb5ee7,"haxor.core.BaseApplication.OnFocus","haxor/core/BaseApplication.hx",293,0x69cdc962)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnUnfocus",0x121577ae,"haxor.core.BaseApplication.OnUnfocus","haxor/core/BaseApplication.hx",298,0x69cdc962)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","CheckResize",0x66ea7c8a,"haxor.core.BaseApplication.CheckResize","haxor/core/BaseApplication.hx",304,0x69cdc962)
		HX_STACK_THIS(this)
		HX_STACK_LINE(305)
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnResize",0x33088805,"haxor.core.BaseApplication.OnResize","haxor/core/BaseApplication.hx",318,0x69cdc962)
		HX_STACK_THIS(this)
		HX_STACK_LINE(319)
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnFullscreenEnter",0x69cab4ac,"haxor.core.BaseApplication.OnFullscreenEnter","haxor/core/BaseApplication.hx",329,0x69cdc962)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnFullscreenExit",0xaa67be0a,"haxor.core.BaseApplication.OnFullscreenExit","haxor/core/BaseApplication.hx",334,0x69cdc962)
		HX_STACK_THIS(this)
	}
return null();
}
...
bool BaseApplication_obj::OnFullscreenRequest( bool v){
	HX_STACK_FRAME("haxor.core.BaseApplication","OnFullscreenRequest",0x4d1933e3,"haxor.core.BaseApplication.OnFullscreenRequest","haxor/core/BaseApplication.hx",340,0x69cdc962)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(340)
	return false;
...
bool BaseApplication_obj::OnPointerLockRequest( bool v){
	HX_STACK_FRAME("haxor.core.BaseApplication","OnPointerLockRequest",0x3f05d878,"haxor.core.BaseApplication.OnPointerLockRequest","haxor/core/BaseApplication.hx",346,0x69cdc962)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(346)
	return false;
...
bool BaseApplication_obj::OnPointerVisibilityRequest( bool v){
	HX_STACK_FRAME("haxor.core.BaseApplication","OnPointerVisibilityRequest",0x706bf871,"haxor.core.BaseApplication.OnPointerVisibilityRequest","haxor/core/BaseApplication.hx",352,0x69cdc962)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(352)
	return false;
...
{
		HX_STACK_FRAME("haxor.core.BaseApplication","OnMousePosition",0x27e9c5fd,"haxor.core.BaseApplication.OnMousePosition","haxor/core/BaseApplication.hx",359,0x69cdc962)
		HX_STACK_THIS(this)
...
Float BaseApplication_obj::GetContainerWidth( ){
	HX_STACK_FRAME("haxor.core.BaseApplication","GetContainerWidth",0xf173fa69,"haxor.core.BaseApplication.GetContainerWidth","haxor/core/BaseApplication.hx",365,0x69cdc962)
	HX_STACK_THIS(this)
	HX_STACK_LINE(365)
	return 0.0;
}
...
Float BaseApplication_obj::GetContainerHeight( ){
	HX_STACK_FRAME("haxor.core.BaseApplication","GetContainerHeight",0x0a569a24,"haxor.core.BaseApplication.GetContainerHeight","haxor/core/BaseApplication.hx",371,0x69cdc962)
	HX_STACK_THIS(this)
	HX_STACK_LINE(371)
	return 0.0;
}
...
Dynamic BaseApplication_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"runOnBackground") ) { return get_runOnBackground(); }
...
Dynamic BaseApplication_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"runOnBackground") ) { return set_runOnBackground(inValue); }
		break;
	case 19:
...
void BaseApplication_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_CSTRING("runOnBackground"));
	outFields->push(HX_CSTRING("m_run_on_background"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(BaseApplication_obj,m_run_on_background),HX_CSTRING("m_run_on_background")},
...
static ::String sMemberFields[] = {
	...
	HX_CSTRING("get_runOnBackground"),
	HX_CSTRING("set_runOnBackground"),
	HX_CSTRING("m_run_on_background"),
	HX_CSTRING("m_scenes"),
