...
int p_level = __o_p_level.Default(0);
	HX_STACK_FRAME("haxor.core.Console","Log",0x0d81f5ca,"haxor.core.Console.Log","haxor/core/Console.hx",77,0xc2f3b4ca)
...
{
		HX_STACK_FRAME("haxor.core.Console","LogImage",0xe2f35d31,"haxor.core.Console.LogImage","haxor/core/Console.hx",105,0xc2f3b4ca)
...
{
		HX_STACK_FRAME("haxor.core.Console","LogWarning",0x54c1b9b2,"haxor.core.Console.LogWarning","haxor/core/Console.hx",131,0xc2f3b4ca)
		HX_STACK_ARG(p_msg,"p_msg")
...
{
		HX_STACK_FRAME("haxor.core.Console","LogError",0x98b4099e,"haxor.core.Console.LogError","haxor/core/Console.hx",153,0xc2f3b4ca)
		HX_STACK_ARG(p_msg,"p_msg")
		HX_STACK_ARG(p_obj,"p_obj")
		HX_STACK_LINE(153)
...
{
		HX_STACK_FRAME("haxor.core.Console","ClearStyle",0x3d6997de,"haxor.core.Console.ClearStyle","haxor/core/Console.hx",162,0xc2f3b4ca)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxor.core.Console","Clear",0xb9aa7053,"haxor.core.Console.Clear","haxor/core/Console.hx",172,0xc2f3b4ca)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxor.core.Console","TimeStart",0x31f922db,"haxor.core.Console.TimeStart","haxor/core/Console.hx",189,0xc2f3b4ca)
...
{
		HX_STACK_FRAME("haxor.core.Console","TimeEnd",0x7af7f214,"haxor.core.Console.TimeEnd","haxor/core/Console.hx",204,0xc2f3b4ca)
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(208)
		if ((!(::haxor::core::Console_obj::m_benchmarks->exists(p_id)))){
			HX_STACK_LINE(208)
...
{
		HX_STACK_FRAME("haxor.core.Console","StackTrace",0x0d7fe597,"haxor.core.Console.StackTrace","haxor/core/Console.hx",219,0xc2f3b4ca)
	}
return null();
}
...
::String p_font = __o_p_font.Default(HX_CSTRING("'Lucida Console', Monaco, monospace"));
	HX_STACK_FRAME("haxor.core.Console","SetStyle",0xccd60f29,"haxor.core.Console.SetStyle","haxor/core/Console.hx",237,0xc2f3b4ca)
