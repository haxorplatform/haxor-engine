...
{
HX_STACK_FRAME("haxor.core.Entity","new",0x37b4da38,"haxor.core.Entity.new","haxor/core/Entity.hx",71,0x47bf6bd8)
HX_STACK_THIS(this)
...
bool Entity_obj::get_enabled( ){
	HX_STACK_FRAME("haxor.core.Entity","get_enabled",0x7cee0670,"haxor.core.Entity.get_enabled","haxor/core/Entity.hx",19,0x47bf6bd8)
	HX_STACK_THIS(this)
	HX_STACK_LINE(19)
...
bool Entity_obj::set_enabled( bool v){
	HX_STACK_FRAME("haxor.core.Entity","set_enabled",0x875b0d7c,"haxor.core.Entity.set_enabled","haxor/core/Entity.hx",21,0x47bf6bd8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(22)
	if ((this->m_destroyed)){
...
::haxor::component::Transform Entity_obj::get_transform( ){
	HX_STACK_FRAME("haxor.core.Entity","get_transform",0x2f07c91b,"haxor.core.Entity.get_transform","haxor/core/Entity.hx",42,0x47bf6bd8)
	HX_STACK_THIS(this)
	HX_STACK_LINE(42)
...
int Entity_obj::get_layer( ){
	HX_STACK_FRAME("haxor.core.Entity","get_layer",0x80d3da00,"haxor.core.Entity.get_layer","haxor/core/Entity.hx",49,0x47bf6bd8)
	HX_STACK_THIS(this)
	HX_STACK_LINE(49)
	return this->m_layer;
}
...
int Entity_obj::set_layer( int v){
	HX_STACK_FRAME("haxor.core.Entity","set_layer",0x6424c60c,"haxor.core.Entity.set_layer","haxor/core/Entity.hx",51,0x47bf6bd8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(52)
	if (((v <= (int)0))){
...
Dynamic Entity_obj::AddComponent( ::Class p_type){
	HX_STACK_FRAME("haxor.core.Entity","AddComponent",0x084559a4,"haxor.core.Entity.AddComponent","haxor/core/Entity.hx",87,0x47bf6bd8)
	HX_STACK_THIS(this)
...
Dynamic Entity_obj::GetComponent( ::Class p_type){
	HX_STACK_FRAME("haxor.core.Entity","GetComponent",0x1847d48f,"haxor.core.Entity.GetComponent","haxor/core/Entity.hx",111,0x47bf6bd8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_type,"p_type")
	HX_STACK_LINE(112)
	{
...
Dynamic Entity_obj::GetComponents( ::Class p_type){
	HX_STACK_FRAME("haxor.core.Entity","GetComponents",0x26922904,"haxor.core.Entity.GetComponents","haxor/core/Entity.hx",122,0x47bf6bd8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_type,"p_type")
	HX_STACK_LINE(123)
...
Dynamic Entity_obj::GetComponentInChildren( ::Class p_type){
	HX_STACK_FRAME("haxor.core.Entity","GetComponentInChildren",0xc729dfb3,"haxor.core.Entity.GetComponentInChildren","haxor/core/Entity.hx",133,0x47bf6bd8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_type,"p_type")
	HX_STACK_LINE(133)
	...
	bool run(::haxor::component::Transform t,int d){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","haxor/core/Entity.hx",138,0x47bf6bd8)
		HX_STACK_ARG(t,"t")
		HX_STACK_ARG(d,"d")
		{
			HX_STACK_LINE(139)
...
Dynamic Entity_obj::GetComponentsInChildren( ::Class p_type){
	HX_STACK_FRAME("haxor.core.Entity","GetComponentsInChildren",0x36cc3868,"haxor.core.Entity.GetComponentsInChildren","haxor/core/Entity.hx",152,0x47bf6bd8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_type,"p_type")
	HX_STACK_LINE(152)
	Array< ::Dynamic > p_type1 = Array_obj< ::Dynamic >::__new().Add(p_type);		HX_STACK_VAR(p_type1,"p_type1");
	...
	bool run(::haxor::component::Transform t,int d){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","haxor/core/Entity.hx",156,0x47bf6bd8)
		HX_STACK_ARG(t,"t")
		HX_STACK_ARG(d,"d")
		{
			HX_STACK_LINE(157)
...
{
		HX_STACK_FRAME("haxor.core.Entity","OnDestroy",0x6b6dc153,"haxor.core.Entity.OnDestroy","haxor/core/Entity.hx",168,0x47bf6bd8)
		HX_STACK_THIS(this)
		HX_STACK_LINE(169)
		{
			HX_STACK_LINE(169)
