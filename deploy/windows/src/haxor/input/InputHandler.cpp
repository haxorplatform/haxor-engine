...
{
		HX_STACK_FRAME("haxor.input.InputHandler","OnMouseWheel",0xa1f38af3,"haxor.input.InputHandler.OnMouseWheel","haxor/input/InputHandler.hx",86,0x17daf1ac)
		HX_STACK_THIS(this)
...
Float p_angle = __o_p_angle.Default(0.0);
	HX_STACK_FRAME("haxor.input.InputHandler","OnTouchStart",0x3808bae0,"haxor.input.InputHandler.OnTouchStart","haxor/input/InputHandler.hx",121,0x17daf1ac)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.input.InputHandler","OnTouchMove",0x53847653,"haxor.input.InputHandler.OnTouchMove","haxor/input/InputHandler.hx",146,0x17daf1ac)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
...
{
		HX_STACK_FRAME("haxor.input.InputHandler","OnTouchCancel",0x81d4553c,"haxor.input.InputHandler.OnTouchCancel","haxor/input/InputHandler.hx",164,0x17daf1ac)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(165)
		::haxor::input::Touch t = ::haxor::input::Input_obj::m_api_touches->__get(p_id).StaticCast< ::haxor::input::Touch >();		HX_STACK_VAR(t,"t");
...
{
		HX_STACK_FRAME("haxor.input.InputHandler","OnTouchEnd",0x56730ed9,"haxor.input.InputHandler.OnTouchEnd","haxor/input/InputHandler.hx",174,0x17daf1ac)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(176)
		::haxor::input::Touch t = ::haxor::input::Input_obj::m_api_touches->__get(p_id).StaticCast< ::haxor::input::Touch >();		HX_STACK_VAR(t,"t");
...
{
		HX_STACK_FRAME("haxor.input.InputHandler","OnJoystickStart",0x827d0b69,"haxor.input.InputHandler.OnJoystickStart","haxor/input/InputHandler.hx",186,0x17daf1ac)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_id,"p_id")
...
{
		HX_STACK_FRAME("haxor.input.InputHandler","OnJoystickDataUpdate",0x2a91db6c,"haxor.input.InputHandler.OnJoystickDataUpdate","haxor/input/InputHandler.hx",205,0x17daf1ac)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_code,"p_code")
...
{
		HX_STACK_FRAME("haxor.input.InputHandler","OnJoystickAnalogUpdate",0xda26fc32,"haxor.input.InputHandler.OnJoystickAnalogUpdate","haxor/input/InputHandler.hx",224,0x17daf1ac)
		HX_STACK_THIS(this)
		HX_STACK_LINE(225)
		if (((this->m_joystick == null()))){
			HX_STACK_LINE(225)
		...
		HX_STACK_LINE(233)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ::haxor::math::Vector3 &v){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/input/InputHandler.hx",233,0x17daf1ac)
					{
						HX_STACK_LINE(233)
		...
		HX_STACK_LINE(239)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ::haxor::math::Vector3 &v){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/input/InputHandler.hx",239,0x17daf1ac)
					{
						HX_STACK_LINE(239)
						Float p_a = v->x;		HX_STACK_VAR(p_a,"p_a");
						HX_STACK_LINE(239)
...
{
		HX_STACK_FRAME("haxor.input.InputHandler","RequestJoystickVibration",0x9aa08525,"haxor.input.InputHandler.RequestJoystickVibration","haxor/input/InputHandler.hx",252,0x17daf1ac)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.input.InputHandler","EmulateTouch",0x1e86c6ca,"haxor.input.InputHandler.EmulateTouch","haxor/input/InputHandler.hx",261,0x17daf1ac)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_code,"p_code")
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(263)
