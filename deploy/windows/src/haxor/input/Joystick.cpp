...
Float Joystick_obj::set_vibrationLeft( Float v){
	...
	struct _Function_1_1{
		inline static Float Block( hx::ObjectPtr< ::haxor::input::Joystick_obj > __this,Float &v){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/input/Joystick.hx",84,0x86e4ec50)
			{
				HX_STACK_LINE(84)
...
Float Joystick_obj::set_vibrationRight( Float v){
	...
	struct _Function_1_1{
		inline static Float Block( hx::ObjectPtr< ::haxor::input::Joystick_obj > __this,Float &v){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/input/Joystick.hx",92,0x86e4ec50)
			{
				HX_STACK_LINE(92)
