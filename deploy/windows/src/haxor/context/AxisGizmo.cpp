...
{
HX_STACK_FRAME("haxor.context.AxisGizmo","new",0x2c9d8080,"haxor.context.AxisGizmo.new","haxor/context/GizmoContext.hx",552,0xa99c50bc)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(552)
...
{
		HX_STACK_FRAME("haxor.context.AxisGizmo","OnBuild",0x962de18f,"haxor.context.AxisGizmo.OnBuild","haxor/context/GizmoContext.hx",558,0xa99c50bc)
		HX_STACK_THIS(this)
		HX_STACK_LINE(559)
