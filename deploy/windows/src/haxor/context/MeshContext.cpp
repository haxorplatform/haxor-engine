...
{
		HX_STACK_FRAME("haxor.context.MeshContext","Initialize",0xf4678a47,"haxor.context.MeshContext.Initialize","haxor/context/MeshContext.hx",88,0xf23de969)
		HX_STACK_THIS(this)
		HX_STACK_LINE(88)
...
{
		HX_STACK_FRAME("haxor.context.MeshContext","Bind",0xc775ab74,"haxor.context.MeshContext.Bind","haxor/context/MeshContext.hx",97,0xf23de969)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.context.MeshContext","ActivateAttributes",0x6a542e61,"haxor.context.MeshContext.ActivateAttributes","haxor/context/MeshContext.hx",117,0xf23de969)
		HX_STACK_THIS(this)
		HX_STACK_LINE(118)
...
{
		HX_STACK_FRAME("haxor.context.MeshContext","Unbind",0x42acce0d,"haxor.context.MeshContext.Unbind","haxor/context/MeshContext.hx",166,0xf23de969)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("haxor.context.MeshContext","Draw",0xc8cee1bb,"haxor.context.MeshContext.Draw","haxor/context/MeshContext.hx",188,0xf23de969)
		HX_STACK_THIS(this)
		HX_STACK_ARG(m,"m")
		HX_STACK_LINE(188)
		if ((m->m_indexed)){
...
{
		HX_STACK_FRAME("haxor.context.MeshContext","RemoveAttrib",0xdd784765,"haxor.context.MeshContext.RemoveAttrib","haxor/context/MeshContext.hx",224,0xf23de969)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.context.MeshContext","UpdateAttrib",0x6e0e52ea,"haxor.context.MeshContext.UpdateAttrib","haxor/context/MeshContext.hx",237,0xf23de969)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
...
void MeshContext_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_CSTRING("m_auto_white"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(MeshContext_obj,m_auto_white),HX_CSTRING("m_auto_white")},
	{ hx::fsUnknown, 0, null()}
};
#endif
