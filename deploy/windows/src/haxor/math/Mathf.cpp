...
bool Mathf_obj::IsPOT( int p_v){
	HX_STACK_FRAME("haxor.math.Mathf","IsPOT",0xd55d00c1,"haxor.math.Mathf.IsPOT","haxor/math/Mathf.hx",33,0x3182889a)
...
int Mathf_obj::NextPOT( int p_v){
	HX_STACK_FRAME("haxor.math.Mathf","NextPOT",0xfe950cd8,"haxor.math.Mathf.NextPOT","haxor/math/Mathf.hx",35,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
	HX_STACK_LINE(36)
	--(p_v);
	HX_STACK_LINE(37)
...
Float Mathf_obj::Sign( Float p_a){
	HX_STACK_FRAME("haxor.math.Mathf","Sign",0x27ae4c07,"haxor.math.Mathf.Sign","haxor/math/Mathf.hx",43,0x3182889a)
...
int Mathf_obj::SignInt( int p_a){
	HX_STACK_FRAME("haxor.math.Mathf","SignInt",0x9a217728,"haxor.math.Mathf.SignInt","haxor/math/Mathf.hx",44,0x3182889a)
	HX_STACK_ARG(p_a,"p_a")
	HX_STACK_LINE(44)
	if (((p_a < (int)0))){
		HX_STACK_LINE(44)
...
Float Mathf_obj::Abs( Float p_a){
	HX_STACK_FRAME("haxor.math.Mathf","Abs",0xcb513be8,"haxor.math.Mathf.Abs","haxor/math/Mathf.hx",45,0x3182889a)
	HX_STACK_ARG(p_a,"p_a")
	HX_STACK_LINE(45)
	if (((p_a < (int)0))){
		HX_STACK_LINE(45)
...
int Mathf_obj::AbsInt( int p_a){
	HX_STACK_FRAME("haxor.math.Mathf","AbsInt",0xf676e9e7,"haxor.math.Mathf.AbsInt","haxor/math/Mathf.hx",46,0x3182889a)
	HX_STACK_ARG(p_a,"p_a")
	HX_STACK_LINE(46)
	if (((p_a < (int)0))){
		HX_STACK_LINE(46)
...
Float Mathf_obj::Clamp( Float p_v,Float p_min,Float p_max){
	HX_STACK_FRAME("haxor.math.Mathf","Clamp",0x5c6207f1,"haxor.math.Mathf.Clamp","haxor/math/Mathf.hx",47,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
...
Float Mathf_obj::Clamp01( Float p_v){
	HX_STACK_FRAME("haxor.math.Mathf","Clamp01",0xbee8d032,"haxor.math.Mathf.Clamp01","haxor/math/Mathf.hx",48,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
	HX_STACK_LINE(48)
	if (((p_v <= 0.0))){
		HX_STACK_LINE(48)
...
int Mathf_obj::ClampInt( int p_v,int p_min,int p_max){
	HX_STACK_FRAME("haxor.math.Mathf","ClampInt",0x4ce0897e,"haxor.math.Mathf.ClampInt","haxor/math/Mathf.hx",49,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
	HX_STACK_ARG(p_min,"p_min")
	HX_STACK_ARG(p_max,"p_max")
	HX_STACK_LINE(49)
...
Float Mathf_obj::Min( Float a,Float b){
	HX_STACK_FRAME("haxor.math.Mathf","Min",0xcb5a5d08,"haxor.math.Mathf.Min","haxor/math/Mathf.hx",50,0x3182889a)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(50)
...
Float Mathf_obj::Max( Float a,Float b){
	HX_STACK_FRAME("haxor.math.Mathf","Max",0xcb5a561a,"haxor.math.Mathf.Max","haxor/math/Mathf.hx",51,0x3182889a)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(51)
...
int Mathf_obj::MinInt( int a,int b){
	HX_STACK_FRAME("haxor.math.Mathf","MinInt",0xc73f3cc7,"haxor.math.Mathf.MinInt","haxor/math/Mathf.hx",52,0x3182889a)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(52)
	return ::Math_obj::min(a,b);
...
int Mathf_obj::MaxInt( int a,int b){
	HX_STACK_FRAME("haxor.math.Mathf","MaxInt",0x32a6baf5,"haxor.math.Mathf.MaxInt","haxor/math/Mathf.hx",53,0x3182889a)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(53)
	return ::Math_obj::max(a,b);
...
Float Mathf_obj::Sin( Float v){
	HX_STACK_FRAME("haxor.math.Mathf","Sin",0xcb5eea8e,"haxor.math.Mathf.Sin","haxor/math/Mathf.hx",54,0x3182889a)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(54)
...
Float Mathf_obj::Cos( Float v){
	HX_STACK_FRAME("haxor.math.Mathf","Cos",0xcb52cbbd,"haxor.math.Mathf.Cos","haxor/math/Mathf.hx",55,0x3182889a)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(55)
...
Float Mathf_obj::ASin( Float v){
	HX_STACK_FRAME("haxor.math.Mathf","ASin",0x1bb7c501,"haxor.math.Mathf.ASin","haxor/math/Mathf.hx",56,0x3182889a)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(56)
...
Float Mathf_obj::ACos( Float v){
	HX_STACK_FRAME("haxor.math.Mathf","ACos",0x1baba630,"haxor.math.Mathf.ACos","haxor/math/Mathf.hx",57,0x3182889a)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(57)
...
Float Mathf_obj::Tan( Float v){
	HX_STACK_FRAME("haxor.math.Mathf","Tan",0xcb5fa5d7,"haxor.math.Mathf.Tan","haxor/math/Mathf.hx",58,0x3182889a)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(58)
...
Float Mathf_obj::ATan( Float v){
	HX_STACK_FRAME("haxor.math.Mathf","ATan",0x1bb8804a,"haxor.math.Mathf.ATan","haxor/math/Mathf.hx",59,0x3182889a)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(59)
...
Float Mathf_obj::ATan2( Float y,Float x){
	HX_STACK_FRAME("haxor.math.Mathf","ATan2",0x25b7c0a8,"haxor.math.Mathf.ATan2","haxor/math/Mathf.hx",60,0x3182889a)
	HX_STACK_ARG(y,"y")
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(60)
...
Float Mathf_obj::Sqrt( Float v){
	HX_STACK_FRAME("haxor.math.Mathf","Sqrt",0x27b467aa,"haxor.math.Mathf.Sqrt","haxor/math/Mathf.hx",61,0x3182889a)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(61)
...
Float Mathf_obj::Pow( Float b,Float exp){
	HX_STACK_FRAME("haxor.math.Mathf","Pow",0xcb5ca90e,"haxor.math.Mathf.Pow","haxor/math/Mathf.hx",62,0x3182889a)
	HX_STACK_ARG(b,"b")
...
Float Mathf_obj::Floor( Float p_v){
	HX_STACK_FRAME("haxor.math.Mathf","Floor",0x16a066c2,"haxor.math.Mathf.Floor","haxor/math/Mathf.hx",64,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
	HX_STACK_LINE(64)
...
Float Mathf_obj::Ceil( Float p_v){
	HX_STACK_FRAME("haxor.math.Mathf","Ceil",0x1d17dacf,"haxor.math.Mathf.Ceil","haxor/math/Mathf.hx",65,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
	HX_STACK_LINE(65)
...
Float Mathf_obj::Round( Float p_v){
	HX_STACK_FRAME("haxor.math.Mathf","Round",0x016f8d44,"haxor.math.Mathf.Round","haxor/math/Mathf.hx",66,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
	HX_STACK_LINE(66)
...
int p_decimal_places = __o_p_decimal_places.Default(2);
	HX_STACK_FRAME("haxor.math.Mathf","RoundPlaces",0x09078630,"haxor.math.Mathf.RoundPlaces","haxor/math/Mathf.hx",68,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
...
Float Mathf_obj::Lerp( Float p_a,Float p_b,Float p_ratio){
	HX_STACK_FRAME("haxor.math.Mathf","Lerp",0x230ace41,"haxor.math.Mathf.Lerp","haxor/math/Mathf.hx",73,0x3182889a)
	HX_STACK_ARG(p_a,"p_a")
...
int Mathf_obj::LerpInt( int p_a,int p_b,Float p_ratio){
	HX_STACK_FRAME("haxor.math.Mathf","LerpInt",0x3458952e,"haxor.math.Mathf.LerpInt","haxor/math/Mathf.hx",74,0x3182889a)
	HX_STACK_ARG(p_a,"p_a")
	HX_STACK_ARG(p_b,"p_b")
	HX_STACK_ARG(p_ratio,"p_ratio")
	struct _Function_1_1{
		inline static Float Block( int &p_a,int &p_b,Float &p_ratio){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/math/Mathf.hx",74,0x3182889a)
			{
				HX_STACK_LINE(74)
...
Float Mathf_obj::Frac( Float p_v){
	HX_STACK_FRAME("haxor.math.Mathf","Frac",0x1f1d54f8,"haxor.math.Mathf.Frac","haxor/math/Mathf.hx",76,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
	HX_STACK_LINE(76)
...
Float Mathf_obj::Loop( Float p_v,Float p_v0,Float p_v1){
	HX_STACK_FRAME("haxor.math.Mathf","Loop",0x2312622e,"haxor.math.Mathf.Loop","haxor/math/Mathf.hx",79,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
...
Float Mathf_obj::Linear2Gamma( Float p_v){
	HX_STACK_FRAME("haxor.math.Mathf","Linear2Gamma",0x512ce304,"haxor.math.Mathf.Linear2Gamma","haxor/math/Mathf.hx",89,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
	HX_STACK_LINE(89)
...
Float Mathf_obj::Oscilate( Float p_v,Float p_v0,Float p_v1){
	HX_STACK_FRAME("haxor.math.Mathf","Oscilate",0x9adde9ba,"haxor.math.Mathf.Oscilate","haxor/math/Mathf.hx",92,0x3182889a)
	HX_STACK_ARG(p_v,"p_v")
	HX_STACK_ARG(p_v0,"p_v0")
	HX_STACK_ARG(p_v1,"p_v1")
	struct _Function_1_1{
		inline static Float Block( Float &p_v){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/math/Mathf.hx",94,0x3182889a)
			{
				HX_STACK_LINE(94)
...
Float Mathf_obj::WrapAngle( Float p_angle){
	HX_STACK_FRAME("haxor.math.Mathf","WrapAngle",0x054f059f,"haxor.math.Mathf.WrapAngle","haxor/math/Mathf.hx",99,0x3182889a)
