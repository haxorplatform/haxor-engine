...
{
HX_STACK_FRAME("haxor.io.file.ColladaNode","new",0xa111d4d0,"haxor.io.file.ColladaNode.new","haxor/io/file/ColladaFile.hx",1404,0xa1888587)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(1446)
	this->instances = null();
...
::haxor::math::Matrix4 ColladaNode_obj::get_world( ){
	HX_STACK_FRAME("haxor.io.file.ColladaNode","get_world",0x5c8aeb19,"haxor.io.file.ColladaNode.get_world","haxor/io/file/ColladaFile.hx",1423,0xa1888587)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1424)
...
{
		HX_STACK_FRAME("haxor.io.file.ColladaNode","GenerateTranform",0x74c172b4,"haxor.io.file.ColladaNode.GenerateTranform","haxor/io/file/ColladaFile.hx",1459,0xa1888587)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1460)
		...
		struct _Function_1_1{
			inline static ::haxor::math::Matrix4 Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/io/file/ColladaFile.hx",1462,0xa1888587)
				{
					HX_STACK_LINE(1462)
		...
		HX_STACK_LINE(1463)
		{
			...
			{
				HX_STACK_LINE(1463)
				::haxor::math::Matrix4 _this1 = ::haxor::math::Matrix4_obj::GetScale(mtx,null());		HX_STACK_VAR(_this1,"_this1");
				HX_STACK_LINE(1463)
