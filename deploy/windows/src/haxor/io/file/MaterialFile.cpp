...
{
HX_STACK_FRAME("haxor.io.file.MaterialFile","new",0xac40b0ab,"haxor.io.file.MaterialFile.new","haxor/io/file/MaterialFile.hx",105,0x5b3fbce4)
HX_STACK_THIS(this)
...
Dynamic MaterialFile_obj::get_asset( ){
	HX_STACK_FRAME("haxor.io.file.MaterialFile","get_asset",0xc58170d2,"haxor.io.file.MaterialFile.get_asset","haxor/io/file/MaterialFile.hx",126,0x5b3fbce4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(127)
...
{
		HX_STACK_FRAME("haxor.io.file.MaterialFile","Parse",0x79a0c91e,"haxor.io.file.MaterialFile.Parse","haxor/io/file/MaterialFile.hx",190,0x5b3fbce4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(n,"n")
		HX_STACK_LINE(190)
...
{
		HX_STACK_FRAME("haxor.io.file.MaterialFile","ParseUniforms",0x39629ffd,"haxor.io.file.MaterialFile.ParseUniforms","haxor/io/file/MaterialFile.hx",221,0x5b3fbce4)
		HX_STACK_THIS(this)
		HX_STACK_ARG(n,"n")
		HX_STACK_LINE(222)
...
int MaterialFile_obj::BlendModeNameToEnum( ::String b){
	HX_STACK_FRAME("haxor.io.file.MaterialFile","BlendModeNameToEnum",0xc2f0fe66,"haxor.io.file.MaterialFile.BlendModeNameToEnum","haxor/io/file/MaterialFile.hx",236,0x5b3fbce4)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(237)
	::String _switch_6 = (b);
