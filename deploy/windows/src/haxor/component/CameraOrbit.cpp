...
{
HX_STACK_FRAME("haxor.component.CameraOrbit","new",0xc5a52f1a,"haxor.component.CameraOrbit.new","haxor/component/CameraOrbit.hx",20,0xdbbd8c58)
HX_STACK_THIS(this)
...
::haxor::component::Transform CameraOrbit_obj::get_pivot( ){
	HX_STACK_FRAME("haxor.component.CameraOrbit","get_pivot",0x368fcd53,"haxor.component.CameraOrbit.get_pivot","haxor/component/CameraOrbit.hx",37,0xdbbd8c58)
	HX_STACK_THIS(this)
	HX_STACK_LINE(38)
...
{
		HX_STACK_FRAME("haxor.component.CameraOrbit","OnBuild",0x2359e529,"haxor.component.CameraOrbit.OnBuild","haxor/component/CameraOrbit.hx",67,0xdbbd8c58)
		HX_STACK_THIS(this)
		HX_STACK_LINE(68)
		this->super::OnBuild();
		HX_STACK_LINE(69)
...
{
		HX_STACK_FRAME("haxor.component.CameraOrbit","OnStart",0xec7a7e5d,"haxor.component.CameraOrbit.OnStart","haxor/component/CameraOrbit.hx",75,0xdbbd8c58)
		HX_STACK_THIS(this)
		HX_STACK_LINE(76)
...
{
		HX_STACK_FRAME("haxor.component.CameraOrbit","OnUpdate",0x7fbf37ae,"haxor.component.CameraOrbit.OnUpdate","haxor/component/CameraOrbit.hx",87,0xdbbd8c58)
		HX_STACK_THIS(this)
		HX_STACK_LINE(88)
		...
		struct _Function_1_1{
			inline static ::haxor::math::Quaternion Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/component/CameraOrbit.hx",95,0xdbbd8c58)
				{
					HX_STACK_LINE(95)
					::haxor::context::DataContext _this = ::haxor::context::EngineContext_obj::data;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(95)
...
Float p_angle_y = __o_p_angle_y.Default(0);
	HX_STACK_FRAME("haxor.component.CameraOrbit","Create",0xf0f2eca2,"haxor.component.CameraOrbit.Create","haxor/component/CameraOrbit.hx",23,0xdbbd8c58)
