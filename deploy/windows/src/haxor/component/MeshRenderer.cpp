...
{
HX_STACK_FRAME("haxor.component.MeshRenderer","new",0x52d8f6df,"haxor.component.MeshRenderer.new","haxor/component/MeshRenderer.hx",21,0x9df8586f)
HX_STACK_THIS(this)
...
::haxor::graphics::mesh::Mesh MeshRenderer_obj::get_mesh( ){
	HX_STACK_FRAME("haxor.component.MeshRenderer","get_mesh",0x8a77f297,"haxor.component.MeshRenderer.get_mesh","haxor/component/MeshRenderer.hx",32,0x9df8586f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(32)
	return this->m_mesh;
}
...
::haxor::graphics::mesh::Mesh MeshRenderer_obj::set_mesh( ::haxor::graphics::mesh::Mesh v){
	HX_STACK_FRAME("haxor.component.MeshRenderer","set_mesh",0x38d54c0b,"haxor.component.MeshRenderer.set_mesh","haxor/component/MeshRenderer.hx",33,0x9df8586f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(33)
	if (((this->m_mesh == v))){
...
{
		HX_STACK_FRAME("haxor.component.MeshRenderer","OnBuild",0xf16d736e,"haxor.component.MeshRenderer.OnBuild","haxor/component/MeshRenderer.hx",55,0x9df8586f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(56)
...
bool MeshRenderer_obj::IsVisible( ::haxor::component::Camera p_camera){
	HX_STACK_FRAME("haxor.component.MeshRenderer","IsVisible",0x9e016547,"haxor.component.MeshRenderer.IsVisible","haxor/component/MeshRenderer.hx",69,0x9df8586f)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static ::haxor::math::Vector3 Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/component/MeshRenderer.hx",73,0x9df8586f)
			{
				HX_STACK_LINE(73)
	...
	struct _Function_1_2{
		inline static ::haxor::math::Vector3 Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/component/MeshRenderer.hx",87,0x9df8586f)
			{
				HX_STACK_LINE(87)
				::haxor::context::DataContext _this = ::haxor::context::EngineContext_obj::data;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(87)
...
bool MeshRenderer_obj::CheckCulling( ){
	HX_STACK_FRAME("haxor.component.MeshRenderer","CheckCulling",0x30b87849,"haxor.component.MeshRenderer.CheckCulling","haxor/component/MeshRenderer.hx",105,0x9df8586f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(106)
...
{
		HX_STACK_FRAME("haxor.component.MeshRenderer","OnTransformUpdate",0x36a668d5,"haxor.component.MeshRenderer.OnTransformUpdate","haxor/component/MeshRenderer.hx",121,0x9df8586f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(121)
...
{
		HX_STACK_FRAME("haxor.component.MeshRenderer","UpdateWorldBounds",0x4b4a6d7d,"haxor.component.MeshRenderer.UpdateWorldBounds","haxor/component/MeshRenderer.hx",130,0x9df8586f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(130)
		if (((this->m_mesh != null()))){
			HX_STACK_LINE(133)
			...
			struct _Function_2_1{
				inline static Float Block( hx::ObjectPtr< ::haxor::component::MeshRenderer_obj > __this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","haxor/component/MeshRenderer.hx",137,0x9df8586f)
					{
						HX_STACK_LINE(137)
...
{
		HX_STACK_FRAME("haxor.component.MeshRenderer","OnRender",0x80ec0b16,"haxor.component.MeshRenderer.OnRender","haxor/component/MeshRenderer.hx",154,0x9df8586f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(155)
		this->super::OnRender();
		HX_STACK_LINE(156)
