...
{
HX_STACK_FRAME("haxor.platform.graphics.WinGL","new",0x140421df,"haxor.platform.graphics.WinGL.new","haxor/platform/graphics/WinGL.hx",41,0xd2011392)
HX_STACK_THIS(this)
...
::haxor::platform::windows::Window WinGL_obj::get_window( ){
	HX_STACK_FRAME("haxor.platform.graphics.WinGL","get_window",0x5b86701a,"haxor.platform.graphics.WinGL.get_window","haxor/platform/graphics/WinGL.hx",48,0xd2011392)
	HX_STACK_THIS(this)
	HX_STACK_LINE(48)
...
bool WinGL_obj::Initialize( ::haxor::platform::windows::Window p_window){
	HX_STACK_FRAME("haxor.platform.graphics.WinGL","Initialize",0xfbdea1d1,"haxor.platform.graphics.WinGL.Initialize","haxor/platform/graphics/WinGL.hx",55,0xd2011392)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.WinGL","CheckExtensions",0xc139fedb,"haxor.platform.graphics.WinGL.CheckExtensions","haxor/platform/graphics/WinGL.hx",147,0xd2011392)
		HX_STACK_THIS(this)
		HX_STACK_LINE(148)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.WinGL","Focus",0x353dbef7,"haxor.platform.graphics.WinGL.Focus","haxor/platform/graphics/WinGL.hx",159,0xd2011392)
		HX_STACK_THIS(this)
		HX_STACK_LINE(159)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.WinGL","Flush",0x334fc1e3,"haxor.platform.graphics.WinGL.Flush","haxor/platform/graphics/WinGL.hx",169,0xd2011392)
		HX_STACK_THIS(this)
		HX_STACK_LINE(169)
