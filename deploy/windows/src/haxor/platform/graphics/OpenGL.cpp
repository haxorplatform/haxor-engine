...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","UniformMatrix4fv",0xda86ce3a,"haxor.platform.graphics.OpenGL.UniformMatrix4fv","haxor/platform/graphics/OpenGL.hx",220,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_transpose,"p_transpose")
		HX_STACK_ARG(p_v,"p_v")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","BlendFunc",0xc23185aa,"haxor.platform.graphics.OpenGL.BlendFunc","haxor/platform/graphics/OpenGL.hx",225,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Disable",0x1f6d3c1d,"haxor.platform.graphics.OpenGL.Disable","haxor/platform/graphics/OpenGL.hx",226,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Enable",0xdd78d9ee,"haxor.platform.graphics.OpenGL.Enable","haxor/platform/graphics/OpenGL.hx",227,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_flag,"p_flag")
		HX_STACK_LINE(227)
		glEnable(p_flag);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DepthMask",0x596f2504,"haxor.platform.graphics.OpenGL.DepthMask","haxor/platform/graphics/OpenGL.hx",228,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_flag,"p_flag")
		HX_STACK_LINE(228)
		glDepthMask(p_flag);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DepthFunc",0x54ddcf5c,"haxor.platform.graphics.OpenGL.DepthFunc","haxor/platform/graphics/OpenGL.hx",229,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_flag,"p_flag")
		HX_STACK_LINE(229)
		glDepthFunc(p_flag);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CullFace",0x9055039a,"haxor.platform.graphics.OpenGL.CullFace","haxor/platform/graphics/OpenGL.hx",230,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","FrontFace",0x3b568b5b,"haxor.platform.graphics.OpenGL.FrontFace","haxor/platform/graphics/OpenGL.hx",231,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_face,"p_face")
		HX_STACK_LINE(231)
		glFrontFace(p_face);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Clear",0x1247dc82,"haxor.platform.graphics.OpenGL.Clear","haxor/platform/graphics/OpenGL.hx",235,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_flag,"p_flag")
		HX_STACK_LINE(235)
		glClear(p_flag);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","ClearDepth",0x3476ed21,"haxor.platform.graphics.OpenGL.ClearDepth","haxor/platform/graphics/OpenGL.hx",236,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_value,"p_value")
		HX_STACK_LINE(236)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","ClearColor",0xa7a96d81,"haxor.platform.graphics.OpenGL.ClearColor","haxor/platform/graphics/OpenGL.hx",237,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Viewport",0x80c86891,"haxor.platform.graphics.OpenGL.Viewport","haxor/platform/graphics/OpenGL.hx",238,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
		HX_STACK_ARG(p_width,"p_width")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Scissor",0x72fbfa51,"haxor.platform.graphics.OpenGL.Scissor","haxor/platform/graphics/OpenGL.hx",239,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
		HX_STACK_ARG(p_width,"p_width")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","ReadPixels",0x0e68900e,"haxor.platform.graphics.OpenGL.ReadPixels","haxor/platform/graphics/OpenGL.hx",241,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
		HX_STACK_ARG(p_width,"p_width")
...
int OpenGL_obj::GetErrorCode( ){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","GetErrorCode",0xa39fd74a,"haxor.platform.graphics.OpenGL.GetErrorCode","haxor/platform/graphics/OpenGL.hx",244,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(244)
	return glGetError();;
	HX_STACK_LINE(244)
