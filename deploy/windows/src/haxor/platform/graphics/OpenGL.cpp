...
{
HX_STACK_FRAME("haxor.platform.graphics.OpenGL","new",0xa0d46c35,"haxor.platform.graphics.OpenGL.new","haxor/platform/graphics/OpenGL.hx",51,0x3c17389a)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CheckExtensions",0x58fb7231,"haxor.platform.graphics.OpenGL.CheckExtensions","haxor/platform/graphics/OpenGL.hx",57,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(58)
		this->Focus();
		HX_STACK_LINE(59)
		...
		HX_STACK_LINE(71)
		{
			...
			while((true)){
				...
				if (  ( _switch_1==HX_CSTRING("ARB_texture_half_float"))){
					...
					HX_STACK_LINE(88)
					::haxor::platform::graphics::GL_obj::MAX_TEXTURE_ANISOTROPY = f;
					HX_STACK_LINE(89)
					::haxor::platform::graphics::GL_obj::TEXTURE_ANISOTROPY_ENABLED = true;
					HX_STACK_LINE(90)
					::haxor::core::Console_obj::Log((HX_CSTRING("\t\tMAX_TEXTURE_MAX_ANISOTROPY: ") + ::haxor::platform::graphics::GL_obj::MAX_TEXTURE_ANISOTROPY),null());
				}
					...
					HX_STACK_LINE(96)
					::haxor::platform::graphics::GL_obj::TEXTURE_DEPTH_ENABLED = true;
				}
			}
		}
		HX_STACK_LINE(101)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","BindBuffer",0x81014f88,"haxor.platform.graphics.OpenGL.BindBuffer","haxor/platform/graphics/OpenGL.hx",108,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","BufferData",0x1bb67c35,"haxor.platform.graphics.OpenGL.BufferData","haxor/platform/graphics/OpenGL.hx",110,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","BufferSubData",0xb254de9f,"haxor.platform.graphics.OpenGL.BufferSubData","haxor/platform/graphics/OpenGL.hx",116,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
...
int OpenGL_obj::CreateBuffer( ){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CreateBuffer",0x1f060ac7,"haxor.platform.graphics.OpenGL.CreateBuffer","haxor/platform/graphics/OpenGL.hx",122,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(122)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DrawArrays",0x81f6b0c9,"haxor.platform.graphics.OpenGL.DrawArrays","haxor/platform/graphics/OpenGL.hx",123,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DrawElements",0x85d3d006,"haxor.platform.graphics.OpenGL.DrawElements","haxor/platform/graphics/OpenGL.hx",124,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_primitive,"p_primitive")
		HX_STACK_ARG(p_count,"p_count")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DeleteBuffer",0x6348f136,"haxor.platform.graphics.OpenGL.DeleteBuffer","haxor/platform/graphics/OpenGL.hx",125,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(125)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DisableVertexAttrib",0x5b69998b,"haxor.platform.graphics.OpenGL.DisableVertexAttrib","haxor/platform/graphics/OpenGL.hx",126,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","EnableVertexAttrib",0x7d132cdc,"haxor.platform.graphics.OpenGL.EnableVertexAttrib","haxor/platform/graphics/OpenGL.hx",127,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_LINE(127)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","VertexAttrib3f",0xc931a48c,"haxor.platform.graphics.OpenGL.VertexAttrib3f","haxor/platform/graphics/OpenGL.hx",128,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","VertexAttrib4f",0xc931a56b,"haxor.platform.graphics.OpenGL.VertexAttrib4f","haxor/platform/graphics/OpenGL.hx",129,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","VertexAttribPointer",0xd397d244,"haxor.platform.graphics.OpenGL.VertexAttribPointer","haxor/platform/graphics/OpenGL.hx",130,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CompileShader",0x472258ed,"haxor.platform.graphics.OpenGL.CompileShader","haxor/platform/graphics/OpenGL.hx",133,0x3c17389a)
		HX_STACK_THIS(this)
...
int OpenGL_obj::CreateShader( int p_type){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CreateShader",0x6b920cec,"haxor.platform.graphics.OpenGL.CreateShader","haxor/platform/graphics/OpenGL.hx",134,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_type,"p_type")
	HX_STACK_LINE(134)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DetachShader",0x16c9de83,"haxor.platform.graphics.OpenGL.DetachShader","haxor/platform/graphics/OpenGL.hx",135,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DeleteShader",0xafd4f35b,"haxor.platform.graphics.OpenGL.DeleteShader","haxor/platform/graphics/OpenGL.hx",136,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_shader,"p_shader")
		HX_STACK_LINE(136)
...
::String OpenGL_obj::GetShaderInfoLog( int p_shader){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","GetShaderInfoLog",0x08f47cc6,"haxor.platform.graphics.OpenGL.GetShaderInfoLog","haxor/platform/graphics/OpenGL.hx",137,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_shader,"p_shader")
	HX_STACK_LINE(137)
...
int OpenGL_obj::GetShaderParameter( int p_shader,int p_parameter){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","GetShaderParameter",0xbd5589b9,"haxor.platform.graphics.OpenGL.GetShaderParameter","haxor/platform/graphics/OpenGL.hx",138,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_shader,"p_shader")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","ShaderSource",0xce365b8b,"haxor.platform.graphics.OpenGL.ShaderSource","haxor/platform/graphics/OpenGL.hx",140,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_shader,"p_shader")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","AttachShader",0xde93de75,"haxor.platform.graphics.OpenGL.AttachShader","haxor/platform/graphics/OpenGL.hx",147,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_program,"p_program")
		HX_STACK_ARG(p_shader,"p_shader")
		HX_STACK_LINE(147)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","BindAttribLocation",0xa52ac627,"haxor.platform.graphics.OpenGL.BindAttribLocation","haxor/platform/graphics/OpenGL.hx",148,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_program,"p_program")
		HX_STACK_ARG(p_location,"p_location")
...
int OpenGL_obj::CreateProgram( ){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CreateProgram",0x48ac0add,"haxor.platform.graphics.OpenGL.CreateProgram","haxor/platform/graphics/OpenGL.hx",149,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(149)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DeleteProgram",0xbef2c58e,"haxor.platform.graphics.OpenGL.DeleteProgram","haxor/platform/graphics/OpenGL.hx",150,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_program,"p_program")
		HX_STACK_LINE(150)
...
int OpenGL_obj::GetAttribLocation( int p_program,::String p_name){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","GetAttribLocation",0xce2ba14a,"haxor.platform.graphics.OpenGL.GetAttribLocation","haxor/platform/graphics/OpenGL.hx",151,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_program,"p_program")
	HX_STACK_ARG(p_name,"p_name")
	HX_STACK_LINE(151)
...
int OpenGL_obj::GetUniformLocation( int p_program,::String p_name){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","GetUniformLocation",0xd6ce7f7e,"haxor.platform.graphics.OpenGL.GetUniformLocation","haxor/platform/graphics/OpenGL.hx",152,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_program,"p_program")
	HX_STACK_ARG(p_name,"p_name")
	HX_STACK_LINE(152)
...
::String OpenGL_obj::GetProgramInfoLog( int p_program){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","GetProgramInfoLog",0x3f0e783d,"haxor.platform.graphics.OpenGL.GetProgramInfoLog","haxor/platform/graphics/OpenGL.hx",153,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_program,"p_program")
	HX_STACK_LINE(153)
...
int OpenGL_obj::GetProgramParameter( int p_program,int p_parameter){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","GetProgramParameter",0x2a7e90f0,"haxor.platform.graphics.OpenGL.GetProgramParameter","haxor/platform/graphics/OpenGL.hx",154,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p_program,"p_program")
	HX_STACK_ARG(p_parameter,"p_parameter")
	HX_STACK_LINE(154)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","LinkProgram",0x3b9e3e5f,"haxor.platform.graphics.OpenGL.LinkProgram","haxor/platform/graphics/OpenGL.hx",155,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_program,"p_program")
		HX_STACK_LINE(155)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","UseProgram",0x7eef29e8,"haxor.platform.graphics.OpenGL.UseProgram","haxor/platform/graphics/OpenGL.hx",156,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_program,"p_program")
		HX_STACK_LINE(156)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","ActiveTexture",0xc319fbaa,"haxor.platform.graphics.OpenGL.ActiveTexture","haxor/platform/graphics/OpenGL.hx",159,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","BindFramebuffer",0x3d935565,"haxor.platform.graphics.OpenGL.BindFramebuffer","haxor/platform/graphics/OpenGL.hx",160,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(160)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","BindRenderbuffer",0x29e3755e,"haxor.platform.graphics.OpenGL.BindRenderbuffer","haxor/platform/graphics/OpenGL.hx",161,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(161)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","BindTexture",0x4d746d53,"haxor.platform.graphics.OpenGL.BindTexture","haxor/platform/graphics/OpenGL.hx",162,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(162)
...
int OpenGL_obj::CreateFramebuffer( ){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CreateFramebuffer",0x3e0475c6,"haxor.platform.graphics.OpenGL.CreateFramebuffer","haxor/platform/graphics/OpenGL.hx",163,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(163)
...
int OpenGL_obj::CreateRenderbuffer( ){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CreateRenderbuffer",0x8c6ea9dd,"haxor.platform.graphics.OpenGL.CreateRenderbuffer","haxor/platform/graphics/OpenGL.hx",164,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(164)
...
int OpenGL_obj::CreateTexture( ){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CreateTexture",0xf3938934,"haxor.platform.graphics.OpenGL.CreateTexture","haxor/platform/graphics/OpenGL.hx",165,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(165)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DeleteFramebuffer",0xc11cdcf7,"haxor.platform.graphics.OpenGL.DeleteFramebuffer","haxor/platform/graphics/OpenGL.hx",166,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(166)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DeleteRenderbuffer",0xbeb08d8c,"haxor.platform.graphics.OpenGL.DeleteRenderbuffer","haxor/platform/graphics/OpenGL.hx",167,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(167)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DeleteTexture",0x69da43e5,"haxor.platform.graphics.OpenGL.DeleteTexture","haxor/platform/graphics/OpenGL.hx",168,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_id,"p_id")
		HX_STACK_LINE(168)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","FramebufferRenderbuffer",0x2b862998,"haxor.platform.graphics.OpenGL.FramebufferRenderbuffer","haxor/platform/graphics/OpenGL.hx",170,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","FramebufferTexture2D",0xf5d4976b,"haxor.platform.graphics.OpenGL.FramebufferTexture2D","haxor/platform/graphics/OpenGL.hx",172,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
		HX_STACK_ARG(p_attachment,"p_attachment")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","GenerateMipmap",0xd088e508,"haxor.platform.graphics.OpenGL.GenerateMipmap","haxor/platform/graphics/OpenGL.hx",173,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
		HX_STACK_LINE(173)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","PixelStorei",0x32eac543,"haxor.platform.graphics.OpenGL.PixelStorei","haxor/platform/graphics/OpenGL.hx",174,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_parameter,"p_parameter")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","RenderbufferStorage",0x1b526eba,"haxor.platform.graphics.OpenGL.RenderbufferStorage","haxor/platform/graphics/OpenGL.hx",175,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","TexImage2D",0x41aa39b1,"haxor.platform.graphics.OpenGL.TexImage2D","haxor/platform/graphics/OpenGL.hx",177,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","TexImage2DAlloc",0x47931904,"haxor.platform.graphics.OpenGL.TexImage2DAlloc","haxor/platform/graphics/OpenGL.hx",183,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
		HX_STACK_ARG(p_level,"p_level")
		HX_STACK_ARG(p_internal_format,"p_internal_format")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","TexSubImage2D",0x95001709,"haxor.platform.graphics.OpenGL.TexSubImage2D","haxor/platform/graphics/OpenGL.hx",186,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
		HX_STACK_ARG(p_level,"p_level")
		HX_STACK_ARG(p_x,"p_x")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","TexParameterf",0xa8a10f59,"haxor.platform.graphics.OpenGL.TexParameterf","haxor/platform/graphics/OpenGL.hx",191,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
		HX_STACK_ARG(p_parameter,"p_parameter")
		HX_STACK_ARG(p_value,"p_value")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","TexParameteri",0xa8a10f5c,"haxor.platform.graphics.OpenGL.TexParameteri","haxor/platform/graphics/OpenGL.hx",192,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_target,"p_target")
		HX_STACK_ARG(p_parameter,"p_parameter")
		HX_STACK_ARG(p_value,"p_value")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform1f",0xc273aabe,"haxor.platform.graphics.OpenGL.Uniform1f","haxor/platform/graphics/OpenGL.hx",195,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_LINE(195)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform2f",0xc273ab9d,"haxor.platform.graphics.OpenGL.Uniform2f","haxor/platform/graphics/OpenGL.hx",196,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform3f",0xc273ac7c,"haxor.platform.graphics.OpenGL.Uniform3f","haxor/platform/graphics/OpenGL.hx",197,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform4f",0xc273ad5b,"haxor.platform.graphics.OpenGL.Uniform4f","haxor/platform/graphics/OpenGL.hx",198,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform1i",0xc273aac1,"haxor.platform.graphics.OpenGL.Uniform1i","haxor/platform/graphics/OpenGL.hx",199,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_LINE(199)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform2i",0xc273aba0,"haxor.platform.graphics.OpenGL.Uniform2i","haxor/platform/graphics/OpenGL.hx",200,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform3i",0xc273ac7f,"haxor.platform.graphics.OpenGL.Uniform3i","haxor/platform/graphics/OpenGL.hx",201,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform4i",0xc273ad5e,"haxor.platform.graphics.OpenGL.Uniform4i","haxor/platform/graphics/OpenGL.hx",202,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform1fv",0x62c1bbf8,"haxor.platform.graphics.OpenGL.Uniform1fv","haxor/platform/graphics/OpenGL.hx",203,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform2fv",0x62c27e39,"haxor.platform.graphics.OpenGL.Uniform2fv","haxor/platform/graphics/OpenGL.hx",204,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_v,"p_v")
		HX_STACK_LINE(204)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform3fv",0x62c3407a,"haxor.platform.graphics.OpenGL.Uniform3fv","haxor/platform/graphics/OpenGL.hx",205,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_v,"p_v")
		HX_STACK_LINE(205)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform4fv",0x62c402bb,"haxor.platform.graphics.OpenGL.Uniform4fv","haxor/platform/graphics/OpenGL.hx",206,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_v,"p_v")
		HX_STACK_LINE(206)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform1iv",0x62c1be95,"haxor.platform.graphics.OpenGL.Uniform1iv","haxor/platform/graphics/OpenGL.hx",208,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_v,"p_v")
		HX_STACK_LINE(208)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform2iv",0x62c280d6,"haxor.platform.graphics.OpenGL.Uniform2iv","haxor/platform/graphics/OpenGL.hx",210,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_v,"p_v")
		HX_STACK_LINE(210)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform3iv",0x62c34317,"haxor.platform.graphics.OpenGL.Uniform3iv","haxor/platform/graphics/OpenGL.hx",212,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_v,"p_v")
		HX_STACK_LINE(212)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Uniform4iv",0x62c40558,"haxor.platform.graphics.OpenGL.Uniform4iv","haxor/platform/graphics/OpenGL.hx",214,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_v,"p_v")
		HX_STACK_LINE(214)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","UniformMatrix2fv",0xda8549b8,"haxor.platform.graphics.OpenGL.UniformMatrix2fv","haxor/platform/graphics/OpenGL.hx",216,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","UniformMatrix3fv",0xda860bf9,"haxor.platform.graphics.OpenGL.UniformMatrix3fv","haxor/platform/graphics/OpenGL.hx",217,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_transpose,"p_transpose")
		HX_STACK_ARG(p_v,"p_v")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","UniformMatrix4fv",0xda86ce3a,"haxor.platform.graphics.OpenGL.UniformMatrix4fv","haxor/platform/graphics/OpenGL.hx",218,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_location,"p_location")
		HX_STACK_ARG(p_transpose,"p_transpose")
		HX_STACK_ARG(p_v,"p_v")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","BlendFunc",0xc23185aa,"haxor.platform.graphics.OpenGL.BlendFunc","haxor/platform/graphics/OpenGL.hx",221,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Disable",0x1f6d3c1d,"haxor.platform.graphics.OpenGL.Disable","haxor/platform/graphics/OpenGL.hx",222,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Enable",0xdd78d9ee,"haxor.platform.graphics.OpenGL.Enable","haxor/platform/graphics/OpenGL.hx",223,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_flag,"p_flag")
		HX_STACK_LINE(223)
		glEnable(p_flag);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DepthMask",0x596f2504,"haxor.platform.graphics.OpenGL.DepthMask","haxor/platform/graphics/OpenGL.hx",224,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_flag,"p_flag")
		HX_STACK_LINE(224)
		glDepthMask(p_flag);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","DepthFunc",0x54ddcf5c,"haxor.platform.graphics.OpenGL.DepthFunc","haxor/platform/graphics/OpenGL.hx",225,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_flag,"p_flag")
		HX_STACK_LINE(225)
		glDepthFunc(p_flag);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","CullFace",0x9055039a,"haxor.platform.graphics.OpenGL.CullFace","haxor/platform/graphics/OpenGL.hx",226,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","FrontFace",0x3b568b5b,"haxor.platform.graphics.OpenGL.FrontFace","haxor/platform/graphics/OpenGL.hx",227,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_face,"p_face")
		HX_STACK_LINE(227)
		glFrontFace(p_face);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Clear",0x1247dc82,"haxor.platform.graphics.OpenGL.Clear","haxor/platform/graphics/OpenGL.hx",231,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_flag,"p_flag")
		HX_STACK_LINE(231)
		glClear(p_flag);;
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","ClearDepth",0x3476ed21,"haxor.platform.graphics.OpenGL.ClearDepth","haxor/platform/graphics/OpenGL.hx",232,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_value,"p_value")
		HX_STACK_LINE(232)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","ClearColor",0xa7a96d81,"haxor.platform.graphics.OpenGL.ClearColor","haxor/platform/graphics/OpenGL.hx",233,0x3c17389a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Viewport",0x80c86891,"haxor.platform.graphics.OpenGL.Viewport","haxor/platform/graphics/OpenGL.hx",234,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
		HX_STACK_ARG(p_width,"p_width")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","Scissor",0x72fbfa51,"haxor.platform.graphics.OpenGL.Scissor","haxor/platform/graphics/OpenGL.hx",235,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
		HX_STACK_ARG(p_width,"p_width")
...
{
		HX_STACK_FRAME("haxor.platform.graphics.OpenGL","ReadPixels",0x0e68900e,"haxor.platform.graphics.OpenGL.ReadPixels","haxor/platform/graphics/OpenGL.hx",237,0x3c17389a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p_x,"p_x")
		HX_STACK_ARG(p_y,"p_y")
		HX_STACK_ARG(p_width,"p_width")
...
int OpenGL_obj::GetErrorCode( ){
	HX_STACK_FRAME("haxor.platform.graphics.OpenGL","GetErrorCode",0xa39fd74a,"haxor.platform.graphics.OpenGL.GetErrorCode","haxor/platform/graphics/OpenGL.hx",240,0x3c17389a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(240)
	return glGetError();;
	HX_STACK_LINE(240)
