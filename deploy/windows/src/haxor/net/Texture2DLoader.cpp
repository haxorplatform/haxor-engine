...
{
HX_STACK_FRAME("haxor.net.Texture2DLoader","new",0xbec50975,"haxor.net.Texture2DLoader.new","haxor/net/Texture2DLoader.hx",37,0x3127789d)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxor.net.Texture2DLoader","OnBitmapCallback",0x4f54543e,"haxor.net.Texture2DLoader.OnBitmapCallback","haxor/net/Texture2DLoader.hx",43,0x3127789d)
		HX_STACK_THIS(this)
		...
		if (((this->m_progress < 1.0))){
			...
			Void run(){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","haxor/net/Texture2DLoader.hx",54,0x3127789d)
				{
					HX_STACK_LINE(55)
