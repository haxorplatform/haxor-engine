...
bool IntMap_obj::exists( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","F:\\development\\resource\\platform\\haxe\\3_1_3\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",41,0x370c2ca8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(41)
