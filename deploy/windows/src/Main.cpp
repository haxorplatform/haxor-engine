...
bool Main_obj::Load( ){
	...
	Void run(::String s,Float p){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","Main.hx",69,0x087e5c05)
		HX_STACK_ARG(s,"s")
		HX_STACK_ARG(p,"p")
		{
			HX_STACK_LINE(70)
			::haxor::core::Console_obj::Log((HX_CSTRING("progress> ") + p),null());
			HX_STACK_LINE(71)
			if (((p >= 1.0))){
				HX_STACK_LINE(73)
				if (((s != null()))){
					HX_STACK_LINE(75)
					::haxor::core::Console_obj::Log(s.substr((int)0,(int)100),null());
				}
			}
		}
		return null();
	...
	Void run(::haxor::graphics::texture::Bitmap b,Float p){
		HX_STACK_FRAME("*","_Function_1_2",0x5200ed38,"*._Function_1_2","Main.hx",82,0x087e5c05)
		HX_STACK_ARG(b,"b")
		HX_STACK_ARG(p,"p")
		{
			HX_STACK_LINE(83)
	...
	HX_STACK_LINE(81)
	::haxor::net::Web_obj::LoadImg(HX_CSTRING("./projects/dungeon/big/DungeonAtlas03.png"), Dynamic(new _Function_1_2(_g)));
	HX_STACK_LINE(131)
	return false;
}
...
{
		HX_STACK_FRAME("Main","Initialize",0x7af3b365,"Main.Initialize","Main.hx",135,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(136)
...
{
		HX_STACK_FRAME("Main","OnUpdate",0x876cdf5d,"Main.OnUpdate","Main.hx",249,0x087e5c05)
		HX_STACK_THIS(this)
	}
return null();
}
